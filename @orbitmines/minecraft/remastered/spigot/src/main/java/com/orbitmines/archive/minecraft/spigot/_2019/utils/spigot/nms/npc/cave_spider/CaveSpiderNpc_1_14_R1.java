package com.orbitmines.archive.minecraft.spigot._2019.utils.spigot.nms.npc.cave_spider;
...
public class CaveSpiderNpc_1_14_R1 implements CaveSpiderNpc {

    private final NpcNms npcNms;

    public CaveSpiderNpc_1_14_R1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomCaveSpiderNpc entity = new CustomCaveSpiderNpc(world, options);

        entity.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
        world.addEntity(entity);

        CraftEntity craftEntity = entity.getBukkitEntity();
        ((CraftCaveSpider) craftEntity).setRemoveWhenFarAway(false);
...
//        World world = ((CraftWorld) location.getWorld()).getHandle();
//        CustomCaveSpiderRideable entity = new CustomCaveSpiderRideable(world, npcNms, speed, backMultiplier, sideMultiplier, walkHeight, jumpHeight);
//
//        entity.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
//        world.addEntity(entity);
//
...
//    }
    ...
    private static class CustomCaveSpiderNpc extends EntityCaveSpider {

        private final Collection<Option> options;

        CustomCaveSpiderNpc(World world) {
            this(world, new ArrayList<>());
        }

        CustomCaveSpiderNpc(World world, Collection<Option> options) {
...
//    private static class CustomCaveSpiderRideable extends EntityCaveSpider {
//
//        private final NpcNms npcNms;
//
...
//
//        CustomCaveSpiderRideable(World world) {
//            this(world, null, 0F, 0F, 0F, 0F, 0F); //DEFAULTS
//        }
//
//        CustomCaveSpiderRideable(World world, NpcNms npcNms, float speed, float backMultiplier, float sideMultiplier, float walkHeight, float jumpHeight) {
