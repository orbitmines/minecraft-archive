...
public class VindicatorNpc_26_1 implements VindicatorNpc {

    private final NpcNms npcNms;

    public VindicatorNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomVindicatorNpc entity = new CustomVindicatorNpc(level, options, npcNms);
    ...
    private static class CustomVindicatorNpc extends Vindicator {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomVindicatorNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomVindicatorNpc(Level level, Collection<Option> options, NpcNms npcNms) {
