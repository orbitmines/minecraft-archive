package com.orbitmines.archive.minecraft.spigot._2019.utils.spigot.nms.npc.silverfish;
...
public class SilverfishNpc_1_14_R1 implements SilverfishNpc {

    private final NpcNms npcNms;

    public SilverfishNpc_1_14_R1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomSilverfishNpc entity = new CustomSilverfishNpc(world, options);

        entity.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
        world.addEntity(entity);

        CraftEntity craftEntity = entity.getBukkitEntity();
        ((CraftSilverfish) craftEntity).setRemoveWhenFarAway(false);
...
//        World world = ((CraftWorld) location.getWorld()).getHandle();
//        CustomSilverfishRideable entity = new CustomSilverfishRideable(world, npcNms, speed, backMultiplier, sideMultiplier, walkHeight, jumpHeight);
//
//        entity.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
//        world.addEntity(entity);
//
...
//    }
    ...
    private static class CustomSilverfishNpc extends EntitySilverfish {

        private final Collection<Option> options;

        CustomSilverfishNpc(World world) {
            this(world, new ArrayList<>());
        }

        CustomSilverfishNpc(World world, Collection<Option> options) {
...
//    private static class CustomSilverfishRideable extends EntitySilverfish {
//
//        private final NpcNms npcNms;
//
...
//
//        CustomSilverfishRideable(World world) {
//            this(world, null, 0F, 0F, 0F, 0F, 0F); //DEFAULTS
//        }
//
//        CustomSilverfishRideable(World world, NpcNms npcNms, float speed, float backMultiplier, float sideMultiplier, float walkHeight, float jumpHeight) {
