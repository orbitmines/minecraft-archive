...
public class WitchNpc_26_1 implements WitchNpc {

    private final NpcNms npcNms;

    public WitchNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomWitchNpc entity = new CustomWitchNpc(level, options, npcNms);
    ...
    private static class CustomWitchNpc extends Witch {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomWitchNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomWitchNpc(Level level, Collection<Option> options, NpcNms npcNms) {
