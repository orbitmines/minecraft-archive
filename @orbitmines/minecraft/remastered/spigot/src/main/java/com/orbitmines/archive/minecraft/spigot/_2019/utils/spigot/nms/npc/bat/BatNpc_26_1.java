...
public class BatNpc_26_1 implements BatNpc {

    private final NpcNms npcNms;

    public BatNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomBatNpc entity = new CustomBatNpc(level, options, npcNms);
    ...
    private static class CustomBatNpc extends Bat {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomBatNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomBatNpc(Level level, Collection<Option> options, NpcNms npcNms) {
