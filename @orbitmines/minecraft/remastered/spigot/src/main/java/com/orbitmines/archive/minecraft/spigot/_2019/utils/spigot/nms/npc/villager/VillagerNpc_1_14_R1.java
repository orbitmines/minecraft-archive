package com.orbitmines.archive.minecraft.spigot._2019.utils.spigot.nms.npc.villager;
...
public class VillagerNpc_1_14_R1 implements VillagerNpc {

    private final NpcNms npcNms;

    public VillagerNpc_1_14_R1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomVillagerNpc entity = new CustomVillagerNpc(world, options);

        entity.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
        world.addEntity(entity);

        CraftEntity craftEntity = entity.getBukkitEntity();
        ((CraftVillager) craftEntity).setRemoveWhenFarAway(false);
...
//        World world = ((CraftWorld) location.getWorld()).getHandle();
//        CustomVillagerRideable entity = new CustomVillagerRideable(world, npcNms, speed, backMultiplier, sideMultiplier, walkHeight, jumpHeight);
//
//        entity.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
//        world.addEntity(entity);
//
...
//    }
    ...
    private static class CustomVillagerNpc extends EntityVillager {

        private final Collection<Option> options;

        CustomVillagerNpc(World world) {
            this(world, new ArrayList<>());
        }

        CustomVillagerNpc(World world, Collection<Option> options) {
...
//    private static class CustomVillagerRideable extends EntityVillager {
//
//        private final NpcNms npcNms;
//
...
//
//        CustomVillagerRideable(World world) {
//            this(world, null, 0F, 0F, 0F, 0F, 0F); //DEFAULTS
//        }
//
//        CustomVillagerRideable(World world, NpcNms npcNms, float speed, float backMultiplier, float sideMultiplier, float walkHeight, float jumpHeight) {
