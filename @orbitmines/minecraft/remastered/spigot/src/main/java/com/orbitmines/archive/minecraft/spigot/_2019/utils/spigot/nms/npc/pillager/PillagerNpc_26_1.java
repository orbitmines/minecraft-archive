package com.orbitmines.archive.minecraft.spigot._2019.utils.spigot.nms.npc.pillager;
...
public class PillagerNpc_26_1 implements PillagerNpc {

    private final NpcNms npcNms;

    public PillagerNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomPillagerNpc entity = new CustomPillagerNpc(level, options, npcNms);
        ...
        ((CraftPillager) craftEntity).setRemoveWhenFarAway(false);
    ...
    private static class CustomPillagerNpc extends Pillager {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomPillagerNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomPillagerNpc(Level level, Collection<Option> options, NpcNms npcNms) {
