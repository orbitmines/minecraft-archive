package com.orbitmines.archive.minecraft.spigot._2019.utils.spigot.nms.npc.mushroom_cow;
...
public class MushroomCowNpc_1_14_R1 implements MushroomCowNpc {

    private final NpcNms npcNms;

    public MushroomCowNpc_1_14_R1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomMushroomCowNpc entity = new CustomMushroomCowNpc(world, options);

        entity.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
        world.addEntity(entity);

        CraftEntity craftEntity = entity.getBukkitEntity();
        ((CraftMushroomCow) craftEntity).setRemoveWhenFarAway(false);
...
//        World world = ((CraftWorld) location.getWorld()).getHandle();
//        CustomMushroomCowRideable entity = new CustomMushroomCowRideable(world, npcNms, speed, backMultiplier, sideMultiplier, walkHeight, jumpHeight);
//
//        entity.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
//        world.addEntity(entity);
//
...
//    }
    ...
    private static class CustomMushroomCowNpc extends EntityMushroomCow {

        private final Collection<Option> options;

        CustomMushroomCowNpc(World world) {
            this(world, new ArrayList<>());
        }

        CustomMushroomCowNpc(World world, Collection<Option> options) {
...
//    private static class CustomMushroomCowRideable extends EntityMushroomCow {
//
//        private final NpcNms npcNms;
//
...
//
//        CustomMushroomCowRideable(World world) {
//            this(world, null, 0F, 0F, 0F, 0F, 0F); //DEFAULTS
//        }
//
//        CustomMushroomCowRideable(World world, NpcNms npcNms, float speed, float backMultiplier, float sideMultiplier, float walkHeight, float jumpHeight) {
