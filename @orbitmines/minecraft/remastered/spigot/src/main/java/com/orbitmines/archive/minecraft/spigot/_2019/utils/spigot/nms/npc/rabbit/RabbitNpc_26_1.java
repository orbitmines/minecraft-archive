...
public class RabbitNpc_26_1 implements RabbitNpc {

    private final NpcNms npcNms;

    public RabbitNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomRabbitNpc entity = new CustomRabbitNpc(level, options, npcNms);
    ...
    private static class CustomRabbitNpc extends Rabbit {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomRabbitNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomRabbitNpc(Level level, Collection<Option> options, NpcNms npcNms) {
