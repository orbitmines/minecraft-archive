package com.orbitmines.archive.minecraft.spigot._2019.utils.spigot.nms.npc.mule;
...
public class MuleNpc_1_14_R1 implements MuleNpc {

    private final NpcNms npcNms;

    public MuleNpc_1_14_R1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomHorseMuleNpc entity = new CustomHorseMuleNpc(world, options);

        entity.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
        world.addEntity(entity);

        CraftEntity craftEntity = entity.getBukkitEntity();
        ((CraftMule) craftEntity).setRemoveWhenFarAway(false);
...
//        World world = ((CraftWorld) location.getWorld()).getHandle();
//        CustomHorseMuleRideable entity = new CustomHorseMuleRideable(world, npcNms, speed, backMultiplier, sideMultiplier, walkHeight, jumpHeight);
//
//        entity.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
//        world.addEntity(entity);
//
...
//    }
    ...
    private static class CustomHorseMuleNpc extends EntityHorseMule {

        private final Collection<Option> options;

        CustomHorseMuleNpc(World world) {
            this(world, new ArrayList<>());
        }

        CustomHorseMuleNpc(World world, Collection<Option> options) {
...
//    private static class CustomHorseMuleRideable extends EntityHorseMule {
//
//        private final NpcNms npcNms;
//
...
//
//        CustomHorseMuleRideable(World world) {
//            this(world, null, 0F, 0F, 0F, 0F, 0F); //DEFAULTS
//        }
//
//        CustomHorseMuleRideable(World world, NpcNms npcNms, float speed, float backMultiplier, float sideMultiplier, float walkHeight, float jumpHeight) {
