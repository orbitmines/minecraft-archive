package com.orbitmines.archive.minecraft.spigot._2019.utils.spigot.nms.npc.tropical_fish;
...
public class TropicalFishNpc_1_14_R1 implements TropicalFishNpc {

    private final NpcNms npcNms;

    public TropicalFishNpc_1_14_R1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomTropicalFishNpc entity = new CustomTropicalFishNpc(world, options);

        entity.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
        world.addEntity(entity);

        CraftEntity craftEntity = entity.getBukkitEntity();
        ((CraftTropicalFish) craftEntity).setRemoveWhenFarAway(false);
...
//        World world = ((CraftWorld) location.getWorld()).getHandle();
//        CustomTropicalFishRideable entity = new CustomTropicalFishRideable(world, npcNms, speed, backMultiplier, sideMultiplier, walkHeight, jumpHeight);
//
//        entity.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
//        world.addEntity(entity);
//
...
//    }
    ...
    private static class CustomTropicalFishNpc extends EntityTropicalFish {

        private final Collection<Option> options;

        CustomTropicalFishNpc(World world) {
            this(world, new ArrayList<>());
        }

        CustomTropicalFishNpc(World world, Collection<Option> options) {
...
//    private static class CustomTropicalFishRideable extends EntityTropicalFish {
//
//        private final NpcNms npcNms;
//
...
//
//        CustomTropicalFishRideable(World world) {
//            this(world, null, 0F, 0F, 0F, 0F, 0F); //DEFAULTS
//        }
//
//        CustomTropicalFishRideable(World world, NpcNms npcNms, float speed, float backMultiplier, float sideMultiplier, float walkHeight, float jumpHeight) {
