package com.orbitmines.archive.minecraft.spigot._2019.utils.spigot.nms.npc.sheep;
...
public class SheepNpc_1_14_R1 implements SheepNpc {

    private final NpcNms npcNms;

    public SheepNpc_1_14_R1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomSheepNpc entity = new CustomSheepNpc(world, options);

        entity.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
        world.addEntity(entity);

        CraftEntity craftEntity = entity.getBukkitEntity();
        ((CraftSheep) craftEntity).setRemoveWhenFarAway(false);
...
//        World world = ((CraftWorld) location.getWorld()).getHandle();
//        CustomSheepRideable entity = new CustomSheepRideable(world, npcNms, speed, backMultiplier, sideMultiplier, walkHeight, jumpHeight);
//
//        entity.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
//        world.addEntity(entity);
//
...
//    }
    ...
    private static class CustomSheepNpc extends EntitySheep {

        private final Collection<Option> options;

        CustomSheepNpc(World world) {
            this(world, new ArrayList<>());
        }

        CustomSheepNpc(World world, Collection<Option> options) {
...
//    private static class CustomSheepRideable extends EntitySheep {
//
//        private final NpcNms npcNms;
//
...
//
//        CustomSheepRideable(World world) {
//            this(world, null, 0F, 0F, 0F, 0F, 0F); //DEFAULTS
//        }
//
//        CustomSheepRideable(World world, NpcNms npcNms, float speed, float backMultiplier, float sideMultiplier, float walkHeight, float jumpHeight) {
