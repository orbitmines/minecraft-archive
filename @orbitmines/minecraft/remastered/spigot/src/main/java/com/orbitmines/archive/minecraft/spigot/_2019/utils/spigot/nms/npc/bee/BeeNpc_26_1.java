package com.orbitmines.archive.minecraft.spigot._2019.utils.spigot.nms.npc.bee;
...
public class BeeNpc_26_1 implements BeeNpc {

    private final NpcNms npcNms;

    public BeeNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomBeeNpc entity = new CustomBeeNpc(level, options, npcNms);
        ...
        ((CraftBee) craftEntity).setRemoveWhenFarAway(false);
    ...
    private static class CustomBeeNpc extends Bee {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomBeeNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomBeeNpc(Level level, Collection<Option> options, NpcNms npcNms) {
