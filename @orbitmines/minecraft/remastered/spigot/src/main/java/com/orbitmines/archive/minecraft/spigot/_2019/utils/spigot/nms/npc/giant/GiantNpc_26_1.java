...
public class GiantNpc_26_1 implements GiantNpc {

    private final NpcNms npcNms;

    public GiantNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomGiantNpc entity = new CustomGiantNpc(level, options, npcNms);
    ...
    private static class CustomGiantNpc extends Giant {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomGiantNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomGiantNpc(Level level, Collection<Option> options, NpcNms npcNms) {
            super(EntityType.GIANT, level);
