...
public class WitherSkeletonNpc_26_1 implements WitherSkeletonNpc {

    private final NpcNms npcNms;

    public WitherSkeletonNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomWitherSkeletonNpc entity = new CustomWitherSkeletonNpc(level, options, npcNms);
    ...
    private static class CustomWitherSkeletonNpc extends WitherSkeleton {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomWitherSkeletonNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomWitherSkeletonNpc(Level level, Collection<Option> options, NpcNms npcNms) {
