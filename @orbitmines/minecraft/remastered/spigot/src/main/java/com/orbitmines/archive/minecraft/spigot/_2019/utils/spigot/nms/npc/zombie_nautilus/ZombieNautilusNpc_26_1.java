package com.orbitmines.archive.minecraft.spigot._2019.utils.spigot.nms.npc.zombie_nautilus;
...
public class ZombieNautilusNpc_26_1 implements ZombieNautilusNpc {

    private final NpcNms npcNms;

    public ZombieNautilusNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomZombieNautilusNpc entity = new CustomZombieNautilusNpc(level, options, npcNms);
        ...
        ((CraftZombieNautilus) craftEntity).setRemoveWhenFarAway(false);
    ...
    private static class CustomZombieNautilusNpc extends ZombieNautilus {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomZombieNautilusNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomZombieNautilusNpc(Level level, Collection<Option> options, NpcNms npcNms) {
