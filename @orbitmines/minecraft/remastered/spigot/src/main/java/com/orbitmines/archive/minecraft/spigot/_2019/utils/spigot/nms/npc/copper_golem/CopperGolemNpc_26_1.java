package com.orbitmines.archive.minecraft.spigot._2019.utils.spigot.nms.npc.copper_golem;
...
public class CopperGolemNpc_26_1 implements CopperGolemNpc {

    private final NpcNms npcNms;

    public CopperGolemNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomCopperGolemNpc entity = new CustomCopperGolemNpc(level, options, npcNms);
        ...
        ((CraftCopperGolem) craftEntity).setRemoveWhenFarAway(false);
    ...
    private static class CustomCopperGolemNpc extends CopperGolem {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomCopperGolemNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomCopperGolemNpc(Level level, Collection<Option> options, NpcNms npcNms) {
