package com.orbitmines.archive.minecraft.spigot._2019.utils.spigot.nms.npc.iron_golem;
...
public class IronGolemNpc_26_1 implements IronGolemNpc {

    private final NpcNms npcNms;

    public IronGolemNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomIronGolemNpc entity = new CustomIronGolemNpc(level, options, npcNms);
    ...
    private static class CustomIronGolemNpc extends IronGolem {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomIronGolemNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomIronGolemNpc(Level level, Collection<Option> options, NpcNms npcNms) {
