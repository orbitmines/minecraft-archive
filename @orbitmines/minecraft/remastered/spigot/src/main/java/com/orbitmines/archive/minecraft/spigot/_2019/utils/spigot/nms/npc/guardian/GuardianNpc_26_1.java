...
public class GuardianNpc_26_1 implements GuardianNpc {

    private final NpcNms npcNms;

    public GuardianNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomGuardianNpc entity = new CustomGuardianNpc(level, options, npcNms);
    ...
    private static class CustomGuardianNpc extends Guardian {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomGuardianNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomGuardianNpc(Level level, Collection<Option> options, NpcNms npcNms) {
