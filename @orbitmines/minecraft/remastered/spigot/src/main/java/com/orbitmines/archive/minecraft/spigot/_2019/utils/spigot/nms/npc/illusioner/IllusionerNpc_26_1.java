...
public class IllusionerNpc_26_1 implements IllusionerNpc {

    private final NpcNms npcNms;

    public IllusionerNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomIllusionerNpc entity = new CustomIllusionerNpc(level, options, npcNms);
    ...
    private static class CustomIllusionerNpc extends Illusioner {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomIllusionerNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomIllusionerNpc(Level level, Collection<Option> options, NpcNms npcNms) {
            super(EntityType.ILLUSIONER, level);
