package com.orbitmines.archive.minecraft.spigot._2019.utils.spigot.nms.npc.bogged;
...
public class BoggedNpc_26_1 implements BoggedNpc {

    private final NpcNms npcNms;

    public BoggedNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomBoggedNpc entity = new CustomBoggedNpc(level, options, npcNms);
        ...
        ((CraftBogged) craftEntity).setRemoveWhenFarAway(false);
    ...
    private static class CustomBoggedNpc extends Bogged {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomBoggedNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomBoggedNpc(Level level, Collection<Option> options, NpcNms npcNms) {
