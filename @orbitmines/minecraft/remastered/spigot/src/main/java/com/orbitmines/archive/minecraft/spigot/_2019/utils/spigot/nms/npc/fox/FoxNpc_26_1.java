package com.orbitmines.archive.minecraft.spigot._2019.utils.spigot.nms.npc.fox;
...
public class FoxNpc_26_1 implements FoxNpc {

    private final NpcNms npcNms;

    public FoxNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    private static class CustomFoxNpc extends Fox {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomFoxNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomFoxNpc(Level level, Collection<Option> options, NpcNms npcNms) {
