...
public class HuskNpc_1_14_R1 implements HuskNpc {

    private final NpcNms npcNms;

    public HuskNpc_1_14_R1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomZombieHuskNpc entity = new CustomZombieHuskNpc(world, options);
...
//        World world = ((CraftWorld) location.getWorld()).getHandle();
//        CustomZombieHuskRideable entity = new CustomZombieHuskRideable(world, npcNms, speed, backMultiplier, sideMultiplier, walkHeight, jumpHeight);
//
//        entity.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
//        world.addEntity(entity);
//
...
//    }
    ...
    private static class CustomZombieHuskNpc extends EntityZombieHusk {

        private final Collection<Option> options;

        CustomZombieHuskNpc(World world) {
            this(world, new ArrayList<>());
        }

        CustomZombieHuskNpc(World world, Collection<Option> options) {
...
//    private static class CustomZombieHuskRideable extends EntityZombieHusk {
//
//        private final NpcNms npcNms;
//
...
//
//        CustomZombieHuskRideable(World world) {
//            this(world, null, 0F, 0F, 0F, 0F, 0F); //DEFAULTS
//        }
//
//        CustomZombieHuskRideable(World world, NpcNms npcNms, float speed, float backMultiplier, float sideMultiplier, float walkHeight, float jumpHeight) {
