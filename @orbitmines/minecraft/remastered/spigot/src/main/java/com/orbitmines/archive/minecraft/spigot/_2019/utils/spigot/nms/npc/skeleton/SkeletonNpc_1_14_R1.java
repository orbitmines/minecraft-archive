package com.orbitmines.archive.minecraft.spigot._2019.utils.spigot.nms.npc.skeleton;
...
public class SkeletonNpc_1_14_R1 implements SkeletonNpc {

    private final NpcNms npcNms;

    public SkeletonNpc_1_14_R1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomSkeletonNpc entity = new CustomSkeletonNpc(world, options);

        entity.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
        world.addEntity(entity);

        CraftEntity craftEntity = entity.getBukkitEntity();
        ((CraftSkeleton) craftEntity).setRemoveWhenFarAway(false);
...
//        World world = ((CraftWorld) location.getWorld()).getHandle();
//        CustomSkeletonRideable entity = new CustomSkeletonRideable(world, npcNms, speed, backMultiplier, sideMultiplier, walkHeight, jumpHeight);
//
//        entity.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
//        world.addEntity(entity);
//
...
//    }
    ...
    private static class CustomSkeletonNpc extends EntitySkeleton {

        private final Collection<Option> options;

        CustomSkeletonNpc(World world) {
            this(world, new ArrayList<>());
        }

        CustomSkeletonNpc(World world, Collection<Option> options) {
...
//    private static class CustomSkeletonRideable extends EntitySkeleton {
//
//        private final NpcNms npcNms;
//
...
//
//        CustomSkeletonRideable(World world) {
//            this(world, null, 0F, 0F, 0F, 0F, 0F); //DEFAULTS
//        }
//
//        CustomSkeletonRideable(World world, NpcNms npcNms, float speed, float backMultiplier, float sideMultiplier, float walkHeight, float jumpHeight) {
