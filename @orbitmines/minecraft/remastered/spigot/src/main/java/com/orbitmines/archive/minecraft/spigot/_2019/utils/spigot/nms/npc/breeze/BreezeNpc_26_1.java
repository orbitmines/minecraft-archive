package com.orbitmines.archive.minecraft.spigot._2019.utils.spigot.nms.npc.breeze;
...
public class BreezeNpc_26_1 implements BreezeNpc {

    private final NpcNms npcNms;

    public BreezeNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomBreezeNpc entity = new CustomBreezeNpc(level, options, npcNms);
        ...
        ((CraftBreeze) craftEntity).setRemoveWhenFarAway(false);
    ...
    private static class CustomBreezeNpc extends Breeze {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomBreezeNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomBreezeNpc(Level level, Collection<Option> options, NpcNms npcNms) {
