...
public class StrayNpc_26_1 implements StrayNpc {

    private final NpcNms npcNms;

    public StrayNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomStrayNpc entity = new CustomStrayNpc(level, options, npcNms);
    ...
    private static class CustomStrayNpc extends Stray {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomStrayNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomStrayNpc(Level level, Collection<Option> options, NpcNms npcNms) {
