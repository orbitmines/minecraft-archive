...
public class ChickenNpc_26_1 implements ChickenNpc {

    private final NpcNms npcNms;

    public ChickenNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomChickenNpc entity = new CustomChickenNpc(level, options, npcNms);
    ...
    private static class CustomChickenNpc extends Chicken {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomChickenNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomChickenNpc(Level level, Collection<Option> options, NpcNms npcNms) {
