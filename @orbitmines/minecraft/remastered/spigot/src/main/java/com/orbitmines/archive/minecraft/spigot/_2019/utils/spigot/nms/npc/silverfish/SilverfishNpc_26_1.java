...
public class SilverfishNpc_26_1 implements SilverfishNpc {

    private final NpcNms npcNms;

    public SilverfishNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomSilverfishNpc entity = new CustomSilverfishNpc(level, options, npcNms);
    ...
    private static class CustomSilverfishNpc extends Silverfish {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomSilverfishNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomSilverfishNpc(Level level, Collection<Option> options, NpcNms npcNms) {
