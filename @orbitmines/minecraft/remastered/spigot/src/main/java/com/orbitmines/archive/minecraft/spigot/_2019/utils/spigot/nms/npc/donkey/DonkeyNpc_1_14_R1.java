package com.orbitmines.archive.minecraft.spigot._2019.utils.spigot.nms.npc.donkey;
...
public class DonkeyNpc_1_14_R1 implements DonkeyNpc {

    private final NpcNms npcNms;

    public DonkeyNpc_1_14_R1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomHorseDonkeyNpc entity = new CustomHorseDonkeyNpc(world, options);

        entity.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
        world.addEntity(entity);

        CraftEntity craftEntity = entity.getBukkitEntity();
        ((CraftDonkey) craftEntity).setRemoveWhenFarAway(false);
...
//        World world = ((CraftWorld) location.getWorld()).getHandle();
//        CustomHorseDonkeyRideable entity = new CustomHorseDonkeyRideable(world, npcNms, speed, backMultiplier, sideMultiplier, walkHeight, jumpHeight);
//
//        entity.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
//        world.addEntity(entity);
//
...
//    }
    ...
    private static class CustomHorseDonkeyNpc extends EntityHorseDonkey {

        private final Collection<Option> options;

        CustomHorseDonkeyNpc(World world) {
            this(world, new ArrayList<>());
        }

        CustomHorseDonkeyNpc(World world, Collection<Option> options) {
...
//    private static class CustomHorseDonkeyRideable extends EntityHorseDonkey {
//
//        private final NpcNms npcNms;
//
...
//
//        CustomHorseDonkeyRideable(World world) {
//            this(world, null, 0F, 0F, 0F, 0F, 0F); //DEFAULTS
//        }
//
//        CustomHorseDonkeyRideable(World world, NpcNms npcNms, float speed, float backMultiplier, float sideMultiplier, float walkHeight, float jumpHeight) {
