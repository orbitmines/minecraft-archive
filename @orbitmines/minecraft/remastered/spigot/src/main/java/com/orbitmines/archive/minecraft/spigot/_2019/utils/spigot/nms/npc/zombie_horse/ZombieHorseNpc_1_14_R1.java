...
public class ZombieHorseNpc_1_14_R1 implements ZombieHorseNpc {

    private final NpcNms npcNms;

    public ZombieHorseNpc_1_14_R1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomHorseZombieNpc entity = new CustomHorseZombieNpc(world, options);
...
//        World world = ((CraftWorld) location.getWorld()).getHandle();
//        CustomHorseZombieRideable entity = new CustomHorseZombieRideable(world, npcNms, speed, backMultiplier, sideMultiplier, walkHeight, jumpHeight);
//
//        entity.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
//        world.addEntity(entity);
//
...
//    }
    ...
    private static class CustomHorseZombieNpc extends EntityHorseZombie {

        private final Collection<Option> options;

        CustomHorseZombieNpc(World world) {
            this(world, new ArrayList<>());
        }

        CustomHorseZombieNpc(World world, Collection<Option> options) {
...
//    private static class CustomHorseZombieRideable extends EntityHorseZombie {
//
//        private final NpcNms npcNms;
//
...
//
//        CustomHorseZombieRideable(World world) {
//            this(world, null, 0F, 0F, 0F, 0F, 0F); //DEFAULTS
//        }
//
//        CustomHorseZombieRideable(World world, NpcNms npcNms, float speed, float backMultiplier, float sideMultiplier, float walkHeight, float jumpHeight) {
