...
public class ElderGuardianNpc_26_1 implements ElderGuardianNpc {

    private final NpcNms npcNms;

    public ElderGuardianNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomElderGuardianNpc entity = new CustomElderGuardianNpc(level, options, npcNms);
    ...
    private static class CustomElderGuardianNpc extends ElderGuardian {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomElderGuardianNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomElderGuardianNpc(Level level, Collection<Option> options, NpcNms npcNms) {
