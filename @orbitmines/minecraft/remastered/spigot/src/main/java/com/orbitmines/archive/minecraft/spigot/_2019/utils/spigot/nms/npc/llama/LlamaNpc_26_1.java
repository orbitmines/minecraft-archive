...
public class LlamaNpc_26_1 implements LlamaNpc {

    private final NpcNms npcNms;

    public LlamaNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomLlamaNpc entity = new CustomLlamaNpc(level, options, npcNms);
    ...
    private static class CustomLlamaNpc extends Llama {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomLlamaNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomLlamaNpc(Level level, Collection<Option> options, NpcNms npcNms) {
