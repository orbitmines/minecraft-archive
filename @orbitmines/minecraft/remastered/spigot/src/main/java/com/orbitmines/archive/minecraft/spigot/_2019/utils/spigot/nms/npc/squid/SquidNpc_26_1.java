...
public class SquidNpc_26_1 implements SquidNpc {

    private final NpcNms npcNms;

    public SquidNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomSquidNpc entity = new CustomSquidNpc(level, options, npcNms);
    ...
    private static class CustomSquidNpc extends Squid {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomSquidNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomSquidNpc(Level level, Collection<Option> options, NpcNms npcNms) {
            super(EntityType.SQUID, level);
