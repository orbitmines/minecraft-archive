...
public class TurtleNpc_1_14_R1 implements TurtleNpc {

    private final NpcNms npcNms;

    public TurtleNpc_1_14_R1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomTurtleNpc entity = new CustomTurtleNpc(world, options);
...
//        World world = ((CraftWorld) location.getWorld()).getHandle();
//        CustomTurtleRideable entity = new CustomTurtleRideable(world, npcNms, speed, backMultiplier, sideMultiplier, walkHeight, jumpHeight);
//
//        entity.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
//        world.addEntity(entity);
//
...
//    }
    ...
    private static class CustomTurtleNpc extends EntityTurtle {

        private final Collection<Option> options;

        CustomTurtleNpc(World world) {
            this(world, new ArrayList<>());
        }

        CustomTurtleNpc(World world, Collection<Option> options) {
...
//    private static class CustomTurtleRideable extends EntityTurtle {
//
//        private final NpcNms npcNms;
//
...
//
//        CustomTurtleRideable(World world) {
//            this(world, null, 0F, 0F, 0F, 0F, 0F); //DEFAULTS
//        }
//
//        CustomTurtleRideable(World world, NpcNms npcNms, float speed, float backMultiplier, float sideMultiplier, float walkHeight, float jumpHeight) {
