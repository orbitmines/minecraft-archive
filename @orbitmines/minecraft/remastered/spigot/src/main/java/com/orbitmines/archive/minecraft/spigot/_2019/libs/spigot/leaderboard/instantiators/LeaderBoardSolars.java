...
public class LeaderBoardSolars extends LeaderBoard.Instantiator {

    public LeaderBoardSolars() {
        super("SOLARS");
    }
    ...
    public LeaderBoard instantiate(Location location, String[] data) {
        return new DefaultHologramLeaderBoard(
            ...
            PlayerModel.column.SOLARS.getColumn(),
            new MySQLQueryBuilder(PlayerModel.TABLE).
                order(PlayerModel.column.SOLARS.getColumn(), Order.DESC).
                limit(10)
        );
    }
}
