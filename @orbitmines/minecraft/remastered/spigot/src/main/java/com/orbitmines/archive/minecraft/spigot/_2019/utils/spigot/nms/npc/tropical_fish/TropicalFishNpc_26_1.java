...
public class TropicalFishNpc_26_1 implements TropicalFishNpc {

    private final NpcNms npcNms;

    public TropicalFishNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomTropicalFishNpc entity = new CustomTropicalFishNpc(level, options, npcNms);
    ...
    private static class CustomTropicalFishNpc extends TropicalFish {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomTropicalFishNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomTropicalFishNpc(Level level, Collection<Option> options, NpcNms npcNms) {
            super(EntityType.TROPICAL_FISH, level);
