...
public class VexNpc_26_1 implements VexNpc {

    private final NpcNms npcNms;

    public VexNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomVexNpc entity = new CustomVexNpc(level, options, npcNms);
    ...
    private static class CustomVexNpc extends Vex {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomVexNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomVexNpc(Level level, Collection<Option> options, NpcNms npcNms) {
