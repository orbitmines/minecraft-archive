...
public class CaveSpiderNpc_26_1 implements CaveSpiderNpc {

    private final NpcNms npcNms;

    public CaveSpiderNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomCaveSpiderNpc entity = new CustomCaveSpiderNpc(level, options, npcNms);
    ...
    private static class CustomCaveSpiderNpc extends CaveSpider {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomCaveSpiderNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomCaveSpiderNpc(Level level, Collection<Option> options, NpcNms npcNms) {
