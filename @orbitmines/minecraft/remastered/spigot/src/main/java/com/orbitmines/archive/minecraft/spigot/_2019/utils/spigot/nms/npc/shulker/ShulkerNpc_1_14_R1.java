package com.orbitmines.archive.minecraft.spigot._2019.utils.spigot.nms.npc.shulker;
...
public class ShulkerNpc_1_14_R1 implements ShulkerNpc {

    private final NpcNms npcNms;

    public ShulkerNpc_1_14_R1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomShulkerNpc entity = new CustomShulkerNpc(world, options);

        entity.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
        world.addEntity(entity);

        CraftEntity craftEntity = entity.getBukkitEntity();
        ((CraftShulker) craftEntity).setRemoveWhenFarAway(false);
...
//        World world = ((CraftWorld) location.getWorld()).getHandle();
//        CustomShulkerRideable entity = new CustomShulkerRideable(world, npcNms, speed, backMultiplier, sideMultiplier, walkHeight, jumpHeight);
//
//        entity.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
//        world.addEntity(entity);
//
...
//    }
    ...
    private static class CustomShulkerNpc extends EntityShulker {

        private final Collection<Option> options;

        CustomShulkerNpc(World world) {
            this(world, new ArrayList<>());
        }

        CustomShulkerNpc(World world, Collection<Option> options) {
...
//    private static class CustomShulkerRideable extends EntityShulker {
//
//        private final NpcNms npcNms;
//
...
//
//        CustomShulkerRideable(World world) {
//            this(world, null, 0F, 0F, 0F, 0F, 0F); //DEFAULTS
//        }
//
//        CustomShulkerRideable(World world, NpcNms npcNms, float speed, float backMultiplier, float sideMultiplier, float walkHeight, float jumpHeight) {
