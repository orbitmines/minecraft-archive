...
public class ZombieNpc_26_1 implements ZombieNpc {

    private final NpcNms npcNms;

    public ZombieNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomZombieNpc entity = new CustomZombieNpc(level, options, npcNms);
    ...
    private static class CustomZombieNpc extends Zombie {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomZombieNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomZombieNpc(Level level, Collection<Option> options, NpcNms npcNms) {
