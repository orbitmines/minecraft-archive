...
public class PigZombieNpc_26_1 implements PigZombieNpc {

    private final NpcNms npcNms;

    public PigZombieNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomZombifiedPiglinNpc entity = new CustomZombifiedPiglinNpc(level, options, npcNms);
    ...
    private static class CustomZombifiedPiglinNpc extends ZombifiedPiglin {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomZombifiedPiglinNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomZombifiedPiglinNpc(Level level, Collection<Option> options, NpcNms npcNms) {
