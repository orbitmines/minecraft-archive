...
public class DonkeyNpc_26_1 implements DonkeyNpc {

    private final NpcNms npcNms;

    public DonkeyNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomDonkeyNpc entity = new CustomDonkeyNpc(level, options, npcNms);
    ...
    private static class CustomDonkeyNpc extends Donkey {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomDonkeyNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomDonkeyNpc(Level level, Collection<Option> options, NpcNms npcNms) {
            super(EntityType.DONKEY, level);
