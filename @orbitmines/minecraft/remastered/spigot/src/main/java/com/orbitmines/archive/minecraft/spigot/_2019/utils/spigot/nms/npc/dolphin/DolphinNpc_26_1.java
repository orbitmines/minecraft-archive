...
public class DolphinNpc_26_1 implements DolphinNpc {
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomDolphinNpc entity = new CustomDolphinNpc(level, options, npcNms);
    ...
    private static class CustomDolphinNpc extends Dolphin {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomDolphinNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomDolphinNpc(Level level, Collection<Option> options, NpcNms npcNms) {
            super(EntityType.DOLPHIN, level);
