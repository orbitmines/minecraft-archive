...
public class CreeperNpc_26_1 implements CreeperNpc {

    private final NpcNms npcNms;

    public CreeperNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomCreeperNpc entity = new CustomCreeperNpc(level, options, npcNms);
    ...
    private static class CustomCreeperNpc extends Creeper {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomCreeperNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomCreeperNpc(Level level, Collection<Option> options, NpcNms npcNms) {
