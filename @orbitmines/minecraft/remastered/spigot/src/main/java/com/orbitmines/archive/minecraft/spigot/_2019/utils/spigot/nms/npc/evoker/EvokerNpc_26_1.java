...
public class EvokerNpc_26_1 implements EvokerNpc {

    private final NpcNms npcNms;

    public EvokerNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomEvokerNpc entity = new CustomEvokerNpc(level, options, npcNms);
    ...
    private static class CustomEvokerNpc extends Evoker {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomEvokerNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomEvokerNpc(Level level, Collection<Option> options, NpcNms npcNms) {
