...
public class MagmaCubeNpc_26_1 implements MagmaCubeNpc {

    private final NpcNms npcNms;

    public MagmaCubeNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomMagmaCubeNpc entity = new CustomMagmaCubeNpc(level, options, npcNms);
    ...
    private static class CustomMagmaCubeNpc extends MagmaCube {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomMagmaCubeNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomMagmaCubeNpc(Level level, Collection<Option> options, NpcNms npcNms) {
