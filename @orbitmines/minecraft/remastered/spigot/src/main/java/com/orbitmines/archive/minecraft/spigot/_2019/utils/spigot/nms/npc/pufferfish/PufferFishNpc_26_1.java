...
public class PufferFishNpc_26_1 implements PufferFishNpc {

    private final NpcNms npcNms;

    public PufferFishNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomPufferfishNpc entity = new CustomPufferfishNpc(level, options, npcNms);
    ...
    private static class CustomPufferfishNpc extends Pufferfish {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomPufferfishNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomPufferfishNpc(Level level, Collection<Option> options, NpcNms npcNms) {
