...
public class PhantomNpc_1_14_R1 implements PhantomNpc {

    private final NpcNms npcNms;

    public PhantomNpc_1_14_R1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomPhantomNpc entity = new CustomPhantomNpc(world, options);
...
//        World world = ((CraftWorld) location.getWorld()).getHandle();
//        CustomPhantomRideable entity = new CustomPhantomRideable(world, npcNms, speed, backMultiplier, sideMultiplier, walkHeight, jumpHeight);
//
//        entity.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
//        world.addEntity(entity);
//
...
//    }
    ...
    private static class CustomPhantomNpc extends EntityPhantom {

        private final Collection<Option> options;

        CustomPhantomNpc(World world) {
            this(world, new ArrayList<>());
        }

        CustomPhantomNpc(World world, Collection<Option> options) {
...
//    private static class CustomPhantomRideable extends EntityPhantom {
//
//        private final NpcNms npcNms;
//
...
//
//        CustomPhantomRideable(World world) {
//            this(world, null, 0F, 0F, 0F, 0F, 0F); //DEFAULTS
//        }
//
//        CustomPhantomRideable(World world, NpcNms npcNms, float speed, float backMultiplier, float sideMultiplier, float walkHeight, float jumpHeight) {
