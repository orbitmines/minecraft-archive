...
public class SlimeNpc_26_1 implements SlimeNpc {

    private final NpcNms npcNms;

    public SlimeNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomSlimeNpc entity = new CustomSlimeNpc(level, options, npcNms);
    ...
    private static class CustomSlimeNpc extends Slime {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomSlimeNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomSlimeNpc(Level level, Collection<Option> options, NpcNms npcNms) {
