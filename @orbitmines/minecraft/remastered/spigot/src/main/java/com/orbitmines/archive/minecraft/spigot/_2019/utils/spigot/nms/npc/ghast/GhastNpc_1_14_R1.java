package com.orbitmines.archive.minecraft.spigot._2019.utils.spigot.nms.npc.ghast;
...
public class GhastNpc_1_14_R1 implements GhastNpc {

    private final NpcNms npcNms;

    public GhastNpc_1_14_R1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomGhastNpc entity = new CustomGhastNpc(world, options);

        entity.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
        world.addEntity(entity);

        CraftEntity craftEntity = entity.getBukkitEntity();
        ((CraftGhast) craftEntity).setRemoveWhenFarAway(false);
...
//        World world = ((CraftWorld) location.getWorld()).getHandle();
//        CustomGhastRideable entity = new CustomGhastRideable(world, npcNms, speed, backMultiplier, sideMultiplier, walkHeight, jumpHeight);
//
//        entity.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
//        world.addEntity(entity);
//
...
//    }
    ...
    private static class CustomGhastNpc extends EntityGhast {

        private final Collection<Option> options;

        CustomGhastNpc(World world) {
            this(world, new ArrayList<>());
        }

        CustomGhastNpc(World world, Collection<Option> options) {
...
//    private static class CustomGhastRideable extends EntityGhast {
//
//        private final NpcNms npcNms;
//
...
//
//        CustomGhastRideable(World world) {
//            this(world, null, 0F, 0F, 0F, 0F, 0F); //DEFAULTS
//        }
//
//        CustomGhastRideable(World world, NpcNms npcNms, float speed, float backMultiplier, float sideMultiplier, float walkHeight, float jumpHeight) {
