...
public class ShulkerNpc_26_1 implements ShulkerNpc {

    private final NpcNms npcNms;

    public ShulkerNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomShulkerNpc entity = new CustomShulkerNpc(level, options, npcNms);
    ...
    private static class CustomShulkerNpc extends Shulker {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomShulkerNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomShulkerNpc(Level level, Collection<Option> options, NpcNms npcNms) {
