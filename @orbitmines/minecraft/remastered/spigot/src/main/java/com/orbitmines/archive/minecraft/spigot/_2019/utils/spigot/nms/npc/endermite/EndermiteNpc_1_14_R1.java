package com.orbitmines.archive.minecraft.spigot._2019.utils.spigot.nms.npc.endermite;
...
public class EndermiteNpc_1_14_R1 implements EndermiteNpc {

    private final NpcNms npcNms;

    public EndermiteNpc_1_14_R1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomEndermiteNpc entity = new CustomEndermiteNpc(world, options);

        entity.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
        world.addEntity(entity);

        CraftEntity craftEntity = entity.getBukkitEntity();
        ((CraftEndermite) craftEntity).setRemoveWhenFarAway(false);
...
//        World world = ((CraftWorld) location.getWorld()).getHandle();
//        CustomEndermiteRideable entity = new CustomEndermiteRideable(world, npcNms, speed, backMultiplier, sideMultiplier, walkHeight, jumpHeight);
//
//        entity.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
//        world.addEntity(entity);
//
...
//    }
    ...
    private static class CustomEndermiteNpc extends EntityEndermite {

        private final Collection<Option> options;

        CustomEndermiteNpc(World world) {
            this(world, new ArrayList<>());
        }

        CustomEndermiteNpc(World world, Collection<Option> options) {
...
//    private static class CustomEndermiteRideable extends EntityEndermite {
//
//        private final NpcNms npcNms;
//
...
//
//        CustomEndermiteRideable(World world) {
//            this(world, null, 0F, 0F, 0F, 0F, 0F); //DEFAULTS
//        }
//
//        CustomEndermiteRideable(World world, NpcNms npcNms, float speed, float backMultiplier, float sideMultiplier, float walkHeight, float jumpHeight) {
