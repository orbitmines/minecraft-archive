...
public class EnderDragonNpc_1_14_R1 implements EnderDragonNpc {

    private final NpcNms npcNms;

    public EnderDragonNpc_1_14_R1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomEnderDragonNpc entity = new CustomEnderDragonNpc(world, options);
...
//        World world = ((CraftWorld) location.getWorld()).getHandle();
//        CustomEnderDragonRideable entity = new CustomEnderDragonRideable(world, npcNms, speed, backMultiplier, sideMultiplier, walkHeight, jumpHeight);
//
//        entity.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
//        world.addEntity(entity);
//
...
//    }
    ...
    private static class CustomEnderDragonNpc extends EntityEnderDragon {

        private final Collection<Option> options;

        CustomEnderDragonNpc(World world) {
            this(world, new ArrayList<>());
        }

        CustomEnderDragonNpc(World world, Collection<Option> options) {
...
//    private static class CustomEnderDragonRideable extends EntityEnderDragon {
//
//        private final NpcNms npcNms;
//
...
//
//        CustomEnderDragonRideable(World world) {
//            this(world, null, 0F, 0F, 0F, 0F, 0F); //DEFAULTS
//        }
//
//        CustomEnderDragonRideable(World world, NpcNms npcNms, float speed, float backMultiplier, float sideMultiplier, float walkHeight, float jumpHeight) {
