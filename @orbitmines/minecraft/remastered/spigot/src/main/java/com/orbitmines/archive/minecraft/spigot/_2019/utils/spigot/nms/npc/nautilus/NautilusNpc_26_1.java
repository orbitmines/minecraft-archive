package com.orbitmines.archive.minecraft.spigot._2019.utils.spigot.nms.npc.nautilus;
...
public class NautilusNpc_26_1 implements NautilusNpc {

    private final NpcNms npcNms;

    public NautilusNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomNautilusNpc entity = new CustomNautilusNpc(level, options, npcNms);
        ...
        ((CraftNautilus) craftEntity).setRemoveWhenFarAway(false);
    ...
    private static class CustomNautilusNpc extends Nautilus {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomNautilusNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomNautilusNpc(Level level, Collection<Option> options, NpcNms npcNms) {
