package com.orbitmines.archive.minecraft.spigot._2019.utils.spigot.nms.npc.wither_skeleton;
...
public class WitherSkeletonNpc_1_14_R1 implements WitherSkeletonNpc {

    private final NpcNms npcNms;

    public WitherSkeletonNpc_1_14_R1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomSkeletonWitherNpc entity = new CustomSkeletonWitherNpc(world, options);

        entity.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
        world.addEntity(entity);

        CraftEntity craftEntity = entity.getBukkitEntity();
        ((CraftWitherSkeleton) craftEntity).setRemoveWhenFarAway(false);
...
//        World world = ((CraftWorld) location.getWorld()).getHandle();
//        CustomSkeletonWitherRideable entity = new CustomSkeletonWitherRideable(world, npcNms, speed, backMultiplier, sideMultiplier, walkHeight, jumpHeight);
//
//        entity.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
//        world.addEntity(entity);
//
...
//    }
    ...
    private static class CustomSkeletonWitherNpc extends EntitySkeletonWither {

        private final Collection<Option> options;

        CustomSkeletonWitherNpc(World world) {
            this(world, new ArrayList<>());
        }

        CustomSkeletonWitherNpc(World world, Collection<Option> options) {
...
//    private static class CustomSkeletonWitherRideable extends EntitySkeletonWither {
//
//        private final NpcNms npcNms;
//
...
//
//        CustomSkeletonWitherRideable(World world) {
//            this(world, null, 0F, 0F, 0F, 0F, 0F); //DEFAULTS
//        }
//
//        CustomSkeletonWitherRideable(World world, NpcNms npcNms, float speed, float backMultiplier, float sideMultiplier, float walkHeight, float jumpHeight) {
