...
public class SalmonNpc_1_14_R1 implements SalmonNpc {

    private final NpcNms npcNms;

    public SalmonNpc_1_14_R1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomSalmonNpc entity = new CustomSalmonNpc(world, options);
...
//        World world = ((CraftWorld) location.getWorld()).getHandle();
//        CustomSalmonRideable entity = new CustomSalmonRideable(world, npcNms, speed, backMultiplier, sideMultiplier, walkHeight, jumpHeight);
//
//        entity.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
//        world.addEntity(entity);
//
...
//    }
    ...
    private static class CustomSalmonNpc extends EntitySalmon {

        private final Collection<Option> options;

        CustomSalmonNpc(World world) {
            this(world, new ArrayList<>());
        }

        CustomSalmonNpc(World world, Collection<Option> options) {
...
//    private static class CustomSalmonRideable extends EntitySalmon {
//
//        private final NpcNms npcNms;
//
...
//
//        CustomSalmonRideable(World world) {
//            this(world, null, 0F, 0F, 0F, 0F, 0F); //DEFAULTS
//        }
//
//        CustomSalmonRideable(World world, NpcNms npcNms, float speed, float backMultiplier, float sideMultiplier, float walkHeight, float jumpHeight) {
