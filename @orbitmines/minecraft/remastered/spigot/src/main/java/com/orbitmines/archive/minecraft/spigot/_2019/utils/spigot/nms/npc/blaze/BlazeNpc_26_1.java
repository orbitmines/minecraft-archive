...
public class BlazeNpc_26_1 implements BlazeNpc {

    private final NpcNms npcNms;

    public BlazeNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomBlazeNpc entity = new CustomBlazeNpc(level, options, npcNms);
    ...
    private static class CustomBlazeNpc extends Blaze {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomBlazeNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomBlazeNpc(Level level, Collection<Option> options, NpcNms npcNms) {
