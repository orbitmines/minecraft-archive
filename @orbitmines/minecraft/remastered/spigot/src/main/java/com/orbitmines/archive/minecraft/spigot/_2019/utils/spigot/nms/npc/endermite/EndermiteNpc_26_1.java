...
public class EndermiteNpc_26_1 implements EndermiteNpc {

    private final NpcNms npcNms;

    public EndermiteNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomEndermiteNpc entity = new CustomEndermiteNpc(level, options, npcNms);
    ...
    private static class CustomEndermiteNpc extends Endermite {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomEndermiteNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomEndermiteNpc(Level level, Collection<Option> options, NpcNms npcNms) {
