...
public class MushroomCowNpc_26_1 implements MushroomCowNpc {

    private final NpcNms npcNms;

    public MushroomCowNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomMushroomCowNpc entity = new CustomMushroomCowNpc(level, options, npcNms);
    ...
    private static class CustomMushroomCowNpc extends MushroomCow {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomMushroomCowNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomMushroomCowNpc(Level level, Collection<Option> options, NpcNms npcNms) {
