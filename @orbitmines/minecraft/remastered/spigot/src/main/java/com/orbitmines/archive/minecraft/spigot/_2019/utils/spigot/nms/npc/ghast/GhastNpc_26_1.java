...
public class GhastNpc_26_1 implements GhastNpc {

    private final NpcNms npcNms;

    public GhastNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomGhastNpc entity = new CustomGhastNpc(level, options, npcNms);
    ...
    private static class CustomGhastNpc extends Ghast {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomGhastNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomGhastNpc(Level level, Collection<Option> options, NpcNms npcNms) {
