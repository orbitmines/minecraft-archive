package com.orbitmines.archive.minecraft.spigot._2019.utils.spigot.nms.npc.stray;
...
public class StrayNpc_1_14_R1 implements StrayNpc {

    private final NpcNms npcNms;

    public StrayNpc_1_14_R1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomSkeletonStrayNpc entity = new CustomSkeletonStrayNpc(world, options);

        entity.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
        world.addEntity(entity);

        CraftEntity craftEntity = entity.getBukkitEntity();
        ((CraftStray) craftEntity).setRemoveWhenFarAway(false);
...
//        World world = ((CraftWorld) location.getWorld()).getHandle();
//        CustomSkeletonStrayRideable entity = new CustomSkeletonStrayRideable(world, npcNms, speed, backMultiplier, sideMultiplier, walkHeight, jumpHeight);
//
//        entity.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
//        world.addEntity(entity);
//
...
//    }
    ...
    private static class CustomSkeletonStrayNpc extends EntitySkeletonStray {

        private final Collection<Option> options;

        CustomSkeletonStrayNpc(World world) {
            this(world, new ArrayList<>());
        }

        CustomSkeletonStrayNpc(World world, Collection<Option> options) {
...
//    private static class CustomSkeletonStrayRideable extends EntitySkeletonStray {
//
//        private final NpcNms npcNms;
//
...
//
//        CustomSkeletonStrayRideable(World world) {
//            this(world, null, 0F, 0F, 0F, 0F, 0F); //DEFAULTS
//        }
//
//        CustomSkeletonStrayRideable(World world, NpcNms npcNms, float speed, float backMultiplier, float sideMultiplier, float walkHeight, float jumpHeight) {
