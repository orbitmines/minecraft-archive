package com.orbitmines.archive.minecraft.spigot._2019.utils.spigot.nms.npc.axolotl;
...
public class AxolotlNpc_26_1 implements AxolotlNpc {

    private final NpcNms npcNms;

    public AxolotlNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomAxolotlNpc entity = new CustomAxolotlNpc(level, options, npcNms);
        ...
        ((CraftAxolotl) craftEntity).setRemoveWhenFarAway(false);
    ...
    private static class CustomAxolotlNpc extends Axolotl {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomAxolotlNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomAxolotlNpc(Level level, Collection<Option> options, NpcNms npcNms) {
