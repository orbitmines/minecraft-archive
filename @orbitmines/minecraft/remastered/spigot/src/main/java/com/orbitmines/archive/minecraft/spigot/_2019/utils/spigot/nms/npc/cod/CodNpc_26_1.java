...
public class CodNpc_26_1 implements CodNpc {

    private final NpcNms npcNms;

    public CodNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomCodNpc entity = new CustomCodNpc(level, options, npcNms);
    ...
    private static class CustomCodNpc extends Cod {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomCodNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomCodNpc(Level level, Collection<Option> options, NpcNms npcNms) {
            super(EntityType.COD, level);
