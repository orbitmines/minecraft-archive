...
public class WolfNpc_26_1 implements WolfNpc {

    private final NpcNms npcNms;

    public WolfNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomWolfNpc entity = new CustomWolfNpc(level, options, npcNms);
    ...
    private static class CustomWolfNpc extends Wolf {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomWolfNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomWolfNpc(Level level, Collection<Option> options, NpcNms npcNms) {
