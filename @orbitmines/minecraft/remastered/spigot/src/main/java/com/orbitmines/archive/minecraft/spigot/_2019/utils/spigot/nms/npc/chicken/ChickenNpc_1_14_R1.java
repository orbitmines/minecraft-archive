package com.orbitmines.archive.minecraft.spigot._2019.utils.spigot.nms.npc.chicken;
...
public class ChickenNpc_1_14_R1 implements ChickenNpc {

//    public static final EntityTypes<CustomChickenNpc> CHICKEN_NPC = EntityTypes.a("om_chicken_npc", EntityTypes.a.a(CustomChickenNpc.class, CustomChickenNpc::new));
//    public static final EntityTypes<CustomChickenRideable> CHICKEN_NPC_RIDEABLE = EntityTypes.a("om_chicken_rideable", EntityTypes.a.a(CustomChickenRideable.class, CustomChickenRideable::new));
//
//    static {
//        EntityTypes CHICKEN = new EntityTypes(this.a, this.b, this.c, this.d, null);
//    }

    private final NpcNms npcNms;

    public ChickenNpc_1_14_R1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
...
//        World world = ((CraftWorld) location.getWorld()).getHandle();
//        CustomChickenRideable entity = new CustomChickenRideable(world, npcNms, speed, backMultiplier, sideMultiplier, walkHeight, jumpHeight);
//
//        entity.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
//        world.addEntity(entity);
//
...
//    }
    ...
    private static class CustomChickenNpc extends EntityChicken {

        private final Collection<Option> options;

        CustomChickenNpc(World world) {
...
//    private static class CustomChickenRideable extends EntityChicken {
//
//        private final NpcNms npcNms;
//
...
//
//        CustomChickenRideable(World world) {
//            this(world, null, 0F, 0F, 0F, 0F, 0F); //DEFAULTS
//        }
//
//        CustomChickenRideable(World world, NpcNms npcNms, float speed, float backMultiplier, float sideMultiplier, float walkHeight, float jumpHeight) {
