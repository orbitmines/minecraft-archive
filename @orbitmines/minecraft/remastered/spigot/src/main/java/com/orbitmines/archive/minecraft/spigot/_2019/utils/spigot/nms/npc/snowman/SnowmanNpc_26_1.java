...
public class SnowmanNpc_26_1 implements SnowmanNpc {

    private final NpcNms npcNms;

    public SnowmanNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomSnowGolemNpc entity = new CustomSnowGolemNpc(level, options, npcNms);
    ...
    private static class CustomSnowGolemNpc extends SnowGolem {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomSnowGolemNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomSnowGolemNpc(Level level, Collection<Option> options, NpcNms npcNms) {
