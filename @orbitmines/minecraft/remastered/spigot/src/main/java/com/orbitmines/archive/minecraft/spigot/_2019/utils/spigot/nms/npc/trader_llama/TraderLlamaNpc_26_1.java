package com.orbitmines.archive.minecraft.spigot._2019.utils.spigot.nms.npc.trader_llama;
...
public class TraderLlamaNpc_26_1 implements TraderLlamaNpc {

    private final NpcNms npcNms;

    public TraderLlamaNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomTraderLlamaNpc entity = new CustomTraderLlamaNpc(level, options, npcNms);
        ...
        ((CraftTraderLlama) craftEntity).setRemoveWhenFarAway(false);
    ...
    private static class CustomTraderLlamaNpc extends TraderLlama {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomTraderLlamaNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomTraderLlamaNpc(Level level, Collection<Option> options, NpcNms npcNms) {
            super(EntityType.TRADER_LLAMA, level);
