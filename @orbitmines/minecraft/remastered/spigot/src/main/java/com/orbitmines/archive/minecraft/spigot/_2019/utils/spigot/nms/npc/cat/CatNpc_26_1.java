package com.orbitmines.archive.minecraft.spigot._2019.utils.spigot.nms.npc.cat;
...
public class CatNpc_26_1 implements CatNpc {

    private final NpcNms npcNms;

    public CatNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomCatNpc entity = new CustomCatNpc(level, options, npcNms);
        ...
        ((CraftCat) craftEntity).setRemoveWhenFarAway(false);
    ...
    private static class CustomCatNpc extends Cat {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomCatNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomCatNpc(Level level, Collection<Option> options, NpcNms npcNms) {
