...
public class MuleNpc_26_1 implements MuleNpc {

    private final NpcNms npcNms;

    public MuleNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomMuleNpc entity = new CustomMuleNpc(level, options, npcNms);
    ...
    private static class CustomMuleNpc extends Mule {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomMuleNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomMuleNpc(Level level, Collection<Option> options, NpcNms npcNms) {
            super(EntityType.MULE, level);
