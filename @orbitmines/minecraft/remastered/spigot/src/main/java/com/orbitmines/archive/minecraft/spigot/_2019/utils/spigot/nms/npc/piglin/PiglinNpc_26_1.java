package com.orbitmines.archive.minecraft.spigot._2019.utils.spigot.nms.npc.piglin;
...
public class PiglinNpc_26_1 implements PiglinNpc {

    private final NpcNms npcNms;

    public PiglinNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomPiglinNpc entity = new CustomPiglinNpc(level, options, npcNms);
        ...
        ((CraftPiglin) craftEntity).setRemoveWhenFarAway(false);
    ...
    private static class CustomPiglinNpc extends Piglin {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomPiglinNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomPiglinNpc(Level level, Collection<Option> options, NpcNms npcNms) {
