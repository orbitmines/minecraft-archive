 ...
 */
@Deprecated
public class KitPvPDataPointMapSpectatorSpawnpoint extends DataPointSign {

    @Getter private List<Location> spawns;

    public KitPvPDataPointMapSpectatorSpawnpoint() {
        super("SPECTATOR", Type.GOLD_PLATE, Material.BROWN_WOOL);
