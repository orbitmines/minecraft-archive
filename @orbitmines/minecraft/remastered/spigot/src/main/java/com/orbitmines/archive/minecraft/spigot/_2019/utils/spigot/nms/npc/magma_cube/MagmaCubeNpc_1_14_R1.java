package com.orbitmines.archive.minecraft.spigot._2019.utils.spigot.nms.npc.magma_cube;
...
public class MagmaCubeNpc_1_14_R1 implements MagmaCubeNpc {

    private final NpcNms npcNms;

    public MagmaCubeNpc_1_14_R1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomMagmaCubeNpc entity = new CustomMagmaCubeNpc(world, options);

        entity.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
        world.addEntity(entity);

        CraftEntity craftEntity = entity.getBukkitEntity();
        ((CraftMagmaCube) craftEntity).setRemoveWhenFarAway(false);
...
//        World world = ((CraftWorld) location.getWorld()).getHandle();
//        CustomMagmaCubeRideable entity = new CustomMagmaCubeRideable(world, npcNms, speed, backMultiplier, sideMultiplier, walkHeight, jumpHeight);
//
//        entity.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
//        world.addEntity(entity);
//
...
//    }
    ...
    private static class CustomMagmaCubeNpc extends EntityMagmaCube {

        private final Collection<Option> options;

        CustomMagmaCubeNpc(World world) {
            this(world, new ArrayList<>());
        }

        CustomMagmaCubeNpc(World world, Collection<Option> options) {
...
//            return options.contains(Option.DISABLE_SOUNDS) ? null : super.dv();
//        }
//
//        @Override
//        protected SoundEffect dw() {
//            return options.contains(Option.DISABLE_SOUNDS) ? null : super.dw();
//        }
    }

//    private static class CustomMagmaCubeRideable extends EntityMagmaCube {
//
//        private final NpcNms npcNms;
//
...
//
//        CustomMagmaCubeRideable(World world) {
//            this(world, null, 0F, 0F, 0F, 0F, 0F); //DEFAULTS
//        }
//
//        CustomMagmaCubeRideable(World world, NpcNms npcNms, float speed, float backMultiplier, float sideMultiplier, float walkHeight, float jumpHeight) {
