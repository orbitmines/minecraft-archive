...
public class KitMiner extends KitPvPKit {
    ...
    public KitMiner(KitPvP kitPvP) {
        super(
                ...
                Color.SILVER,
                new ItemBuilder(Material.GOLDEN_PICKAXE).addFlag(ItemFlag.HIDE_ATTRIBUTES),
    ...
    protected class Level1 extends Level {
        ...
        protected Kit<KitPvPPlayer> registerKit() {
            ...
            kit.set(0, player -> new KitItemBuilder(this, Material.GOLDEN_PICKAXE).addPassive(Passive.ATTACK_DAMAGE, 5).addEnchantment(Enchantment.UNBREAKING, 5));
            kit.set(1, player -> new KitItemBuilder(this, Material.COAL, 1, "§a§lHealing Kit").addActive(Active.HEALING_KIT, 1));
    ...
    protected class Level2 extends Level {
        ...
        protected Kit<KitPvPPlayer> registerKit() {
            ...
            kit.set(0, player -> new KitItemBuilder(this, Material.GOLDEN_PICKAXE).addPassive(Passive.ATTACK_DAMAGE, 6).addEnchantment(Enchantment.UNBREAKING, 5));
            kit.set(1, player -> new KitItemBuilder(this, Material.COAL, 2, "§a§lHealing Kit").addActive(Active.HEALING_KIT, 1));
    ...
    protected class Level3 extends Level {
        ...
        protected Kit<KitPvPPlayer> registerKit() {
            ...
            kit.set(0, player -> new KitItemBuilder(this, Material.GOLDEN_PICKAXE).addPassive(Passive.ATTACK_DAMAGE, 7).addEnchantment(Enchantment.UNBREAKING, 5));
            kit.set(1, player -> new KitItemBuilder(this, Material.COAL, 3, "§a§lHealing Kit").addActive(Active.HEALING_KIT, 1));
