...
public class HorseNpc_26_1 implements HorseNpc {

    private final NpcNms npcNms;

    public HorseNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomHorseNpc entity = new CustomHorseNpc(level, options, npcNms);
    ...
    private static class CustomHorseNpc extends Horse {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomHorseNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomHorseNpc(Level level, Collection<Option> options, NpcNms npcNms) {
