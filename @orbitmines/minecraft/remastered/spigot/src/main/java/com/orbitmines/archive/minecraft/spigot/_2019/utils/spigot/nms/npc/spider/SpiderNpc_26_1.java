...
public class SpiderNpc_26_1 implements SpiderNpc {

    private final NpcNms npcNms;

    public SpiderNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomSpiderNpc entity = new CustomSpiderNpc(level, options, npcNms);
    ...
    private static class CustomSpiderNpc extends Spider {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomSpiderNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomSpiderNpc(Level level, Collection<Option> options, NpcNms npcNms) {
