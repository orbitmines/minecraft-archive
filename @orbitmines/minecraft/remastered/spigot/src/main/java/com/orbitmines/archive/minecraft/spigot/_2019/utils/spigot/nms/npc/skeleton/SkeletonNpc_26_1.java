...
public class SkeletonNpc_26_1 implements SkeletonNpc {

    private final NpcNms npcNms;

    public SkeletonNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomSkeletonNpc entity = new CustomSkeletonNpc(level, options, npcNms);
    ...
    private static class CustomSkeletonNpc extends Skeleton {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomSkeletonNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomSkeletonNpc(Level level, Collection<Option> options, NpcNms npcNms) {
