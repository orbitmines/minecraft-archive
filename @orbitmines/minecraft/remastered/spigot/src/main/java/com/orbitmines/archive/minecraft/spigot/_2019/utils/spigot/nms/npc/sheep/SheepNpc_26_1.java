...
public class SheepNpc_26_1 implements SheepNpc {

    private final NpcNms npcNms;

    public SheepNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomSheepNpc entity = new CustomSheepNpc(level, options, npcNms);
    ...
    private static class CustomSheepNpc extends Sheep {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomSheepNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomSheepNpc(Level level, Collection<Option> options, NpcNms npcNms) {
