package com.orbitmines.archive.minecraft.spigot._2019.utils.spigot.nms.npc.tadpole;
...
public class TadpoleNpc_26_1 implements TadpoleNpc {

    private final NpcNms npcNms;

    public TadpoleNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    private static class CustomTadpoleNpc extends Tadpole {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomTadpoleNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomTadpoleNpc(Level level, Collection<Option> options, NpcNms npcNms) {
