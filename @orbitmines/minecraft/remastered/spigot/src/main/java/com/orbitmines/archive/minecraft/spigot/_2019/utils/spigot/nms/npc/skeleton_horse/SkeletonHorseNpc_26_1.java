package com.orbitmines.archive.minecraft.spigot._2019.utils.spigot.nms.npc.skeleton_horse;
...
public class SkeletonHorseNpc_26_1 implements SkeletonHorseNpc {

    private final NpcNms npcNms;

    public SkeletonHorseNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomSkeletonHorseNpc entity = new CustomSkeletonHorseNpc(level, options, npcNms);
    ...
    private static class CustomSkeletonHorseNpc extends SkeletonHorse {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomSkeletonHorseNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomSkeletonHorseNpc(Level level, Collection<Option> options, NpcNms npcNms) {
