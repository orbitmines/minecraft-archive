...
public class KitFisherman extends KitPvPKit {
    ...
    protected class Level1 extends Level {
        ...
        protected Kit<KitPvPPlayer> registerKit() {
            ...
            kit.set(0, player -> new KitItemBuilder(this, Material.FISHING_ROD).addPassive(Passive.ATTACK_DAMAGE, 6));
    ...
    protected class Level2 extends Level {
        ...
        protected Kit<KitPvPPlayer> registerKit() {
            ...
            kit.set(0, player -> new KitItemBuilder(this, Material.FISHING_ROD).addPassive(Passive.ATTACK_DAMAGE, 7));
    ...
    protected class Level3 extends Level {
        ...
        protected Kit<KitPvPPlayer> registerKit() {
            ...
            kit.set(0, player -> new KitItemBuilder(this, Material.FISHING_ROD).addPassive(Passive.ATTACK_DAMAGE, 8));
