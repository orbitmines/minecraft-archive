...
public class VillagerNpc_26_1 implements VillagerNpc {

    private final NpcNms npcNms;

    public VillagerNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomVillagerNpc entity = new CustomVillagerNpc(level, options, npcNms);
    ...
    private static class CustomVillagerNpc extends Villager {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomVillagerNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomVillagerNpc(Level level, Collection<Option> options, NpcNms npcNms) {
