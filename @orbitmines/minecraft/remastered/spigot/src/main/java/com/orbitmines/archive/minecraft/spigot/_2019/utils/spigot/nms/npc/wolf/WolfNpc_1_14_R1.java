package com.orbitmines.archive.minecraft.spigot._2019.utils.spigot.nms.npc.wolf;
...
public class WolfNpc_1_14_R1 implements WolfNpc {

    private final NpcNms npcNms;

    public WolfNpc_1_14_R1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomWolfNpc entity = new CustomWolfNpc(world, options);

        entity.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
        world.addEntity(entity);

        CraftEntity craftEntity = entity.getBukkitEntity();
        ((CraftWolf) craftEntity).setRemoveWhenFarAway(false);
...
//        World world = ((CraftWorld) location.getWorld()).getHandle();
//        CustomWolfRideable entity = new CustomWolfRideable(world, npcNms, speed, backMultiplier, sideMultiplier, walkHeight, jumpHeight);
//
//        entity.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
//        world.addEntity(entity);
//
...
//    }
    ...
    private static class CustomWolfNpc extends EntityWolf {

        private final Collection<Option> options;

        CustomWolfNpc(World world) {
            this(world, new ArrayList<>());
        }

        CustomWolfNpc(World world, Collection<Option> options) {
...
//    private static class CustomWolfRideable extends EntityWolf {
//
//        private final NpcNms npcNms;
//
...
//
//        CustomWolfRideable(World world) {
//            this(world, null, 0F, 0F, 0F, 0F, 0F); //DEFAULTS
//        }
//
//        CustomWolfRideable(World world, NpcNms npcNms, float speed, float backMultiplier, float sideMultiplier, float walkHeight, float jumpHeight) {
