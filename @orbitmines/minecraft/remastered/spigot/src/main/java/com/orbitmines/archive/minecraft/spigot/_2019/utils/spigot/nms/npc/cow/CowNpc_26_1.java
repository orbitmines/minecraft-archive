...
public class CowNpc_26_1 implements CowNpc {

    private final NpcNms npcNms;

    public CowNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomCowNpc entity = new CustomCowNpc(level, options, npcNms);
    ...
    private static class CustomCowNpc extends Cow {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomCowNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomCowNpc(Level level, Collection<Option> options, NpcNms npcNms) {
