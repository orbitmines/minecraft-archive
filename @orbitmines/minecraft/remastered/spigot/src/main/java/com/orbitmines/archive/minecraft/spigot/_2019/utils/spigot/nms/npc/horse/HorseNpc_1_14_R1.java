package com.orbitmines.archive.minecraft.spigot._2019.utils.spigot.nms.npc.horse;
...
public class HorseNpc_1_14_R1 implements HorseNpc {

    private final NpcNms npcNms;

    public HorseNpc_1_14_R1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomHorseNpc entity = new CustomHorseNpc(world, options);

        entity.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
        world.addEntity(entity);

        CraftEntity craftEntity = entity.getBukkitEntity();
        ((CraftHorse) craftEntity).setRemoveWhenFarAway(false);
...
//        World world = ((CraftWorld) location.getWorld()).getHandle();
//        CustomHorseRideable entity = new CustomHorseRideable(world, npcNms, speed, backMultiplier, sideMultiplier, walkHeight, jumpHeight);
//
//        entity.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
//        world.addEntity(entity);
//
...
//    }
    ...
    private static class CustomHorseNpc extends EntityHorse {

        private final Collection<Option> options;

        CustomHorseNpc(World world) {
            this(world, new ArrayList<>());
        }

        CustomHorseNpc(World world, Collection<Option> options) {
...
//    private static class CustomHorseRideable extends EntityHorse {
//
//        private final NpcNms npcNms;
//
...
//
//        CustomHorseRideable(World world) {
//            this(world, null, 0F, 0F, 0F, 0F, 0F); //DEFAULTS
//        }
//
//        CustomHorseRideable(World world, NpcNms npcNms, float speed, float backMultiplier, float sideMultiplier, float walkHeight, float jumpHeight) {
