...
public class KitBeast extends KitPvPKit {
    ...
    public KitBeast(KitPvP kitPvP) {
        super(
                ...
                Color.GRAY,
                new ItemBuilder(Material.IRON_AXE).addFlag(ItemFlag.HIDE_ATTRIBUTES),
    ...
    protected class Level1 extends Level {
        ...
        protected Kit<KitPvPPlayer> registerKit() {
            ...
            kit.set(0, player -> new KitItemBuilder(this, Material.IRON_AXE).addPassive(Passive.KNOCKUP, 1).addEnchantment(Enchantment.SHARPNESS, 1));
    ...
    protected class Level2 extends Level {
        ...
        protected Kit<KitPvPPlayer> registerKit() {
            ...
            kit.set(0, player -> new KitItemBuilder(this, Material.IRON_AXE).addPassive(Passive.KNOCKUP, 1).addEnchantment(Enchantment.SHARPNESS, 2));
    ...
    protected class Level3 extends Level {
        ...
        protected Kit<KitPvPPlayer> registerKit() {
            ...
            kit.set(0, player -> new KitItemBuilder(this, Material.IRON_AXE).addPassive(Passive.KNOCKUP, 2).addEnchantment(Enchantment.SHARPNESS, 2));
