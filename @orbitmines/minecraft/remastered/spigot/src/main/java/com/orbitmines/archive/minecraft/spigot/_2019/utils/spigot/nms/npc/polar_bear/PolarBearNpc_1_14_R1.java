package com.orbitmines.archive.minecraft.spigot._2019.utils.spigot.nms.npc.polar_bear;
...
public class PolarBearNpc_1_14_R1 implements PolarBearNpc {

    private final NpcNms npcNms;

    public PolarBearNpc_1_14_R1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomPolarBearNpc entity = new CustomPolarBearNpc(world, options);

        entity.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
        world.addEntity(entity);

        CraftEntity craftEntity = entity.getBukkitEntity();
        ((CraftPolarBear) craftEntity).setRemoveWhenFarAway(false);
...
//        World world = ((CraftWorld) location.getWorld()).getHandle();
//        CustomPolarBearRideable entity = new CustomPolarBearRideable(world, npcNms, speed, backMultiplier, sideMultiplier, walkHeight, jumpHeight);
//
//        entity.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
//        world.addEntity(entity);
//
...
//    }
    ...
    private static class CustomPolarBearNpc extends EntityPolarBear {

        private final Collection<Option> options;

        CustomPolarBearNpc(World world) {
            this(world, new ArrayList<>());
        }

        CustomPolarBearNpc(World world, Collection<Option> options) {
...
//    private static class CustomPolarBearRideable extends EntityPolarBear {
//
//        private final NpcNms npcNms;
//
...
//
//        CustomPolarBearRideable(World world) {
//            this(world, null, 0F, 0F, 0F, 0F, 0F); //DEFAULTS
//        }
//
//        CustomPolarBearRideable(World world, NpcNms npcNms, float speed, float backMultiplier, float sideMultiplier, float walkHeight, float jumpHeight) {
