...
public class PigNpc_26_1 implements PigNpc {

    private final NpcNms npcNms;

    public PigNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomPigNpc entity = new CustomPigNpc(level, options, npcNms);
    ...
    private static class CustomPigNpc extends Pig {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomPigNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomPigNpc(Level level, Collection<Option> options, NpcNms npcNms) {
