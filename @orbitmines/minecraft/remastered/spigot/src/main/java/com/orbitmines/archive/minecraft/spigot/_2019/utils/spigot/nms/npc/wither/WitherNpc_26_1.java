...
public class WitherNpc_26_1 implements WitherNpc {

    private final NpcNms npcNms;

    public WitherNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomWitherBossNpc entity = new CustomWitherBossNpc(level, options, npcNms);
    ...
    private static class CustomWitherBossNpc extends WitherBoss {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomWitherBossNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomWitherBossNpc(Level level, Collection<Option> options, NpcNms npcNms) {
