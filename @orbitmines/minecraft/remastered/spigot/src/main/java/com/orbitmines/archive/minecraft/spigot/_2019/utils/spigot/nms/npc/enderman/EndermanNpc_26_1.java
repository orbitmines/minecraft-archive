...
public class EndermanNpc_26_1 implements EndermanNpc {

    private final NpcNms npcNms;

    public EndermanNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomEnderManNpc entity = new CustomEnderManNpc(level, options, npcNms);
    ...
    private static class CustomEnderManNpc extends EnderMan {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomEnderManNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomEnderManNpc(Level level, Collection<Option> options, NpcNms npcNms) {
