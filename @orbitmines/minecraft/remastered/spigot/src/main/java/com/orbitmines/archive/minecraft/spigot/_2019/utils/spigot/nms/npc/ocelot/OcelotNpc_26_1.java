...
public class OcelotNpc_26_1 implements OcelotNpc {

    private final NpcNms npcNms;

    public OcelotNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomOcelotNpc entity = new CustomOcelotNpc(level, options, npcNms);
    ...
    private static class CustomOcelotNpc extends Ocelot {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomOcelotNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomOcelotNpc(Level level, Collection<Option> options, NpcNms npcNms) {
