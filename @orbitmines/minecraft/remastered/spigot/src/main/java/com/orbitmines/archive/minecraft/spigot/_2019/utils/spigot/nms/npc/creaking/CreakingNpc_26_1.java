package com.orbitmines.archive.minecraft.spigot._2019.utils.spigot.nms.npc.creaking;
...
public class CreakingNpc_26_1 implements CreakingNpc {

    private final NpcNms npcNms;

    public CreakingNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomCreakingNpc entity = new CustomCreakingNpc(level, options, npcNms);
        ...
        ((CraftCreaking) craftEntity).setRemoveWhenFarAway(false);
    ...
    private static class CustomCreakingNpc extends Creaking {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomCreakingNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomCreakingNpc(Level level, Collection<Option> options, NpcNms npcNms) {
