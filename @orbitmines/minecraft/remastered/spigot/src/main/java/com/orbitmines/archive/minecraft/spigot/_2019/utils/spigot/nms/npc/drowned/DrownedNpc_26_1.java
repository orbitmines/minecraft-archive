...
public class DrownedNpc_26_1 implements DrownedNpc {
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomDrownedNpc entity = new CustomDrownedNpc(level, options, npcNms);
    ...
    private static class CustomDrownedNpc extends Drowned {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomDrownedNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomDrownedNpc(Level level, Collection<Option> options, NpcNms npcNms) {
