...
public class PolarBearNpc_26_1 implements PolarBearNpc {

    private final NpcNms npcNms;

    public PolarBearNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomPolarBearNpc entity = new CustomPolarBearNpc(level, options, npcNms);
    ...
    private static class CustomPolarBearNpc extends PolarBear {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomPolarBearNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomPolarBearNpc(Level level, Collection<Option> options, NpcNms npcNms) {
