package com.orbitmines.archive.minecraft.spigot._2019.utils.spigot.nms.npc.creeper;
...
public class CreeperNpc_1_14_R1 implements CreeperNpc {

    private final NpcNms npcNms;

    public CreeperNpc_1_14_R1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomCreeperNpc entity = new CustomCreeperNpc(world, options);

        entity.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
        world.addEntity(entity);

        CraftEntity craftEntity = entity.getBukkitEntity();
        ((CraftCreeper) craftEntity).setRemoveWhenFarAway(false);
...
//        World world = ((CraftWorld) location.getWorld()).getHandle();
//        CustomCreeperRideable entity = new CustomCreeperRideable(world, npcNms, speed, backMultiplier, sideMultiplier, walkHeight, jumpHeight);
//
//        entity.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
//        world.addEntity(entity);
//
...
//    }
    ...
    private static class CustomCreeperNpc extends EntityCreeper {

        private final Collection<Option> options;

        CustomCreeperNpc(World world) {
            this(world, new ArrayList<>());
        }

        CustomCreeperNpc(World world, Collection<Option> options) {
...
//    private static class CustomCreeperRideable extends EntityCreeper {
//
//        private final NpcNms npcNms;
//
...
//
//        CustomCreeperRideable(World world) {
//            this(world, null, 0F, 0F, 0F, 0F, 0F); //DEFAULTS
//        }
//
//        CustomCreeperRideable(World world, NpcNms npcNms, float speed, float backMultiplier, float sideMultiplier, float walkHeight, float jumpHeight) {
