package com.orbitmines.archive.minecraft.spigot._2019.utils.spigot.nms.npc.parched;
...
public class ParchedNpc_26_1 implements ParchedNpc {

    private final NpcNms npcNms;

    public ParchedNpc_26_1(NpcNms npcNms) {
        this.npcNms = npcNms;
    }
    ...
    public Entity spawn(Location location, Collection<Option> options) {
        ...
        CustomParchedNpc entity = new CustomParchedNpc(level, options, npcNms);
        ...
        ((CraftParched) craftEntity).setRemoveWhenFarAway(false);
    ...
    private static class CustomParchedNpc extends Parched {

        private final Collection<Option> options;
        private final NpcNms npcNms;

        CustomParchedNpc(Level level) {
            this(level, new ArrayList<>(), null);
        }

        CustomParchedNpc(Level level, Collection<Option> options, NpcNms npcNms) {
