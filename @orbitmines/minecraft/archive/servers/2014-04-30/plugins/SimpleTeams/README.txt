...
Simple Teams is a simple to use, powerful, flexible, PvP team management system. 
The plugin allows for two teams (Red and Blue) that players may join to work with. 
Best of all most aspects of the plugin can be changed to suite your needs!

========================================== CONFIG ==========================================

Sometimes the config has to be saved by the plugin, when that happens, the comments
aren't saved. In the event that occurs, here is a description of each node in the
config:

(alternatively, if you delete the config, it will reset itself and the comments will return)
...
CanOnlyHurtPlayersWithTeam: true
...
Messages:
  ...
  JoinFullTeamAttempt: 'Sorry! That team is full, you cannot join it!'
  ...
  HurtTeamMemberAttempt: 'You cant hurt your team members!'
  ...
  AttackPlayerWithoutTeam: 'You cannot hurt players when you are not on a team!'

  # Sent when a player on a team attacks a player not on a team (goes to attacker)
  # CanOnlyHurtPlayersWithTeam must be true to trigger this message
  AttackPlayerNotOnTeam: 'You cannot hurt players who are not on a team!'

  # Sent when a player switches teams (goes to team switched out of)
  # CanSwitchDirectly must be true to trigger this message
  PlayerSwitchTeams: 'Someone has betrayed the team and joined the enemy!'

  # Sent when a player is denied switching teams (goes to player attempting to switch)
  PlayerSwitchTeamsFailed: 'You are not permitted to switch teams like that!'

  # Sent when a player joins a team (goes to team joined)
  PlayerJoinTeam: 'Welcome to the team!'

  # Sent to player when they join a team
  TeamJoined: 'An ally has been gained! A player has joined the team!'
  
  # Sent when a player leaves a team (goes to team left)
  PlayerLeaveTeam: 'A player has left your team!'
  
  # Sent to a player when they leave a team
  TeamLeft: 'You have left the team'
