...
import me.O_o_Fadi_o_O.OMHub.utils.orbitmines.Inventories.ConfirmInv;
import me.O_o_Fadi_o_O.OMHub.utils.orbitmines.Inventories.ServerSelectorInv;
import me.O_o_Fadi_o_O.OMHub.utils.orbitmines.Inventories.WardrobeInv;
...
public class Runnables {
	...
	public class EntityRunnable extends BukkitRunnable {
		...
		public void removeEntity(final Entity en, int seconds){
			...
			}.runTaskLater(Start.getInstance(), 20 * seconds);
		}
