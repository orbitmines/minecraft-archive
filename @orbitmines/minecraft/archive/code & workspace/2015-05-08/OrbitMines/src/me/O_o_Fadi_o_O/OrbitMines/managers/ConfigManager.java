...
public class ConfigManager {
	...
	public static void setup(){
		...
		if(!cfile.exists()){
			try{
				...
				Bukkit.getConsoleSender().sendMessage("[IslandChallenges] Error while creating config.yml");
			}
		}
	...
	public static void saveConfig(){
		try{
			...
			Bukkit.getConsoleSender().sendMessage("[IslandChallenges] Error while saving config.yml");
		}
	}
