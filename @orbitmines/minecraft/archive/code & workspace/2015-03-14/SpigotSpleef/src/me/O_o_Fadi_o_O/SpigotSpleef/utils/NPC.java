...
public class NPC {
	...
	public void newEntity(EntityType entitytype, Location location, String displayname){
		...
		switch(entitytype){
			...
			case GIANT:
				break;
			case GUARDIAN:
				spawnGuardian(w, location, displayname);
				break;
			case HORSE:
			...
			case WITCH:
				...
				break;
			case WITHER:
				spawnWither(w, location, displayname);
				break;
			case WITHER_SKULL:
				break;
			case WOLF:
	...
	private void spawnGuardian(World w, Location location, String displayname){
	    net.minecraft.server.v1_8_R2.World nmsWorld = ((CraftWorld) w).getHandle();
	    final CustomGuardian e = new CustomGuardian(nmsWorld);
	    e.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
	    nmsWorld.addEntity(e);
	    e.setCustomName(displayname);
	    e.setCustomNameVisible(true);
	...
	private void spawnWither(World w, Location location, String displayname){
	    net.minecraft.server.v1_8_R2.World nmsWorld = ((CraftWorld) w).getHandle();
	    final CustomWither e = new CustomWither(nmsWorld);
	    e.setPositionRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
	    nmsWorld.addEntity(e);
	    e.setCustomName(displayname);
	    e.setCustomNameVisible(true);
