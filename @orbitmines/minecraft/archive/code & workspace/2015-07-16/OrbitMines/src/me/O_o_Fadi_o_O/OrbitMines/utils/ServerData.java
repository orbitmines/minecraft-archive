...
public class ServerData {
	...
	public static class MiniGamesServer {
		...
		private List<SGChestItem> sgchestpotions;
		...
		public List<SGChestItem> getSGChestPotions() {
			return sgchestpotions;
		}
		public void setSGChestPotions(List<SGChestItem> sgchestpotions) {
		...
		private void registerSGChestItems(){
			...
			this.sgchestpotions = new ArrayList<SGChestItem>();
			this.sgchestpotions.add(new SGChestItem(Material.POTION, 1, 1, null, 8193, 10));
			this.sgchestpotions.add(new SGChestItem(Material.POTION, 1, 1, null, 8225, 5));
			this.sgchestpotions.add(new SGChestItem(Material.POTION, 1, 1, null, 8194, 15));
			this.sgchestpotions.add(new SGChestItem(Material.POTION, 1, 1, null, 8226, 5));
			this.sgchestpotions.add(new SGChestItem(Material.POTION, 1, 1, null, 8227, 8));
			this.sgchestpotions.add(new SGChestItem(Material.POTION, 1, 1, null, 8259, 8));
			this.sgchestpotions.add(new SGChestItem(Material.POTION, 1, 1, null, 16388, 7));
			this.sgchestpotions.add(new SGChestItem(Material.POTION, 1, 1, null, 16420, 7));
			this.sgchestpotions.add(new SGChestItem(Material.POTION, 1, 1, null, 16452, 7));
			this.sgchestpotions.add(new SGChestItem(Material.POTION, 1, 1, null, 16453, 5));
			this.sgchestpotions.add(new SGChestItem(Material.POTION, 1, 1, null, 16421, 2));
			this.sgchestpotions.add(new SGChestItem(Material.POTION, 1, 1, null, 8261, 7));
			this.sgchestpotions.add(new SGChestItem(Material.POTION, 1, 1, null, 8262, 8));
			this.sgchestpotions.add(new SGChestItem(Material.POTION, 1, 1, null, 16424, 7));
			this.sgchestpotions.add(new SGChestItem(Material.POTION, 1, 1, null, 16456, 7));
			this.sgchestpotions.add(new SGChestItem(Material.POTION, 1, 1, null, 8201, 2));
			this.sgchestpotions.add(new SGChestItem(Material.POTION, 1, 1, null, 16426, 7));
			this.sgchestpotions.add(new SGChestItem(Material.POTION, 1, 1, null, 16458, 7));
			this.sgchestpotions.add(new SGChestItem(Material.POTION, 1, 1, null, 8203, 4));
			this.sgchestpotions.add(new SGChestItem(Material.POTION, 1, 1, null, 8235, 4));
			this.sgchestpotions.add(new SGChestItem(Material.POTION, 1, 1, null, 16460, 6));
			this.sgchestpotions.add(new SGChestItem(Material.POTION, 1, 1, null, 16428, 6));
			this.sgchestpotions.add(new SGChestItem(Material.POTION, 1, 1, null, 8269, 7));
			this.sgchestpotions.add(new SGChestItem(Material.POTION, 1, 1, null, 8238, 3));
			this.sgchestpotions.add(new SGChestItem(Material.POTION, 1, 1, null, 8270, 2));
		}
	}
}
