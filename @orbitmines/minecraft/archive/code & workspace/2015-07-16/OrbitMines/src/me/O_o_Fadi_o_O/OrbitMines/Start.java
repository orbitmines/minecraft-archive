...
public class Start extends JavaPlugin {
	...
	private void registerAllEvents(){
		getServer().getPluginManager().registerEvents(new BreakEvent(), this);//Hub, KitPvP, Creative, Survival, SkyBlock, MiniGames
		getServer().getPluginManager().registerEvents(new ClickEvent(), this);//Hub, KitPvP, Creative, Survival, SkyBlock, MiniGames
		getServer().getPluginManager().registerEvents(new CommandPreprocessEvent(), this);//Hub, KitPvP, Creative, Survival, SkyBlock, MiniGames
		getServer().getPluginManager().registerEvents(new DamageEvent(), this);//Hub, KitPvP, Creative, Survival, SkyBlock, MiniGames
		getServer().getPluginManager().registerEvents(new EntityDamage(), this);//Hub, KitPvP, Creative, Survival, SkyBlock, MiniGames
		getServer().getPluginManager().registerEvents(new EntityDeath(), this);//Hub, KitPvP, Creative, Survival, SkyBlock, MiniGames
		getServer().getPluginManager().registerEvents(new EntityInteractEvent(), this);//Hub, KitPvP, Creative, Survival, SkyBlock, MiniGames
		getServer().getPluginManager().registerEvents(new InteractAtEntityEvent(), this);//Hub, KitPvP, Creative, Survival, SkyBlock, MiniGames
		getServer().getPluginManager().registerEvents(new JoinEvent(), this);//Hub, KitPvP, Creative, Survival, SkyBlock, MiniGames
		getServer().getPluginManager().registerEvents(new PlaceEvent(), this);//Hub, KitPvP, Creative, Survival, SkyBlock, MiniGames
		getServer().getPluginManager().registerEvents(new PlayerChat(), this);//Hub, KitPvP, Creative, Survival, SkyBlock, MiniGames
		getServer().getPluginManager().registerEvents(new PlayerInteract(), this);//Hub, KitPvP, Creative, Survival, SkyBlock, MiniGames
		getServer().getPluginManager().registerEvents(new PlayerMove(), this);//Hub, KitPvP, Creative, Survival, SkyBlock, MiniGames
		getServer().getPluginManager().registerEvents(new QuitEvent(), this);//Hub, KitPvP, Creative, Survival, SkyBlock, MiniGames
		getServer().getPluginManager().registerEvents(new SignEvent(), this);//Hub, KitPvP, Creative, Survival, SkyBlock, MiniGames
		getServer().getPluginManager().registerEvents(new VoteEvent(), this);//Hub, KitPvP, Creative, Survival, SkyBlock, MiniGames
		getServer().getPluginManager().registerEvents(new WorldChangeEvent(), this);//Hub, KitPvP, Creative, Survival, SkyBlock, MiniGames
