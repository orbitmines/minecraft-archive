...
public class Island {
	...
	public Location getNetherLocation(){
		return new Location(ServerData.getSkyBlock().getSkyblockNetherWorld(), getLocation().getX(), 50.0, getLocation().getY());
	}
	public Location getNetherHomeLocation(){
		return new Location(ServerData.getSkyBlock().getSkyblockNetherWorld(), getLocation().getX() +0.5, 51.0, getLocation().getY() +0.5, 180, 0);
	}
