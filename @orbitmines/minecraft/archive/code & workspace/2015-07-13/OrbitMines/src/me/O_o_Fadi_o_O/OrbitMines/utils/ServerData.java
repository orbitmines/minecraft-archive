...
public class ServerData {
	...
	public static class MiniGamesServer {
		...
		private void registerMaps(){
			...
			{
				Map map = new Map("Abrax Park", "§fxFrozenYeti§7, §fiClarify", MiniGameType.SURVIVAL_GAMES, "AbraxParkSG");
			...
			{
				Map map = new Map("Breeze Island 2", "§fxBayani§7, §fstatic_nightmare§7, §fcameron224", MiniGameType.SURVIVAL_GAMES, "Breeze_Island2");
			...
			{
				Map map = new Map("Estyr", "§fTeam Dmon", MiniGameType.SURVIVAL_GAMES, "Estyr");
			...
			{
				Map map = new Map("Rise of the Orient", "§fTeam OPAlien", MiniGameType.SURVIVAL_GAMES, "Rise_of_the_Orient");
