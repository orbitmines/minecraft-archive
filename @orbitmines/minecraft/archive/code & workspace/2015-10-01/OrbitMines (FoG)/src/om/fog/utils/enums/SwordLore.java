...
public enum SwordLore {
	...
	public static ItemStack random(){
		...
		SwordLoreLevel sl = getLore(rarity);
		
		meta.setDisplayName(rarity.getColor() + "§l" + sl.getLore().getName() + " " + FoGUtils.parseString(sl.getLevel()));
		List<String> lore = new ArrayList<String>();
		lore.add(rarity.getName() + " Enchantment §7(Swords)");
		meta.setLore(lore);
		item.setItemMeta(meta);
