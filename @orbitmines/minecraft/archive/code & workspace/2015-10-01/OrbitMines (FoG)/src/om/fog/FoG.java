...
public class FoG extends JavaPlugin {
	...
	private void spawnNPCs(){
		...
		{
			NPCArmorStand npcas = new NPCArmorStand(NPCType.TRAINING_SUIT, new Location(getGalaxyWorld(), 268.4, 20, 3842.5, 90, 0));
			npcas.setGravity(false);
			npcas.setVisible(false);
	...
	private void registerMaps(){
		...
		this.spawnAreas = new ArrayList<SpawnArea>();
		{
			...
			SpawnArea sa1 = new SpawnArea(map, 216, 3813, 123, 3793);
			sa1.addMob(Mob.ZOMBIE, 1, 10, 6);
			this.spawnAreas.add(sa1);
			
			SpawnArea sa2 = new SpawnArea(map, 252, 3792, 123, 3725);
			sa2.addMob(Mob.ZOMBIE, 1, 30, 6);
			this.spawnAreas.add(sa2);
			
			SpawnArea sa3 = new SpawnArea(map, 252, 3724, 123, 3657);
			sa3.addMob(Mob.ZOMBIE, 2, 25, 6);
			sa3.addMob(Mob.ZOMBIE_ARCHER, 1, 5, 12);
			this.spawnAreas.add(sa3);
			
			SpawnArea sa4 = new SpawnArea(map, 100, 3806, 118, 3846);
			sa4.addMob(Mob.ZOMBIE, 2, 8, 6);
			sa4.addMob(Mob.ZOMBIE_ARCHER, 1, 2, 12);
			this.spawnAreas.add(sa4);
			
			SpawnArea sa5 = new SpawnArea(map, 252, 3656, 123, 3590);
			sa5.addMob(Mob.ZOMBIE, 2, 15, 6);
			sa5.addMob(Mob.ZOMBIE_ARCHER, 2, 15, 12);
			this.spawnAreas.add(sa5);
		}
	}
