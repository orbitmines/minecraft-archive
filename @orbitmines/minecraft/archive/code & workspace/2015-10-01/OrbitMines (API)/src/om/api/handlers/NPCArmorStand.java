...
public class NPCArmorStand {
	...
	public NPCArmorStand(NPCType npctype, Location location){
		...
		api.getNPCArmorStands().add(this);
	}
	...
	public boolean update(Entity en){
		if(en instanceof ArmorStand && en.getWorld().getName().equals(getLocation().getWorld().getName()) && getLocation().distance(en.getLocation()) <= 0.1){
