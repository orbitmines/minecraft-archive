...
public class Start extends Plugin {
	...
	@SuppressWarnings("deprecation")
	public static void sendMessageNullCheck(ProxiedPlayer p, String message){
		try{
	...
	public static void loadDomainWhitelistData(boolean startup){
	...
	private void checkForOlderConfig(){
		...
		if(ConfigManager.config.get("GlobalChat.Groups.1.Servers") == null){
		...
		if(ConfigManager.config.get("GlobalChat.Groups.1.Message") == null){
		...
		if(ConfigManager.config.get("GlobalChat.Groups.2.Servers") == null){
		...
		if(ConfigManager.config.get("GlobalChat.Groups.2.Message") == null){
