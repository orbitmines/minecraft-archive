...
public enum TicketType {
    ...
    public List<String> getDescription(HubPlayer omp){
        switch(this){
            ...
            case CHICKEN_WARLORD_KIT:
                return Arrays.asList("Ability: Iron Fist", HubMessages.INV_TAKEN_KNOCKBACK.get(omp) + ": 90%", HubMessages.INV_TAKEN_DAMAGE.get(omp) + ": 80%", HubMessages.WORD_DAMAGE.get(omp) + ": 150%", getUses().getName());
            case HOT_WING_KIT:
