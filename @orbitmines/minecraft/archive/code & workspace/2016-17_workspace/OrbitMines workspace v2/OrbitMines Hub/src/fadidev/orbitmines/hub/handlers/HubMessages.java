...
public class HubMessages {
    ...
    public static Message ALREADY_CLAIMED_MONTHLY_VIP_POINTS = new MessageAlreadyClaimedVIPPoints();
    public static Message ALREADY_OPENED_CRATE = new MessageAlreadyOpenedCrate();
    public static Message ALREADY_RECEIVED_CRATE = new MessageReceivedCrate();
