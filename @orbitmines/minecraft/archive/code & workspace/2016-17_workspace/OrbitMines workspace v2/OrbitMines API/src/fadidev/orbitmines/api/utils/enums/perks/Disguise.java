...
public enum Disguise {
	...
	GUARDIAN("§3Guardian Disguise", "Guardian", 750, null, Mob.GUARDIAN, EntityType.GUARDIAN),
	POLAR_BEAR("§fPolar Bear Disguise", "PolarBear", 600, null, Mob.POLAR_BEAR, EntityType.POLAR_BEAR);
