...
public class ServerSelectorInv extends OMInventory {
	...
	public void update(){
		getInventory().setItem(4, getItem(Server.HUB));
		...
		getInventory().setItem(13, getItem(Server.SURVIVAL));
		getInventory().setItem(14, getItem(Server.SKYBLOCK));
		getInventory().setItem(15, getItem(Server.MINIGAMES));
		getInventory().setItem(16, getItem(Server.FOG));
