...
public enum Hat {
	...
	BEACON(Material.BEACON, 0, 100, "§bBeacon Hat", "Beacon", null),
	MAGMA_BLOCK(Material.MAGMA, 0, 200, "§cMagma Block Hat", "MagmaBlock", null),
	PURPUR_BLOCK(Material.PURPUR_BLOCK, 0, 75, "§dPurpur Block Hat", "PurpurBlock", null),
	END_STONE_BRICKS(Material.END_BRICKS, 0, 75, "§eEnd Stone Bricks Hat", "EndStoneBricks", null),
