...
public class StatsInv extends OMInventory {
    ...
    private ItemStack[] getContents(Player player){
        ...
        String played = MiniGamesMessages.WORD_PLAYED.get(omp);
        String wins = MiniGamesMessages.WORD_WINS.get(omp);
        String best = MiniGamesMessages.WORD_BEST.get(omp);
        String details = MiniGamesMessages.INV_CLICK_FOR_DETAILS.get(omp);
        {
        ...
        }
        {
            ...
            contents[10] = OrbitMinesMiniGames.getMiniGames().getApi().getNms().customItem().hideFlags(item, 2);
        }
        {
        ...
        }
        {
            ...
            contents[24] = OrbitMinesMiniGames.getMiniGames().getApi().getNms().customItem().hideFlags(item, 2);
        }
