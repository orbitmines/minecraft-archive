...
public class ConfigUtils {
	...
	public List<String> parseStringIntList(List<StringInt> stringintlist){
	...
	public List<UUID> parseUUIDList(List<String> uuidstringlist){
	...
	public List<String> parseStringList(List<UUID> uuidlist){
	...
	public List<Location> parseLocationList(List<String> locationstringlist){
