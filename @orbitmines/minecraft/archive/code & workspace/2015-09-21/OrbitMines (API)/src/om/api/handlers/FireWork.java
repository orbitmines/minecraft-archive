...
public class FireWork {
	...
	public void randomize(){
		List<Color> colors = api.getColorUtils().values();
		
		withColor(api.getColorUtils().random(colors));
		withColor(api.getColorUtils().random(colors));
		withFade(api.getColorUtils().random(colors));
		withFade(api.getColorUtils().random(colors));
		
		if(api.getUtils().random()) withFlicker();
		if(api.getUtils().random()) withTrail();
	}
