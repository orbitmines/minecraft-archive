...
public class ColorUtils {
	...
	public ColorUtils(){
		values =  Arrays.asList(Color.AQUA, Color.BLACK, Color.BLUE, Color.FUCHSIA, Color.GRAY, Color.GREEN, Color.LIME, Color.MAROON, Color.NAVY, Color.OLIVE, Color.ORANGE, Color.PURPLE, Color.RED, Color.SILVER, Color.TEAL, Color.WHITE, Color.YELLOW);
		wardrobe =  Arrays.asList(Color.AQUA, Color.BLACK, Color.BLUE, Color.FUCHSIA, Color.GRAY, Color.GREEN, Color.LIME, Color.NAVY, Color.ORANGE, Color.PURPLE, Color.RED, Color.TEAL, Color.WHITE, Color.YELLOW);
	}
	...
	public String getDatabaseName(Color color){
	...
	public short getDurability(Color color){
	...
	public Color random(List<Color> colors){
	...
	public String parse(Color color){
	...
	public DyeColor getNext(Sheep s){
	...
	public short getDurability(Type type){
		switch(type){
			case CREEPER:
				return 4;
			default:
