...
public class VoteManager {
	...
	private void registerNotOnline(UUID uuid){
		...
		api.getConfigManager().get(Config.VOTERS).set("VoteRewardsNotGiven", api.getConfigUtils().parseStringIntList(list));
	...
	public void registerVote(String playername){
		...
		if(omp != null){
			...
			UUID uuid = api.getUUIDUtils().getUUID(playername);
