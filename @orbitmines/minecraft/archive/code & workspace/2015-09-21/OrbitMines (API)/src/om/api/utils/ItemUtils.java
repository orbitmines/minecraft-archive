...
public class ItemUtils {
	...
	public ItemStack getSkull(String playername, String displayname){
		ItemStack item = new ItemStack(Material.SKULL_ITEM);
		item.setDurability((short) 3);
		SkullMeta meta = (SkullMeta) item.getItemMeta();
	...
	public ItemStack addColor(ItemStack item, Color color){
	...
	public ItemStack setItem(ItemStack item, String displayname, int durability){
	...
	public ItemStack setDisplayname(ItemStack item, String displayname){
		ItemMeta meta = (ItemMeta) item.getItemMeta();
		meta.setDisplayName(displayname);
		item.setItemMeta(meta);
	...
	public ItemStack setLore(ItemStack item, List<String> itemlore){
		ItemMeta meta = (ItemMeta) item.getItemMeta();
