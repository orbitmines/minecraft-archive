...
public class Start extends JavaPlugin {
	...
	private void registerAllEvents(){
		getServer().getPluginManager().registerEvents(new BreakEvent(), this);//Hub, KitPvP, Creative, Survival, SkyBlock
		getServer().getPluginManager().registerEvents(new ClickEvent(), this);//Hub, KitPvP, Creative, Survival, SkyBlock
		getServer().getPluginManager().registerEvents(new CommandPreprocessEvent(), this);//Hub, KitPvP, Creative, Survival, SkyBlock
		getServer().getPluginManager().registerEvents(new DamageEvent(), this);//Hub, KitPvP, Creative, Survival, SkyBlock
		getServer().getPluginManager().registerEvents(new EntityDamage(), this);//Hub, KitPvP, Creative, Survival, SkyBlock
		getServer().getPluginManager().registerEvents(new EntityDeath(), this);//Hub, KitPvP, Creative, Survival, SkyBlock
		getServer().getPluginManager().registerEvents(new EntityInteractEvent(), this);//Hub, KitPvP, Creative, Survival, SkyBlock
		getServer().getPluginManager().registerEvents(new InteractAtEntityEvent(), this);//Hub, KitPvP, Creative, Survival, SkyBlock
		getServer().getPluginManager().registerEvents(new JoinEvent(), this);//Hub, KitPvP, Creative, Survival, SkyBlock
		getServer().getPluginManager().registerEvents(new PlaceEvent(), this);//Hub, KitPvP, Creative, Survival, SkyBlock
		getServer().getPluginManager().registerEvents(new PlayerChat(), this);//Hub, KitPvP, Creative, Survival, SkyBlock
		getServer().getPluginManager().registerEvents(new PlayerInteract(), this);//Hub, KitPvP, Creative, Survival, SkyBlock
		getServer().getPluginManager().registerEvents(new PlayerMove(), this);//Hub, KitPvP, Creative, Survival, SkyBlock
		getServer().getPluginManager().registerEvents(new QuitEvent(), this);//Hub, KitPvP, Creative, Survival, SkyBlock
		getServer().getPluginManager().registerEvents(new SignEvent(), this);//Hub, KitPvP, Creative, Survival, SkyBlock
		getServer().getPluginManager().registerEvents(new VoteEvent(), this);//Hub, KitPvP, Creative, Survival, SkyBlock
		getServer().getPluginManager().registerEvents(new WorldChangeEvent(), this);//Hub, KitPvP, Creative, Survival, SkyBlock
		
		if(ServerData.isServer(Server.HUB, Server.KITPVP, Server.CREATIVE)){
			getServer().getPluginManager().registerEvents(new BlockChangeEvent(), this);//Hub, KitPvP, Creative
			getServer().getPluginManager().registerEvents(new DropEvent(), this);//Hub, KitPvP, Creative
			getServer().getPluginManager().registerEvents(new ExplodeEvent(), this);//Hub, KitPvP, Creative
			getServer().getPluginManager().registerEvents(new FoodEvent(), this);//Hub, KitPvP, Creative
			getServer().getPluginManager().registerEvents(new PickupEvent(), this);//Hub, KitPvP, Creative
			getServer().getPluginManager().registerEvents(new ProjectileHit(), this);//Hub, KitPvP, Creative
		}
