...
public class LogManager {
	...
	public LogManager(boolean use, List<LogReadType> read, boolean defaultLog, boolean perServerLog, boolean perChannelLog, boolean perGlobalLog, boolean allChannelsLog, boolean allGlobalsLog, boolean pmLog){
