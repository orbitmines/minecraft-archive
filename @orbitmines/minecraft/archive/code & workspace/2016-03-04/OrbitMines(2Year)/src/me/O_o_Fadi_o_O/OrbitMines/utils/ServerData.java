...
public class ServerData {
	...
	public static class HubServer {
		...
		private void spawnNPCs(){
			...
			/*{
				NPC npc = NPC.addNPC(NPCType.FOG);
				npc.newEntity(EntityType.SKELETON, new Location(getHubWorld(), -13.5, 73, -26.5, -90, 0), "§e§lFractels of the Galaxy", false);
				npc.setItemInHand(new ItemStack(Material.MAP));
				npc.setHelmet(Utils.addColor(new ItemStack(Material.LEATHER_HELMET), Color.RED));
				npc.setChestplate(Utils.addColor(new ItemStack(Material.LEATHER_CHESTPLATE), Color.YELLOW));
				npc.setBoots(Utils.addColor(new ItemStack(Material.LEATHER_BOOTS), Color.BLUE));
			}
			{
				Hologram h = Hologram.addHologram(new Location(getHubWorld(),  -13.5, 74, -26.5, -90, 0));
				h.addLine("§7Release at 14:00 CEST!");
				h.create();
			}
			{
				Hologram h = Hologram.addHologram(new Location(getHubWorld(),  -17.5, 72, -26.5, 0, 0));
				h.addLine("§6§lSurprise Crate");
				h.create();
			}
			{
				Hologram h = Hologram.addHologram(new Location(getHubWorld(),  -13.5, 72, -22.5, 0, 0));
				h.addLine("§6§lSurprise Crate");
				h.create();
			}
			{
				Hologram h = Hologram.addHologram(new Location(getHubWorld(),  -13.5, 72, -30.5, 0, 0));
				h.addLine("§6§lSurprise Crate");
				h.create();
			}
			{
				Hologram h = Hologram.addHologram(new Location(getHubWorld(),  -9.5, 72, -26.5, 0, 0));
				h.addLine("§6§lSurprise Crate");
				h.create();
			}*/
			{
			...
			{
				NPCArmorStand npcas = NPCArmorStand.addNPCArmorStand(NPCType.SERVER_INFO_FOG, new Location(getHubWorld(), -17.5, 78, -69.5, 0, 0));
				npcas.setHeadPose(EulerAngle.ZERO.setX(0.15).setY(0).setZ(0));
				npcas.setLeftArmPose(EulerAngle.ZERO.setX(0).setY(0).setZ(0));
				npcas.setLeftLegPose(EulerAngle.ZERO.setX(0).setY(0).setZ(0));
				npcas.setRightArmPose(EulerAngle.ZERO.setX(-0.75).setY(0).setZ(0));
				...
				npcas.setGravity(false);
				npcas.setVisible(false);
				npcas.setHelmet(Utils.addColor(new ItemStack(Material.LEATHER_HELMET), Color.RED));
				npcas.setChestplate(Utils.addColor(new ItemStack(Material.LEATHER_CHESTPLATE), Color.YELLOW));
				npcas.setLeggings(Utils.addColor(new ItemStack(Material.LEATHER_LEGGINGS), Color.RED));
				npcas.setBoots(Utils.addColor(new ItemStack(Material.LEATHER_BOOTS), Color.BLUE));
		...
		private void registerServerPortals(){
			...
			setServerPortal(Server.FOG, Utils.getBlocksBetween(new Location(getHubWorld(), -21, 75, -72), new Location(getHubWorld(), -15, 87, -72)));
		}
	...
	public static class KitPvPServer {
		...
		private void registerKits(){
			...
			{// Drunk Level 1 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.setDisplayname(new ItemStack(Material.STONE_SWORD), "§b§lDrunk §a§lLvL 1§8 || §bWeapon"), Enchantment.KNOCKBACK, 2)), 4));
			...
			{// Drunk Level 2 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.setLore(Utils.setDisplayname(new ItemStack(Material.STONE_SWORD), "§b§lDrunk §a§lLvL 2§8 || §bWeapon"), ItemType.BLINDNESS_I.addEnchantment(new ArrayList<String>())), Enchantment.KNOCKBACK, 2)), 4));
			...
			{// Drunk Level 3 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.setLore(Utils.setDisplayname(new ItemStack(Material.IRON_SWORD), "§b§lDrunk §a§lLvL 3§8 || §bWeapon"), ItemType.BLINDNESS_II.addEnchantment(new ArrayList<String>())), Enchantment.KNOCKBACK, 2)), 4));
