...
public class KitPvPUtils {
	...
	public static enum Mastery {
		...
		public String getName(){
			switch(this){
				case MELEE:
					return "§7§lWapen Damage";
				case MELEE_PROTECTION:
					return "§7§lWapen Protectie";
				case RANGE:
					return "§7§lAfstand Wapen Damage";
				case RANGE_PROTECTION:
					return "§7§lAfstand Wapen Protectie";
				default:
					return null;
			}
		}
		...
		public String getEffectName(){
			switch(this){
				case MELEE:
					return "Wapen Damage";
				case MELEE_PROTECTION:
					return "Wapen Damage Genomen";
				case RANGE:
					return "Afstand Wapen Damage";
				case RANGE_PROTECTION:
					return "Afstand Wapen Damage Genomen";
				default:
					return null;
			}
		}
	...
	public static enum Booster {
		...
		public String getPriceName(OMPlayer omp){
			...
			return "§cBenodigd: " + getVIPRank().getRankString();
		}
	}
	...
	public static enum KitPvPKit {
		...
		public List<String> getKitLore(int level){
			...
			if(ServerData.getKitPvP().isFreeKitEnabled() && level == 0){
				kitlore.add("§d§lGratis Kits! (Zaterdag)");
			}
			else{
				if(level != 0){
					kitlore.add("§a§lOntgrendeld §7§o(§a§oLvL " + level + "§7§o)");
				}
				else{
					kitlore.add("§4§lVergrendeld");
				}
			}
			kitlore.add("");
			if(level == 0){
				kitlore.add("§c§o§l§mRechtermuisknop §c§m(Selecteer Kit)");
				kitlore.add("§6§l§oLinkermuisknop §7(Details & Kit Kopen)");
			}
			else{
				kitlore.add("§e§l§oRechtermuisknop §7(Selecteer Kit)");
				if(level != getHighestLevel()){
					kitlore.add("§6§l§oLinkermuisknop §7(Details & Kit Upgraden)");
				}
				else{
					kitlore.add("§6§l§oLinkermuisknop §7(Details)");
				}
			}
			kitlore.add("");
