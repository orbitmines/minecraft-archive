...
public class KitPvPPlayer {
	...
	public void giveKit(KitPvPKit kitpvpkit, int level){
		...
		getPlayer().sendMessage("§7Kit Geselecteerd: '§b§l" + kitpvpkit.getName() + "§7' §7§o(§a§oLvL " + level + "§7§o)");
		Title t = new Title("", "§7Kit Geselecteerd '§b§l" + kitpvpkit.getName() + "§7' (§aLevel " + level + "§7)");
		t.send(getPlayer());
	}
	...
	public void createKillHologram(Player killer, int coinsadded){
		...
		h.addLine("§7Je hebt §6" + getPlayer().getName() + "§7 gedood!");
	...
	public void requiredMoney(int price){
		...
		if(needed == 1){
			p.sendMessage("§7Je hebt nog §6§l" + needed + "§7 §6§lCoins§7 nodig!");
		}
		else{
			p.sendMessage("§7Je hebt nog §6§l" + needed + "§7 §6§lCoins§7 nodig!");
		}
