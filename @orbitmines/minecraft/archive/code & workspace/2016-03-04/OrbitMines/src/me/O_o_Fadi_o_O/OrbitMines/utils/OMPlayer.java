...
public class OMPlayer {
	...
	public void setCanChat(boolean canchat){
		...
		if(canchat){
			getPlayer().sendMessage("§3§lHub §8| §7Chat staat §a§lAAN§7!");
		}
	}
	...
	public void nowAFK(String afkname){
		...
		if(afkname != null){
			Bukkit.broadcastMessage("§7 " + getName() + "§7 is nu §6AFK§7. (§7" + afkname + "§7)");
			this.afkname = afkname;
		}
		else{
			Bukkit.broadcastMessage("§7 " + getName() + "§7 is nu §6AFK§7.");
		}
	}
	public void noLongerAFK(){
		...
		if(getAFKName() != null){
			Bukkit.broadcastMessage("§7 " + getName() + "§7 is niet meer §6AFK§7. (§7" + getAFKName() + "§7)");
		}
		else{
			Bukkit.broadcastMessage("§7 " + getName() + "§7 is niet meer §6AFK§7.");
		}
	}
	...
	public void setChatColor(ChatColor chatcolor){
		...
		getPlayer().sendMessage("§7Jouw " + chatcolor.getName() + "§7 staat nu §a§lAAN§7..");
	}
	...
	public void setCursive(boolean chatcolorcursive){
		...
		getPlayer().playSound(getPlayer().getLocation(), Sound.PISTON_EXTEND, 5, 1);
		getPlayer().sendMessage("§7Jouw " + getChatColor().getColor() + "§oCursive ChatColor§7 staat nu " + Utils.statusString(chatcolorcursive) + "§7.");
	}
	...
	public void disableSoccerMagmaCube(){
		...
		getPlayer().sendMessage("§7Jouw §cMagmaCube Voetbal§7 staat nu §c§lUIT§7!");
	}
	...
	public void setHat(Hat hat){
		...
		getPlayer().sendMessage("§7Jouw " + hat.getName() + "§7 staat nu §a§lAAN§7.");
	}
	...
	public void setHatsBlockTrail(boolean hatsblocktrail){
		...
		getPlayer().playSound(getPlayer().getLocation(), Sound.SUCCESSFUL_HIT, 5, 1);
		if(hatsblocktrail){
			getPlayer().sendMessage("§7Jouw §7Hat Block Trail§7 staat nu §a§lAAN§7.");
		}
		else{
			getPlayer().sendMessage("§7Jouw §7Hat Block Trail§7 staat nu §c§lUIT§7!");
		}
	}
	...
	public void setTrail(Trail trail){
		...
		if(trail != null){
			getPlayer().playSound(getPlayer().getLocation(), Sound.SUCCESSFUL_HIT, 5, 1);
			getPlayer().sendMessage("§7Jouw " + trail.getName() + "§7 staat nu §a§lAAN§7.");
		}
	}
	...
	public void setTrailType(TrailType trailtype){
		...
		getPlayer().playSound(getPlayer().getLocation(), Sound.SUCCESSFUL_HIT, 5, 1);
		getPlayer().sendMessage("§7Jouw " + trailtype.getName() + "§7 staat nu §a§lAAN§7.");
	}
	...
	public void setTrailPA(int trailparticlesamount){
		...
		getPlayer().playSound(getPlayer().getLocation(), Sound.SUCCESSFUL_HIT, 5, 1);
		getPlayer().sendMessage("§7Jouw §7§lAantal Particles§7 is nu §f§l" + trailparticlesamount + "§7.");
	}
	public void addTrailPA(){
		...
		getPlayer().playSound(getPlayer().getLocation(), Sound.SUCCESSFUL_HIT, 5, 1);
		getPlayer().sendMessage("§7Jouw §7§lAantal Particles§7 is nu §f§l" + amount + "§7.");
	}
	...
	public void setSpecialTrail(boolean specialtrail){
		...
		getPlayer().playSound(getPlayer().getLocation(), Sound.SUCCESSFUL_HIT, 5, 1);
		getPlayer().sendMessage("§7Jouw §7§lSpecial Trail§7 staat nu " + Utils.statusString(specialtrail) + "§7.");
	}
	...
	public void setWardrobeDisco(boolean wardrobedisco){
		if(wardrobedisco){
			...
			getPlayer().sendMessage("§7Jouw " + Utils.getColor(Utils.getRandomColor(Utils.getWardrobeColors())) + "Disco Armor§7 staat nu §a§lAAN§7.");
			discoWardrobe();
		}
	...
	public void joinLapisParkour(){
		...
		p.sendMessage(" §7- Je kan niet stoppen met rennen.");
		p.sendMessage(" §7- Beloning: §b§l250 VIP Points§7.");
		p.sendMessage("");
		p.sendMessage("§f§lSucces!");
		
		Title t = new Title("§1§lLapis Parkour", "§7Je kan niet stoppen met rennen!");
		t.send(p);
	}
	public void leaveLapisParkour(){
		setInLapisParkour(false);
		getPlayer().sendMessage("§7Je hebt het Parkour verlaten. Probeer het een andere keer nog is!");
	}
    ...
    public void setLanguage(Language language){
        ...
        Database.get().update("Language", "language", "" + getLanguage().toString(), "uuid", getUUID().toString());

        getPlayer().kickPlayer("§c§lInstellingen Veranderd\n§7Je bent gekickt om de instellingen goed te laten verwerken.\n§7§nJe kan nu terug inloggen.");
    }
	...
	public void vote(){
		...
		p.sendMessage("");
		p.sendMessage("§b§lVote §8| §7Dank je, §b§l" + p.getName() + " §7voor jouw §b§lVote§7!");
		p.sendMessage("§b§lVote §8| §7Je beloning op de " + ServerData.getServer().getName() + "§7 Server:");
		...
		p.sendMessage("§b§lVote §8| §7");
		p.sendMessage("§b§lVote §8| §7Jouw votes deze maand: §b§l" + getVotes());
		p.playSound(p.getLocation(), Sound.LEVEL_UP, 5, 1);
		
		for(Player player : Bukkit.getOnlinePlayers()){
			if(player != p){
				player.sendMessage("§b§lVote §8| §b§l" + p.getName() + "§7 heeft gevoten met §b§l/vote§7.");
			}
		}
	}
	...
	public void notLoaded(){
		...
		p.playSound(p.getLocation(), Sound.CLICK, 5, 1);
		p.sendMessage(server.getName() + " §8| §7Er was een probleem toen je verbond. Vertel dit aan een Moderator/Owner!");
	}
	...
	public void disableWardrobe(){	
		...
		p.sendMessage("§7Jouw " + p.getInventory().getChestplate().getItemMeta().getDisplayName() + "§7 staat nu §c§lUIT§7!");
	...
	public void wardrobe(Color color){
		...
		p.sendMessage("§7Jouw " + Utils.getColorName(color) +" Armor§7 staat nu §a§lAAN§7.");
	...
	public void wardrobe(VIPRank viprank){
		...
		switch(viprank){
			case Emerald_VIP:
				p.sendMessage("§7Jouw §7Chainmail Armor§7 staat nu §a§lAAN§7.");
				...
				break;
			case Diamond_VIP:
				p.sendMessage("§7Jouw §bDiamond Armor§7 staat nu §a§lAAN§7.");
				...
				break;
			case Gold_VIP:
				p.sendMessage("§7Jouw §6Gold Armor§7 staat nu §a§lAAN§7.");
				...
				break;
			case Iron_VIP:
				p.sendMessage("§7Jouw §7Iron Armor§7 staat nu §a§lAAN§7.");
	...
	public void disableTrail(){
		getPlayer().sendMessage("§7Jouw " + getTrail().getName() + "§7 staat nu §c§lUIT§7!");
		setTrail(null);
	}
	...
	public void disableHat(){
		getPlayer().sendMessage("§7Jouw " + getPlayer().getInventory().getHelmet().getItemMeta().getDisplayName() + "§7 staat nu §c§lUIT§7!");
	...
	public void enableGadget(Gadget gadget){
		...
		getPlayer().sendMessage("§7Jouw " + gadget.getName() + "§7 staat nu §a§lAAN§7.");
	}
	...
	public void disableGadget(){
		...
		if(item != null){
			...
			getPlayer().sendMessage("§7Jouw " + displayname.replace("§n", "§l") + "§7 staat nu §c§lUIT§7!");
	...
	public void giveFireworkGun(){
		...
		p.sendMessage("§7Jouw §c§lFirework Gun§7 staat nu §a§lAAN§7.");
	}
	
	public void disablePet(){
		Pet pet = getPetEnabled();
		getPlayer().sendMessage("§7Jouw §f" + getPetName(pet) + "§7 staat nu §c§lUIT§7!");
	...
	public void spawnPet(Pet pet){
		pet.spawn(this);
		getPlayer().sendMessage("§7Jouw §f" + pet.getName() + "§7 staat nu §a§lAAN§7.");
	}
	...
	public void givePetInventory(){
		...
		switch(getPetEnabled()){
			case CHICKEN:
				...
				p.getInventory().setItem(6, Utils.setDisplayname(new ItemStack(Material.RAW_CHICKEN, chickenage), "§c§nVerander Leeftijd"));
				break;
			case COW:
				...
				p.getInventory().setItem(6, Utils.setDisplayname(new ItemStack(Material.RAW_BEEF, cowage), "§c§nVerander Leeftijd"));
				break;
			case CREEPER:
				p.getInventory().setItem(2, Utils.setDisplayname(new ItemStack(Material.TNT, 1), "§c§nExplodeer"));
				
				Creeper creeper = (Creeper) getPet();
				if(creeper.isPowered()){
					p.getInventory().setItem(6, Utils.setDurability(Utils.setDisplayname(new ItemStack(Material.MONSTER_EGG, 1), "§a§nVerander Type§7 (§e§lLIGHTNING§7)"), 50));
				}
				else{
					p.getInventory().setItem(6, Utils.setDurability(Utils.setDisplayname(new ItemStack(Material.MONSTER_EGG, 1), "§a§nVerander Type§7 (§6§lNORMAAL§7)"), 50));
				}
				break;
			case HORSE:
				...
				p.getInventory().setItem(2, Utils.setDisplayname(new ItemStack(Material.FEATHER, speed), "§f§nVerander Snelheid"));
				p.getInventory().setItem(6, Utils.setDisplayname(new ItemStack(Material.LEATHER, 1), "§e§nVerander Kleur"));
				break;
			case MAGMA_CUBE:
				p.getInventory().setItem(2, Utils.setDisplayname(new ItemStack(Material.FIREBALL, 1), "§6§nFireball"));
				p.getInventory().setItem(6, Utils.setDisplayname(new ItemStack(Material.MAGMA_CREAM, ((MagmaCube) getPet()).getSize()), "§c§nVerander Grootte"));
				break;
			case MUSHROOM_COW:
				if(hasPetShroomTrail() == true){
					p.getInventory().setItem(2, Utils.setDurability(Utils.setDisplayname(new ItemStack(Material.HUGE_MUSHROOM_2, 1), "§4§nShroom Trail§7 (§a§lAAN§7)"), 14));
				}
				else{
					p.getInventory().setItem(2, Utils.setDurability(Utils.setDisplayname(new ItemStack(Material.HUGE_MUSHROOM_1, 1), "§4§nShroom Trail§7 (§c§lUIT§7)"), 14));
				}
			...
			case OCELOT:
				...
				p.getInventory().setItem(6, Utils.setDisplayname(new ItemStack(Material.RAW_FISH, 1), "§9§nVerander Kleur"));
				break;
			case PIG:
				if(hasPetBabyPigs() == true){
					p.getInventory().setItem(2, Utils.setDurability(Utils.setDisplayname(new ItemStack(Material.MONSTER_EGG, 1), "§d§nBaby Pigs§7 (§a§lAAN§7)"), 90));
				}
				else{
					p.getInventory().setItem(2, Utils.setDurability(Utils.setDisplayname(new ItemStack(Material.MONSTER_EGG, 1), "§d§nBaby Pigs§7 (§c§lUIT§7)"), 90));
				}
				...
				p.getInventory().setItem(6, Utils.setDisplayname(new ItemStack(Material.PORK, pigage), "§d§nVerander Leeftijd"));
				break;
			case SHEEP:
				if(hasPetSheepDisco() == true){
					p.getInventory().setItem(2, Utils.setDisplayname(new ItemStack(Material.WOOL, 1), "§f§nSheep Disco§7 (§a§lAAN§7)"));
				}
				else{
					p.getInventory().setItem(2, Utils.setDisplayname(new ItemStack(Material.WOOL, 1), "§f§nSheep Disco§7 (§c§lUIT§7)"));
				}
				
				DyeColor dyecolor = ((Sheep) getPet()).getColor();
				p.getInventory().setItem(6, Utils.setDurability(Utils.setDisplayname(new ItemStack(Material.INK_SACK, 1), "§f§nVerander Kleur§7 (" + Utils.getDyeColorName(dyecolor) + "§7)"), dyecolor.getDyeData()));
				break;
			case SILVERFISH:
				p.getInventory().setItem(2, Utils.setDurability(Utils.setDisplayname(new ItemStack(Material.MONSTER_EGG, 1), "§7§nSilverfish Bom"), 60));
			...
			case SLIME:
				...
				p.getInventory().setItem(6, Utils.setDisplayname(new ItemStack(Material.SLIME_BALL, ((Slime) getPet()).getSize()), "§a§nVerander Grootte"));
				break;
			case SPIDER:
			...
			case WOLF:
				...
				p.getInventory().setItem(6, Utils.setDisplayname(new ItemStack(Material.BONE, wolfage), "§7§nVerander Leeftijd"));
				break;
			default:
				break;
		}
	...
	public void setVIP(VIPRank viprank){
		...
		switch(viprank){
			case Emerald_VIP:
				subtitle = "§7Je bent nu een §a§lEmerald VIP§7!";
				break;
			case Diamond_VIP:
				subtitle = "§7Je bent nu een §b§lDiamond VIP§7!";
				break;
			case Gold_VIP:
				subtitle = "§7Je bent nu een §6§lGold VIP§7!";
				break;
			case Iron_VIP:
				subtitle = "§7Je bent nu een §7§lIron VIP§7!";
				break;
			case User:
				break;
			default:
	...
	public void setStaff(StaffRank staffrank){
		...
		switch(staffrank){
			case Builder:
				subtitle = "§7Je bent nu een §d§lBuilder§7!";
			case Moderator:
				subtitle = "§7Je bent nu een §b§lModerator§7!";
			case Owner:
				subtitle = "§7Je bent nu een §4§lOwner§7!";
			case User:
				break;
			default:
				break;
    ...
    public void toServer(Server server){
	    if(server.isOnline()){
			...
			getPlayer().sendMessage("§7Verbinden met de " + server.getName() + "§7 Server...");
			...
			getPlayer().sendMessage("§7De " + server.getName() + "§7 Server is §4§loffline§7!");
    	}
    }
	...
	public void unknownCommand(String command){
		getPlayer().sendMessage("§7Onbekende Command (§6" + command + "§7). Gebruik §6/help§7 voor hulp.");
	}
	
	public void requiredVIPRank(VIPRank viprank){
		Player p = getPlayer();
		
		p.sendMessage("§7Je moet een " + viprank.getRankString() + " VIP§7 zijn om dit te doen!");
	...
	public void requiredVIPPoints(int price){
		...
		if(needed == 1){
			p.sendMessage("§7Je hebt nog §b§l" + needed + "§7 §b§lVIP Point§7 nodig!");
		}
		else{
			p.sendMessage("§7Je hebt nog §b§l" + needed + "§7 §b§lVIP Points§7 nodig!");
		}
	}
	public void requiredOMT(int price){
		...
		if(needed == 1){
			p.sendMessage("§7Je hebt nog §e§l" + needed + "§7 §e§lOrbitMines Token§7 nodig!");
		}
		else{
			p.sendMessage("§7Je hebt nog §e§l" + needed + "§7 §e§lOrbitMines Tokens§7 nodig!");
		}
	}
	public void requiredMiniGameCoins(int price){
		...
		if(needed == 1){
			p.sendMessage("§7Je hebt nog §f§l" + needed + "§7 §f§lCoin§7 nodig!");
		}
		else{
			p.sendMessage("§7Je hebt nog §f§l" + needed + "§7 §f§lCoins§7 nodig!");
		}
	}
	public void requiredMGTickets(int price){
		...
		if(needed == 1){
			p.sendMessage("§7Je hebt nog §f§l" + needed + "§7 §f§lTicket§7 nodig!");
		}
		else{
			p.sendMessage("§7Je hebt nog §f§l" + needed + "§7 §f§lTickets§7 nodig!");
		}
	}
	...
	public void logOut(boolean reload){
		...
		if(Database.get().containsPath("Wardrobe-Disco", "uuid", "uuid", getUUID().toString())){
			Database.get().update("Wardrobe-Disco", "disco", isWardrobeDisco() + "", "uuid", getUUID().toString());
		}
			...
			if(isSilentMode()){
				for(Player p : Bukkit.getOnlinePlayers()){
					...
					if(omp.hasPerms(StaffRank.Moderator)){
						p.sendMessage(" §4§ §l§o" + getPlayer().getName() + "§4 (§c" + ServerData.getServer().getName() + "§4) §6[Silent Modus]");
					}
				}
			}
			else{
			...
			if(nearest != null){
				for(ItemStack item : getPlayer().getInventory().getContents()){
					if(item != null && item.getType() == Material.COMPASS){
						ItemMeta meta = item.getItemMeta();
						meta.setDisplayName("§6§lTracking: §f§l" + nearest.getPlayer().getName() + " §6§lAfstand: §f§l" + String.format("%.1f", distance));
						item.setItemMeta(meta);
					}
				}
	...
	public void load(){
		...
		getPlayer().getScoreboard().clearSlot(DisplaySlot.SIDEBAR);
		setTabList("§6§lOrbitMines§4§lNetwork", "§7Website: §6www.orbitmines.com §8| §7Twitter: §b@OrbitMines §8| §7Doneren: §3shop.orbitmines.com");
		...
		try{
            ...
            if(Database.get().containsPath("Language", "uuid", "uuid", uuid)){
                ...
                Database.get().insert("Language", "uuid`, `language", uuid + "', '" + "DUTCH");
            }
			...
			if(ServerData.isServer(Server.MINIGAMES, Server.HUB)){
				{
			...
			new BukkitRunnable(){
				public void run(){
					...
					p.sendMessage(" §7§lDoneren: §3shop.orbitmines.com");
					p.sendMessage(" §7§lVoten: §bwww.orbitmines.com/voten");
					p.sendMessage(" ");
					
					ComponentMessage cm = new ComponentMessage();
					cm.addPart(" §7§lSpawn Gebouwd Door: ", null, null, null, null);
					cm.addPart("§e§l[View]", null, null, Action.SHOW_TEXT, ServerData.getSpawnBuilders());
					cm.send(p);
					
					p.sendMessage(" §7§lGeontwikkeld Door: §4§lOwner §4O_o_Fadi_o_O");
					p.sendMessage("§7§m----------------------------------------");
				}
			...
			if(ServerData.isServer(Server.SURVIVAL)){
				...
				if(newplayer){
					...
					new BukkitRunnable(){
						public void run(){
							Bukkit.broadcastMessage("§d" + p.getName() + " §7heeft §6§lOrbitMines§4§lNetwork§7 gejoined! §d#" + hub.getPlayerCounter());
						}
					}.runTaskLater(Start.getInstance(), 1);
				}
			}
				...
				new BukkitRunnable(){
					public void run(){
						...
						if(playerstojoin.containsKey(p.getName())){
							...
							p.sendMessage("§7Kan geen §f§lMiniGames§7 data vinden.");
					        ...
					        try{
					        	...
					        	p.kickPlayer("§7Kan geen §f§lMiniGames§7 data vinden.");
					        }
		...
		if(!ServerData.isServer(Server.MINIGAMES)){
			if(isSilentMode()){
				for(Player p : Bukkit.getOnlinePlayers()){
					OMPlayer omp = OMPlayer.getOMPlayer(p);
					if(omp.hasPerms(StaffRank.Moderator)){
						p.sendMessage(" §2§ §l§o" + getPlayer().getName() + "§2 (§a" + ServerData.getServer().getName() + "§2) §6[Silent Modus]");
					}
				}
			}
			else{
