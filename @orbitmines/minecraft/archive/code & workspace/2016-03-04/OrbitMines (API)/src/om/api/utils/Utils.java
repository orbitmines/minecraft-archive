...
public class Utils {
	...
	public static List<StringInt> asNewStringIntList(List<StringInt> list){
		List<StringInt> newlist = new ArrayList<StringInt>();
		for(StringInt o : list){
			newlist.add(o);
		}
		return newlist;
	}
	
	public static Location asNewLocation(Location l, int xAdded, int yAdded, int zAdded){
