...
public class Start extends JavaPlugin {
	...
	private void registerAllEvents(){
		getServer().getPluginManager().registerEvents(new BlockChangeEvent(), this);//Hub, KitPvP
		getServer().getPluginManager().registerEvents(new BreakEvent(), this);//Hub, KitPvP
		getServer().getPluginManager().registerEvents(new ClickEvent(), this);//Hub, KitPvP
		getServer().getPluginManager().registerEvents(new CommandPreprocessEvent(), this);//Hub, KitPvP
		getServer().getPluginManager().registerEvents(new DamageEvent(), this);//Hub, KitPvP
		getServer().getPluginManager().registerEvents(new DropEvent(), this);//Hub, KitPvP
		getServer().getPluginManager().registerEvents(new EntityDamage(), this);//Hub, KitPvP
		getServer().getPluginManager().registerEvents(new EntityDeath(), this);//Hub, KitPvP
		getServer().getPluginManager().registerEvents(new EntityInteractEvent(), this);//Hub, KitPvP
		getServer().getPluginManager().registerEvents(new ExplodeEvent(), this);//Hub, KitPvP
		getServer().getPluginManager().registerEvents(new FoodEvent(), this);//Hub, KitPvP
		getServer().getPluginManager().registerEvents(new InteractAtEntityEvent(), this);//Hub, KitPvP
		getServer().getPluginManager().registerEvents(new PickupEvent(), this);//Hub, KitPvP
		getServer().getPluginManager().registerEvents(new JoinEvent(), this);//Hub, KitPvP
		getServer().getPluginManager().registerEvents(new PlaceEvent(), this);//Hub, KitPvP
		getServer().getPluginManager().registerEvents(new PlayerChat(), this);//Hub, KitPvP
		getServer().getPluginManager().registerEvents(new PlayerInteract(), this);
		getServer().getPluginManager().registerEvents(new PlayerMove(), this);//Hub, KitPvP
		getServer().getPluginManager().registerEvents(new ProjectileHit(), this);//Hub, KitPvP
		getServer().getPluginManager().registerEvents(new QuitEvent(), this);//Hub, KitPvP
		getServer().getPluginManager().registerEvents(new SignEvent(), this);//Hub, KitPvP
		getServer().getPluginManager().registerEvents(new VoteEvent(), this);//Hub, KitPvP
	...
	private void registerCommands(){
		...
		List<String> commandlist = Arrays.asList("setlastdonator", "setvip", "setstaff", "resetMonthlyVIPPoints", "giveMonthlyVIPPoints", "votes", "vippoints", "omt", "money");
