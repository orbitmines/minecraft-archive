...
public class ServerData {
	...
	public static class CreativeServer {
		...
		private void spawnNPCs(){
			...
			{
				NPC npc = NPC.addNPC(NPCType.OMT_SHOP);
				npc.newEntity(EntityType.BLAZE, new Location(getCreativeWorld(), 4.5, 74, -9.5, 0, 0), "§e§lOMT Shop");
			}
			{
	...
	public static class SurvivalServer {
		...
		public SurvivalServer(){
			...
			this.spawn = new Location(getLobbyWorld(), 2.5, 78, 27.5, 180, 0);
		...
		private void spawnNPCs(){
			...
			{
				NPC npc = NPC.addNPC(NPCType.OMT_SHOP);
				npc.newEntity(EntityType.BLAZE, new Location(getLobbyWorld(), 7, 71, 0.5, 0, 0), "§e§lOMT Shop");
			}
		}
		...
		private void registerWorldPortals(){
			...
			setWorldPortal(getSurvivalWorld(), Utils.getBlocksBetween(new Location(getSurvivalWorld(), 10, 72, -13), new Location(getSurvivalWorld(), 14, 68, -13)));
		}
