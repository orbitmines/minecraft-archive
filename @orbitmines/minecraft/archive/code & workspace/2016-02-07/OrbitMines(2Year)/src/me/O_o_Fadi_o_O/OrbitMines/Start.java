...
public class Start extends JavaPlugin {
	...
	public void onEnable(){
		...
		new Database("127.0.0.1", 3306, "OrbitMines", "root", DBPassword.dbpw);
		new ServerData.SkyBlockServer();
	...
	private void registerCommands(){
		...
		List<String> commandlist = Arrays.asList("setlastdonator", "setvip", "build", "setstaff", "resetMonthlyVIPPoints", "giveMonthlyVIPPoints", "votes", "vippoints", "omt", "money", "addhomes", "addshops", "addwarps");
