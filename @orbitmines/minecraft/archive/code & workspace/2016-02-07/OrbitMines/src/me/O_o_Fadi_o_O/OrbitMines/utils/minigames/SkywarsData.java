...
public class SkywarsData {
	...
	public void ending(){
		...
		arena.sendMessage(" §f§lSkywars §7- §6Resultaten");
		arena.sendMessage("");
		arena.sendMessage(" §61e: " + getFirstPlace().getName());
		arena.sendMessage(" §72e: " + getSecondPlace().getName());
		arena.sendMessage(" §c3e: " + getThirdPlace().getName());
		arena.sendMessage("");
		arena.sendMessage("§6§m--------------------------------------------------");
	...
	public void warmup(){
		...
		arena.sendMessage("");
		arena.sendMessage(" §a§oVerzamel loot en schakel alle spelers uit!");
		arena.sendMessage("");
	...
	public void rewardPlayers(){
		for(OMPlayer omp : arena.getAllPlayers()){
			...
			if(arena.isPlayer(omp) || arena.isSpectator(omp) && arena.getDeadPlayers().contains(omp)){
				...
				p.sendMessage("§6§m--------------------------------------------------");
				p.sendMessage(" §f§lSkywars §7- §6Beloningen");
				p.sendMessage("");
				if(getFirstPlace() == omp){
					p.sendMessage(" §f§l+15 §7(1e Plaats)");
					amount += 15;
				}
				else if(getSecondPlace() == omp){
					p.sendMessage(" §f§l+8 §7(2e Plaats)");
					amount += 8;
				}
				else if(getThirdPlace() == omp){
					p.sendMessage(" §f§l+4 §7(3e Plaats)");
					amount += 4;
				}
				else{
					p.sendMessage(" §f§l+2 §7(Geduld)");
					amount += 2;
				}
		...
		if(cage != null){
			switch(cage){
				...
				case OCTOPUS_CAGE:
					...
					setBlock(blocks, b.getRelative(-5, -3, 3), Material.STEP, 6);
					setBlock(blocks, b.getRelative(-4, -5, -4), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(-4, -4, -4), Material.STEP, 6);
					setBlock(blocks, b.getRelative(-4, -7, 0), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(-4, -6, 0), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(-4, -5, 0), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(-4, -4, 0), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(-4, -8, 1), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(-4, -7, 2), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(-4, -6, 2), Material.STEP, 6);
					setBlock(blocks, b.getRelative(-4, -5, 3), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(-3, -5, -3), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(-3, -5, -2), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(-3, -4, -2), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(-3, -3, -2), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(-3, -3, 0), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(-3, -2, 0), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(-3, -3, 2), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(-3, -2, 2), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(-3, -5, 3), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(-3, -4, 3), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(-3, -3, 3), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(-2, -3, -2), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(-2, -2, -2), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(-2, -1, -2), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(-2, -2, 0), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(-2, -1, 0), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(-2, -2, 2), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(-2, -1, 2), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(-2, 0, 2), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(-1, -1, -1), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(-1, 0, -1), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(-1, 1, -1), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(-1, 2, -1), Material.COAL_BLOCK, 0);
					setBlock(blocks, b.getRelative(-1, 3, -1), Material.QUARTZ_BLOCK, 0);
					setBlock(blocks, b.getRelative(-1, 4, -1), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(-1, -1, 0), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(-1, 0, 0), Material.STEP, 6);
					setBlock(blocks, b.getRelative(-1, 1, 0), Material.STEP, 14);
					setBlock(blocks, b.getRelative(-1, 2, 0), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(-1, 3, 0), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(-1, 4, 0), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(-1, 5, 0), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(-1, 0, 1), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(-1, 1, 1), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(-1, 2, 1), Material.COAL_BLOCK, 0);
					setBlock(blocks, b.getRelative(-1, 3, 1), Material.QUARTZ_BLOCK, 0);
					setBlock(blocks, b.getRelative(-1, 4, 1), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(0, -4, -6), Material.STEP, 14);
					setBlock(blocks, b.getRelative(0, -3, -6), Material.STEP, 6);
					setBlock(blocks, b.getRelative(0, -4, -5), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(0, -4, -4), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(0, -3, -4), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(0, -3, -3), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(0, -2, -3), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(0, -2, -2), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(0, -1, -2), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(0, 0, -2), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(0, -2, -1), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(0, -1, -1), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(0, 0, -1), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(0, 1, -1), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(0, 2, -1), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(0, 3, -1), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(0, 4, -1), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(0, 5, -1), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(0, -1, 0), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(0, 4, 0), Material.SEA_LANTERN, 0);
					setBlock(blocks, b.getRelative(0, 5, 0), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(0, -1, 1), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(0, 0, 1), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(0, 1, 1), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(0, 2, 1), Material.STAINED_CLAY, 10);
					...
					setBlock(blocks, b.getRelative(0, -3, 4), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(0, -2, 4), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(0, -1, 4), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(0, -5, 5), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(0, -4, 5), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(0, -3, 5), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(0, -6, 6), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(0, -6, 7), Material.STEP, 14);
					setBlock(blocks, b.getRelative(0, -5, 7), Material.STEP, 6);
					setBlock(blocks, b.getRelative(1, -1, -1), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(1, 0, -1), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(1, 1, -1), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(1, 2, -1), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(1, 3, -1), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(1, -5, 0), Material.STEP, 14);
					setBlock(blocks, b.getRelative(1, -4, 0), Material.STEP, 6);
					setBlock(blocks, b.getRelative(1, -1, 0), Material.STAINED_CLAY, 10);
					...
					setBlock(blocks, b.getRelative(2, -2, -2), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(2, -1, -2), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(2, -5, 0), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(2, 0, 0), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(2, 1, 0), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(2, -3, 2), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(2, -2, 2), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(2, 0, 3), Material.STEP, 14);
					setBlock(blocks, b.getRelative(2, 1, 3), Material.STEP, 6);
					setBlock(blocks, b.getRelative(3, -4, -4), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(3, -4, -3), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(3, -3, -3), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(3, -2, -3), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(3, -5, 0), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(3, -4, 0), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(3, -1, 0), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(3, 0, 0), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(3, -3, 3), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(3, 0, 3), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(4, -4, -5), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(4, -3, -5), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(4, -2, -5), Material.STEP, 6);
					...
					setBlock(blocks, b.getRelative(4, -1, 0), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(4, -3, 4), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(4, -2, 4), Material.STAINED_CLAY, 10);
					setBlock(blocks, b.getRelative(4, -1, 4), Material.STAINED_CLAY, 10);
					break;
				case CASTLE_CAGE:
