...
public class ServerData {
	...
	public static class HubServer {
		...
		public HubServer(){
			...
			for(Player p : Bukkit.getOnlinePlayers()){
				p.kickPlayer("§6§lOrbitMines§4§lNetwerk\n    §3§lHub§7 Server Restarten...");
			}
		...
		private void spawnNPCs(){
			...
			}
			{
				...
				npc.newEntity(EntityType.SKELETON, new Location(getHubWorld(), 31.5, 75, 5.5, 140, 0), "§c§lMindCraft §7| §e§lKlik om te Spelen", false);
				npc.setSkeletonType(SkeletonType.WITHER);
			...
			}
			{
				...
				h.addLine("§d§oReport bugs op §6§owww.orbitmines.com§d§o!");
				h.create();
			}
			{
			...
			}
			{
				...
				npcas.setCustomName("§7Welkom op het §6§lOrbitMines§4§lNetwerk§7!");
				npcas.setCustomNameVisible(true);
				npcas.setBodyPose(EulerAngle.ZERO.setX(0.1).setY(0).setZ(0));
				npcas.setHeadPose(EulerAngle.ZERO.setX(0.15).setY(0).setZ(0));
				npcas.setLeftArmPose(EulerAngle.ZERO.setX(0).setY(0).setZ(0));
		...
		private void registerLobbyItems(){
			...
			}
			{
				...
				ItemMeta itemmeta = item.getItemMeta();
				itemmeta.setDisplayName("§c§nInstellingen");
				item.setItemMeta(itemmeta);
				lobbyitems[3] = item;
			}
			{
	...
	public static class KitPvPServer {
		...
		private void registerKits(){
			{// Knight Level 1 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.setDisplayname(new ItemStack(Material.STONE_SWORD), "§b§lKnight §a§lLvL 1§8 || §bWapen")), 4));
			...
			{// Knight Level 2 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.setDisplayname(new ItemStack(Material.STONE_SWORD), "§b§lKnight §a§lLvL 2§8 || §bWapen")), 4));
			...
			{// Knight Level 3 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.setDisplayname(new ItemStack(Material.STONE_SWORD), "§b§lKnight §a§lLvL 3§8 || §bWapen"), Enchantment.DAMAGE_ALL, 1)), 4));
			...
			{// Archer Level 1 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.setDisplayname(new ItemStack(Material.STONE_SWORD), "§b§lArcher §a§lLvL 1§8 || §bWapen")), 4));
			...
			{// Archer Level 2 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.setDisplayname(new ItemStack(Material.STONE_SWORD), "§b§lArcher §a§lLvL 2§8 || §bWapen")), 4));
			...
			{// Archer Level 3 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.setDisplayname(new ItemStack(Material.STONE_SWORD), "§b§lArcher §a§lLvL 3§8 || §bWapen")), 4));
			...
			{// Soldier Level 1 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.setDisplayname(new ItemStack(Material.STONE_SWORD), "§b§lSoldier §a§lLvL 1§8 || §bWapen")), 4));
			...
			{// Soldier Level 2 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.setLore(Utils.setDisplayname(new ItemStack(Material.STONE_SWORD), "§b§lSoldier §a§lLvL 2§8 || §bWapen"), ItemType.LIGHTNING_I.addEnchantment(new ArrayList<String>())), Enchantment.DURABILITY, 1)), 5));
			...
			{// Soldier Level 3 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.setLore(Utils.setDisplayname(new ItemStack(Material.STONE_SWORD), "§b§lSoldier §a§lLvL 3§8 || §bWapen"), ItemType.LIGHTNING_II.addEnchantment(new ArrayList<String>())), Enchantment.DAMAGE_ALL, 1)), 4));
			...
			{// Wizard Level 1 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.setDisplayname(new ItemStack(Material.STONE_SWORD), "§b§lWizard §a§lLvL 1§8 || §bWapen")), 4));
			...
			{// Wizard Level 2 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.setDisplayname(new ItemStack(Material.STONE_SWORD), "§b§lWizard §a§lLvL 2§8 || §bWapen"), Enchantment.DAMAGE_ALL, 1)), 4));
			...
			{// Wizard Level 3 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.setDisplayname(new ItemStack(Material.STONE_SWORD), "§b§lWizard §a§lLvL 3§8 || §bWapen"), Enchantment.DAMAGE_ALL, 1)), 4));
			...
			{// Tank Level 1 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.setDisplayname(new ItemStack(Material.WOOD_SWORD), "§b§lTank §a§lLvL 1§8 || §bWapen"), Enchantment.KNOCKBACK, 1)), 4));
			...
			{// Tank Level 2 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.setDisplayname(new ItemStack(Material.STONE_SWORD), "§b§lTank §a§lLvL 2§8 || §bWapen"), Enchantment.KNOCKBACK, 2)), 4));
			...
			{// Tank Level 3 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.setDisplayname(new ItemStack(Material.IRON_SWORD), "§b§lTank §a§lLvL 3§8 || §bWapen"), Enchantment.KNOCKBACK, 2)), 4));
			...
			{// Drunk Level 1 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.setDisplayname(new ItemStack(Material.STONE_SWORD), "§b§lDrunk §a§lLvL 1§8 || §bWapen"), Enchantment.KNOCKBACK, 2)), 4));
				...
				kit.setHelmet(Utils.hideFlags(Utils.setUnbreakable(Utils.setDisplayname(new ItemStack(Material.CHAINMAIL_HELMET), "§b§lDrunk §a§lLvL 1§8 || §bHelmet")), 4));
				...
				kit.setBoots(Utils.hideFlags(Utils.setUnbreakable(Utils.setDisplayname(new ItemStack(Material.CHAINMAIL_BOOTS), "§b§lDrunk §a§lLvL 1§8 || §bBoots")), 4));
				kit.setPotionEffect(new PotionEffect(PotionEffectType.CONFUSION, 2000000, 1));
			}
			{// Drunk Level 2 \\
				Kit kit = new Kit(KitPvPKit.DRUNK.getName() + " 2");
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.setLore(Utils.setDisplayname(new ItemStack(Material.STONE_SWORD), "§b§lDrunk §a§lLvL 2§8 || §bWapen"), ItemType.BLINDNESS_I.addEnchantment(new ArrayList<String>())), Enchantment.KNOCKBACK, 2)), 4));
			...
			{// Drunk Level 3 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.setLore(Utils.setDisplayname(new ItemStack(Material.IRON_SWORD), "§b§lDrunk §a§lLvL 3§8 || §bWapen"), ItemType.BLINDNESS_II.addEnchantment(new ArrayList<String>())), Enchantment.KNOCKBACK, 2)), 4));
			...
			{// Pyro Level 1 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.setDisplayname(new ItemStack(Material.IRON_SWORD), "§b§lPyro §a§lLvL 1§8 || §bWapen"), Enchantment.FIRE_ASPECT, 2)), 4));
			...
			{// Pyro Level 2 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.addEnchantment(Utils.setDisplayname(new ItemStack(Material.IRON_SWORD), "§b§lPyro §a§lLvL 2§8 || §bWapen"), Enchantment.FIRE_ASPECT, 2), Enchantment.DAMAGE_ALL, 1)), 4));
			...
			{// Pyro Level 3 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.addEnchantment(Utils.setDisplayname(new ItemStack(Material.IRON_SWORD), "§b§lPyro §a§lLvL 3§8 || §bWapen"), Enchantment.FIRE_ASPECT, 2), Enchantment.DAMAGE_ALL, 1)), 4));
			...
			{// Bunny Level 1 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.setDisplayname(new ItemStack(Material.IRON_SWORD), "§b§lBunny §a§lLvL 1§8 || §bWapen")), 4));
			...
			{// Bunny Level 2 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.setDisplayname(new ItemStack(Material.IRON_SWORD), "§b§lBunny §a§lLvL 2§8 || §bWapen")), 4));
			...
			{// Bunny Level 3 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.setDisplayname(new ItemStack(Material.IRON_SWORD), "§b§lBunny §a§lLvL 3§8 || §bWapen"), Enchantment.DAMAGE_ALL, 1)), 4));
			...
			{// Necromancer Level 1 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.setDisplayname(new ItemStack(Material.GOLD_HOE), "§b§lNecromancer §a§lLvL 1§8 || §bWapen"), Enchantment.DAMAGE_ALL, 8)), 4));
			...
			{// Necromancer Level 2 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.setDisplayname(new ItemStack(Material.GOLD_HOE), "§b§lNecromancer §a§lLvL 2§8 || §bWapen"), Enchantment.DAMAGE_ALL, 8)), 4));
			...
			{// King Level 1 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.setDisplayname(new ItemStack(Material.STONE_SWORD), "§b§lKing §a§lLvL 1§8 || §bWapen"), Enchantment.DAMAGE_ALL, 1)), 4));
			...
			{// King Level 2 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.setLore(Utils.setDisplayname(new ItemStack(Material.STONE_SWORD), "§b§lKing §a§lLvL 2§8 || §bWapen§a"), ItemType.HEALING_I.addEnchantment(new ArrayList<String>())), Enchantment.DAMAGE_ALL, 1)), 4));
			...
			{// King Level 3 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.setLore(Utils.setDisplayname(new ItemStack(Material.STONE_SWORD), "§b§lKing §a§lLvL 3§8 || §bWapen§a"), ItemType.HEALING_II.addEnchantment(new ArrayList<String>())), Enchantment.DAMAGE_ALL, 1)), 4));
			...
			{// Tree Level 1 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.setDisplayname(new ItemStack(Material.LEAVES), "§b§lTree §a§lLvL 1§8 || §bWapen"), Enchantment.DAMAGE_ALL, 4)), 4));
			...
			{// Tree Level 2 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.setDisplayname(new ItemStack(Material.LEAVES), "§b§lTree §a§lLvL 2§8 || §bWapen"), Enchantment.DAMAGE_ALL, 5)), 4));
			...
			{// Tree Level 3 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.setDisplayname(new ItemStack(Material.LEAVES), "§b§lTree §a§lLvL 3§8 || §bWapen"), Enchantment.DAMAGE_ALL, 5)), 4));
			...
			{// Blaze Level 1 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.addEnchantment(Utils.setDisplayname(new ItemStack(Material.BLAZE_POWDER), "§b§lBlaze §a§lLvL 1§8 || §bWapen"), Enchantment.DAMAGE_ALL, 4), Enchantment.FIRE_ASPECT, 2)), 4));
			...
			{// Blaze Level 2 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.addEnchantment(Utils.setDisplayname(new ItemStack(Material.BLAZE_POWDER), "§b§lBlaze §a§lLvL 2§8 || §bWapen"), Enchantment.DAMAGE_ALL, 5), Enchantment.FIRE_ASPECT, 3)), 4));
			...
			{// Blaze Level 3 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.addEnchantment(Utils.setDisplayname(new ItemStack(Material.BLAZE_POWDER), "§b§lBlaze §a§lLvL 3§8 || §bWapen"), Enchantment.DAMAGE_ALL, 6), Enchantment.FIRE_ASPECT, 4)), 4));
			...
			{// TNT Level 1 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.addEnchantment(Utils.addEnchantment(Utils.setDisplayname(new ItemStack(Material.TNT), "§b§lTNT §a§lLvL 1§8 || §bWapen"), Enchantment.DAMAGE_ALL, 5), Enchantment.KNOCKBACK, 3), 4));
			...
			{// TNT Level 2 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.addEnchantment(Utils.addEnchantment(Utils.setDisplayname(new ItemStack(Material.TNT), "§b§lTNT §a§lLvL 2§8 || §bWapen"), Enchantment.DAMAGE_ALL, 5), Enchantment.KNOCKBACK, 4), 4));
			...
			{// TNT Level 3 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.addEnchantment(Utils.addEnchantment(Utils.setDisplayname(new ItemStack(Material.TNT), "§b§lTNT §a§lLvL 3§8 || §bWapen"), Enchantment.DAMAGE_ALL, 5), Enchantment.KNOCKBACK, 4), 4));
				kit.setItem(1, Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.setLore(Utils.setDisplayname(new ItemStack(Material.BOW), "§b§lTNT §a§lLvL 3§8 || §bBow"), ProjectileType.EXPLOSIVE_I.addEnchantment(new ArrayList<String>())), Enchantment.DURABILITY, 1)), 5));
			...
			{// Fisherman Level 1 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.setDisplayname(new ItemStack(Material.FISHING_ROD), "§b§lFisherman §a§lLvL 1§8 || §bWapen"), Enchantment.DAMAGE_ALL, 6)), 4));
			...
			{// Fisherman Level 2 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.setDisplayname(new ItemStack(Material.FISHING_ROD), "§b§lFisherman §a§lLvL 2§8 || §bWapen"), Enchantment.DAMAGE_ALL, 6)), 4));
			...
			{// Fisherman Level 3 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.setDisplayname(new ItemStack(Material.FISHING_ROD), "§b§lFisherman §a§lLvL 3§8 || §bWapen"), Enchantment.DAMAGE_ALL, 6)), 4));
			...
			{// SnowGolem Level 1 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.addEnchantment(Utils.addEnchantment(Utils.setDisplayname(new ItemStack(Material.SNOW_BALL), "§b§lSnowGolem §a§lLvL 1§8 || §bWapen"), Enchantment.DAMAGE_ALL, 6), Enchantment.KNOCKBACK, 2), 4));
			...
			{// SnowGolem Level 2 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.addEnchantment(Utils.addEnchantment(Utils.setDisplayname(new ItemStack(Material.SNOW_BALL), "§b§lSnowGolem §a§lLvL 2§8 || §bWapen"), Enchantment.DAMAGE_ALL, 6), Enchantment.KNOCKBACK, 2), 4));
			...
			{// SnowGolem Level 3 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.addEnchantment(Utils.addEnchantment(Utils.setDisplayname(new ItemStack(Material.SNOW_BALL), "§b§lSnowGolem §a§lLvL 3§8 || §bWapen"), Enchantment.DAMAGE_ALL, 7), Enchantment.KNOCKBACK, 3), 4));
			...
			{// Librarian Level 1 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.addEnchantment(Utils.setDisplayname(new ItemStack(Material.PAPER), "§b§lLibrarian §a§lLvL 1§8 || §bWapen"), Enchantment.DAMAGE_ALL, 8), 4));
			...
			{// Librarian Level 2 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.addEnchantment(Utils.setDisplayname(new ItemStack(Material.PAPER), "§b§lLibrarian §a§lLvL 2§8 || §bWapen"), Enchantment.DAMAGE_ALL, 8), 4));
			...
			{// Librarian Level 3 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.addEnchantment(Utils.setDisplayname(new ItemStack(Material.PAPER), "§b§lLibrarian §a§lLvL 3§8 || §bWapen"), Enchantment.DAMAGE_ALL, 8), 4));
			...
			{// Spider Level 1 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.setLore(Utils.setDisplayname(new ItemStack(Material.SPIDER_EYE), "§b§lSpider §a§lLvL 1§8 || §bWapen"), ItemType.ARTHROPODS_I.addEnchantment(new ArrayList<String>())), Enchantment.DAMAGE_ALL, 6)), 4));
			...
			{// Spider Level 2 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.setLore(Utils.setDisplayname(new ItemStack(Material.SPIDER_EYE), "§b§lSpider §a§lLvL 2§8 || §bWapen"), ItemType.ARTHROPODS_II.addEnchantment(new ArrayList<String>())), Enchantment.DAMAGE_ALL, 6)), 4));
			...
			{// Spider Level 3 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.setLore(Utils.setDisplayname(new ItemStack(Material.SPIDER_EYE), "§b§lSpider §a§lLvL 3§8 || §bWapen"), ItemType.ARTHROPODS_III.addEnchantment(new ArrayList<String>())), Enchantment.DAMAGE_ALL, 6)), 4));
			...
			{// Villager Level 1 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.addEnchantment(Utils.setDisplayname(new ItemStack(Material.EMERALD), "§b§lVillager §a§lLvL 1§8 || §bWapen"), Enchantment.DAMAGE_ALL, 9), 4));
			...
			{// Villager Level 2 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.addEnchantment(Utils.addEnchantment(Utils.setDisplayname(new ItemStack(Material.EMERALD), "§b§lVillager §a§lLvL 2§8 || §bWapen"), Enchantment.DAMAGE_ALL, 9), Enchantment.FIRE_ASPECT, 1), 4));
			...
			{// Villager Level 3 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.addEnchantment(Utils.addEnchantment(Utils.setDisplayname(new ItemStack(Material.EMERALD), "§b§lVillager §a§lLvL 3§8 || §bWapen"), Enchantment.DAMAGE_ALL, 9), Enchantment.FIRE_ASPECT, 1), 4));
			...
			{// Assassin Level 1 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.setDisplayname(new ItemStack(Material.DIAMOND_SWORD), "§b§lAssassin §a§lLvL 1§8 || §bWapen"), Enchantment.DAMAGE_ALL, 1)), 4));
			...
			{// Lord Level 1 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.setDisplayname(new ItemStack(Material.GOLD_SWORD), "§b§lLord §a§lLvL 1§8 || §bWapen")), 4));
				kit.setItem(1, Utils.setDisplayname(new ItemStack(Material.GOLDEN_APPLE, 5), "§b§lLord §a§lLvL 1§8 || §eGolden Apple"));
				
				kit.setHelmet(Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.setDisplayname(new ItemStack(Material.GOLD_HELMET), "§b§lLord §a§lLvL 1§8 || §bHelmet"), Enchantment.PROTECTION_ENVIRONMENTAL, 3)), 4));
			...
			{// Vampire Level 1 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.setLore(Utils.setDisplayname(new ItemStack(Material.IRON_SWORD), "§b§lVampire §a§lLvL 1§8 || §bWapen"), ItemType.VAMPIRE_I.addEnchantment(new ArrayList<String>())), Enchantment.DURABILITY, 1)), 5));
			...
			{// DarkMage Level 1 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.setLore(Utils.setDisplayname(new ItemStack(Material.STONE_SWORD), "§b§lDarkMage §a§lLvL 1§8 || §bWapen§5"), ItemType.MAGIC_I.addEnchantment(new ArrayList<String>())), Enchantment.DAMAGE_ALL, 1)), 4));
			...
			{// Beast Level 1 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.setLore(Utils.setDisplayname(new ItemStack(Material.IRON_AXE), "§b§lBeast §a§lLvL 1§8 || §bWapen"), ItemType.KNOCKUP_I.addEnchantment(new ArrayList<String>())), Enchantment.DAMAGE_ALL, 1)), 4));
			...
			{// Fish Level 1 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.addEnchantment(Utils.setDisplayname(new ItemStack(Material.RAW_FISH), "§b§lFish §a§lLvL 1§8 || §bWapen"), Enchantment.DAMAGE_ALL, 8), 4));
			...
			{// Heavy Level 1 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.setDisplayname(new ItemStack(Material.IRON_SWORD), "§b§lHeavy §a§lLvL 1§8 || §bWapen")), 4));
			...
			{// GrimReaper Level 1 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.setDisplayname(new ItemStack(Material.STONE_AXE), "§b§lGrimReaper §a§lLvL 1§8 || §bWapen"), Enchantment.DAMAGE_ALL, 3)), 4));
			...
			{// Miner Level 1 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.setDisplayname(new ItemStack(Material.GOLD_PICKAXE), "§b§lMiner §a§lLvL 1§8 || §bWapen"), Enchantment.DAMAGE_ALL, 5)), 4));
			...
			{// Farmer Level 1 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.setDisplayname(new ItemStack(Material.STONE_SWORD), "§b§lFarmer §a§lLvL 1§8 || §bWapen"), Enchantment.DAMAGE_ALL, 2)), 4));
				...
				kit.setHelmet(Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.addColor(Utils.setDisplayname(new ItemStack(Material.LEATHER_HELMET), "§b§lFarmer §a§lLvL 1§8 || §bHelmet"), Color.YELLOW), Enchantment.PROTECTION_ENVIRONMENTAL, 2)), 4));
				kit.setChestplate(Utils.hideFlags(Utils.setUnbreakable(Utils.addColor(Utils.setDisplayname(new ItemStack(Material.LEATHER_CHESTPLATE), "§b§lFarmer §a§lLvL 1§8 || §bChestplate"), Color.YELLOW)), 4));
				kit.setLeggings(Utils.hideFlags(Utils.setUnbreakable(Utils.addColor(Utils.setDisplayname(new ItemStack(Material.LEATHER_LEGGINGS), "§b§lFarmer §a§lLvL 1§8 || §bLeggings"), Color.YELLOW)), 4));
				kit.setBoots(Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.addColor(Utils.setDisplayname(new ItemStack(Material.LEATHER_BOOTS), "§b§lFarmer §a§lLvL 1§8 || §bBoots"), Color.YELLOW), Enchantment.PROTECTION_ENVIRONMENTAL, 2)), 4));
				kit.setPotionEffect(new PotionEffect(PotionEffectType.SPEED, 2000000, 0));
			}
			{// Undeath King Level 1 \\
				Kit kit = new Kit(KitPvPKit.UNDEATH_KING.getName() + " 1");
				kit.setItem(0, Utils.hideFlags(Utils.setUnbreakable(Utils.addEnchantment(Utils.setDisplayname(new ItemStack(Material.GOLD_SWORD), "§b§lUndeath King §a§lLvL 1§8 || §bWapen"), Enchantment.DAMAGE_ALL, 1)), 4));
			...
			{// Engineer Level 1 \\
				...
				kit.setItem(0, Utils.hideFlags(Utils.addEnchantment(Utils.setLore(Utils.setDisplayname(new ItemStack(Material.ENDER_PEARL), "§b§lEngineer §a§lLvL 1§8 || §c§lRood §8|| §bWapen§f"), ItemType.PAINTBALLS_I.addEnchantment(new ArrayList<String>())), Enchantment.DURABILITY, 1), 5));
		...
		private void spawnNPCs(){
			...
			}
			{
				...
				h.addLine("§a§oBinnenkort Beschikbaar...");
				h.create();
			}
		}
		...
		private void registerLobbyItems(){
			ItemStack[] lobbyitems = new ItemStack[36];
			{
				ItemStack item = new ItemStack(Material.WRITTEN_BOOK);
				BookMeta itemmeta = (BookMeta) item.getItemMeta();
				itemmeta.setDisplayName("§c§nBoek van Enchantments");
				...
				+ " §0§l- Lightning I\n"
				+ "  §0§o25% kans om een bliksemschicht op je tegenstander te laten inslaan.\n"
				+ " §0§l- Lightning II\n"
				+ "  §0§o33% kans om een bliksemschicht op je tegenstander te laten inslaan.\n");
				itemmeta.setPage(3, 
				"§0§lBlindness\n"
				+ " §0§l- Blindness I\n"
				+ "  §0§oGeeft 2 seconden Blindness aan je tegenstander.\n"
				+ " §0§l- Blindness II\n"
				+ "  §0§oGeeft 3 seconden Blindness aan je tegenstander.\n");
				itemmeta.setPage(4, 
				"§0§lHealing\n"
				+ " §0§l- Healing I\n"
				+ "  §0§oSHIFT + Rechtermuisknop, geef jezelf Regeneration III voor 4 seconden.\n"
				+ " §0§l- Healing II\n"
				+ "  §0§oSHIFT + Rechtermuisknop, geef jezelf Regeneration III voor 5 seconden.\n");
				itemmeta.setPage(5, 
				"§0§lVampire\n"
				+ " §0§l- Vampire I\n"
				+ "  §0§oGeeft je 1.5 HP terug.\n");
				itemmeta.setPage(6, 
				"§0§lMagic\n"
				+ " §0§l- Magic I\n"
				+ "  §0§oGeeft Wither I aan je tegenstander voor 4 seconden.\n");
				itemmeta.setPage(7, 
				"§0§lKnockup\n"
				+ " §0§l- Knockup I\n"
				+ "  §0§o50% kans om je tegenstander in de lucht te gooien.\n");
				itemmeta.setPage(8, 
				"§0§lLightning §0§o(Bow)\n"
				+ " §0§l- Lightning I\n"
				+ "  §0§oEen bliksemschicht zal op je tegenstander inslaan.\n");
				itemmeta.setPage(9, 
				"§0§lUndeath\n"
				+ " §0§l- Undeath I\n"
				+ "  §0§oSpawnt 3 Undeath Knights die jouw tegenstander aanvallen.\n"
				+ " §0§l- Undeath II\n"
				+ "  §0§oSpawnt 3 Undeath Knights en 1 Undeath Archer die jouw tegenstander aanvallen.\n");
				itemmeta.setPage(10, 
				"§0§lExplosive\n"
				+ " §0§l- Explosive I\n"
				+ "  §0§oSpawnt een TNT op de locatie van jouw tegenstander.\n");
				itemmeta.setPage(11, 
				"§0§lArrow Split\n"
				+ " §0§l- Arrow Split I\n"
				+ "  §0§oWanneer je een arrow schiet, zullen eromheen nog 4 worden afgeschoten.\n");
				itemmeta.setPage(12, 
				"§0§lWither Armor\n"
				+ " §0§l- Wither Armor I\n"
				+ "  §0§oGeeft 5 seconden Wither II aan degene die jouw aanvalt.\n");
				itemmeta.setPage(13, 
				"§0§lMolten Armor\n"
				+ " §0§l- Molten Armor I\n"
				+ "  §0§oGeeft 5 seconden Blindness en 5 seconden Slowness VI aan degene die jouw aanvalt.\n");
				itemmeta.setPage(14, 
				"§0§lFire Trail\n"
				+ " §0§l- Fire Trail I\n"
				+ "  §0§oEen pad van vuur volgt je terwijl je loopt.\n");
				itemmeta.setPage(15, 
				"§0§lLight\n"
				+ " §0§l- Light I\n"
				+ "  §0§oEr komt een pad van cobblestone wanneer je over water loopt.\n");
				itemmeta.setPage(16, 
				"§0§lFly\n"
				+ " §0§l- Fly I\n"
				+ "  §0§oSHIFT, om te vliegen!\n");
				itemmeta.setPage(17, 
				"§0§lArthropods\n"
				+ " §0§l- Arthropods I\n"
				+ "  §0§o16.67% kans om een Spider te spawnen die jouw tegenstander aanvalt.\n"
				+ " §0§l- Arthropods II\n"
				+ "  §0§o20% kans om een Spider Jockey te spawnen die jouw tegenstander aanvalt.\n");
				itemmeta.setPage(18,
				" §0§l- Arthropods III\n"
				+ "  §0§o25% kans om een Spider en een Spider Jockey te spawnen die jouw tegenstander aanvalt.\n");
				itemmeta.setPage(19, 
				"§0§lWither\n"
				+ " §0§l- Wither I\n"
				+ "  §0§oRechtermuisknop, schiet 4 Wither Skulls van jouw locatie. Prijs: 1 Soul. Je krijg een Soul wanneer je een tegenstander doodt.\n");
				itemmeta.setPage(20,
				"§0§lBarrier\n"
				+ " §0§l- Barrier I\n"
				+ "  §0§oRechtermuisknop, spawnt een schild om je heen en geeft je 5 seconden Resistance.\n"
				+ " §0§l- Barrier II\n"
				+ "  §0§oRechtermuisknop, spawnt een schild om je heen en geeft je 5 seconden Resistance II.\n");
				itemmeta.setPage(21,
				"§0§lTNT\n"
				+ " §0§l- TNT I\n"
				+ "  §0§oRechtermuisknop, schiet een TNT af van jouw locatie.\n");
				itemmeta.setPage(22,
				"§0§lFish Attack\n"
				+ " §0§l- Fish Attack I\n"
				+ "  §0§oRechtermuisknop, geeft 4 seconden Poison III aan de dichtstbijzijnde tegenstanders.\n");
				itemmeta.setPage(23,
				"§0§lShield\n"
				+ " §0§l- Shield I\n"
				+ "  §0§oRechtermuisknop, geeft je 10 seconden Resistance.\n"
				+ " §0§l- Shield II\n"
				+ "  §0§oRechtermuisknop, geeft je 12 seconden Resistance II.\n");
				itemmeta.setPage(24,
				"§0§lTrade\n"
				+ " §0§l- Trade I\n"
				+ "  §0§oGeeft het wapen dat je tegenstander in zijn hand heeft aan jou.\n");
				itemmeta.setPage(25,
				"§0§lHealing Kit\n"
				+ " §0§l- Healing Kit I\n"
				+ "  §0§oRechtermuisknop, zet je weer naar volle HP.\n");
				itemmeta.setPage(26,
				"§0§lBlock Explosion\n"
				+ " §0§l- Block Explosion I\n"
				+ "  §0§oRechtermuisknop, schiet een bom af die de dichtstbijzijnde tegenstander Blindness en Slowness geeft.\n");
				itemmeta.setPage(27,
				"§0§lUndeath Summon\n"
				+ " §0§l- Undeath Summon I\n"
				+ "  §0§oRechtermuisknop, spawnt 2 Baby Pigman die voor jou vechten.\n");
				itemmeta.setPage(28,
				"§0§lPaintballs\n"
				+ " §0§l- Paintballs I\n"
				+ "  §0§oRechtermuisknop, veranderd een stuk grond naar een kleur, elke kleur heeft een speciaal effect.\n  §0§oLinkermuisknop, verander kleur.\n");
		...
		private void registerSpectatorItems(){
			...
			
			{
				ItemStack item = new ItemStack(Material.ENDER_PEARL, 1);
				ItemMeta itemmeta = item.getItemMeta();
				itemmeta.setDisplayName("§3§nTerug naar de Lobby");
				item.setItemMeta(itemmeta);
	...
	public static class CreativeServer {
		...
		public CreativeServer(){
			...
			for(Player p : Bukkit.getOnlinePlayers()){
				p.kickPlayer("§6§lOrbitMines§4§lNetwerk\n    §d§lCreative§7 Server Restarten...");
			}
	...
	public static class SurvivalServer {
		...
		public SurvivalServer(){
			...
			for(Player p : Bukkit.getOnlinePlayers()){
				p.kickPlayer("§6§lOrbitMines§4§lNetwerk\n    §a§lSurvival§7 Server Restarten...");
			}
		...
		private void spawnNPCs(){
			...
			}
			{
				...
				npcas.setCustomName("§2§lPvP Arena");
				npcas.setCustomNameVisible(true);
				npcas.spawn();
			}
			{
			...
			}
			{
				...
				npc.newEntity(EntityType.VILLAGER, new Location(getLobbyWorld(), -48.5, 79, -10.5, 0, 0), "§f§lTerug naar de Spawn", false);
				npc.setVillagerProfession(Profession.LIBRARIAN);
			}
			{
	...
	public static class SkyBlockServer {
		...
		public SkyBlockServer(){
			...
			for(Player p : Bukkit.getOnlinePlayers()){
				p.kickPlayer("§6§lOrbitMines§4§lNetwerk\n    §5§lSkyBlock§7 Server Restarten...");
			}
		}
	...
	public static class PrisonServer {
		...
		public PrisonServer(){
			...
			ServerStorage.spawnbuilders = "§b§lMod §brienk222\n§9§lDiamond §9jomancool55\n§6§lGold §6gapisabelle §7(PvP Arena)";
		...
		private void spawnNPCs(){
			...
			}
			{
				...
				npc.newEntity(EntityType.SKELETON, new Location(getPrisonWorld(), 1.5, 69, -21.5, 0, 0), "§7§lReset Mijn §a§lZ", false);
				npc.setItemInHand(Utils.addEnchantment(new ItemStack(Material.DIAMOND_PICKAXE), Enchantment.DURABILITY, 1));
			}
			{
				NPC npc = NPC.addNPC(NPCType.RESET_MINE);
				npc.newEntity(EntityType.SKELETON, new Location(getPrisonWorld(), 1022.5, 70, -24.5, 0, 0), "§7§lReset Mijn §a§lY", false);
				npc.setItemInHand(Utils.addEnchantment(new ItemStack(Material.DIAMOND_PICKAXE), Enchantment.DURABILITY, 1));
			}
	...
	public static class MiniGamesServer {
		...
		public MiniGamesServer(){
			...
			for(Player p : Bukkit.getOnlinePlayers()){
				p.kickPlayer("§6§lOrbitMines§4§lNetwerk\n   §f§lMiniGames§7 Server Restarten...");
			}
		...
		private void registerKits(){
			{
				...
				kit.setItem(4, Utils.setDisplayname(new ItemStack(Material.ENDER_PEARL), "§3§nTerug naar de Hub"));
			...
			}
			{
				...
				kit.setItem(5, Utils.setDisplayname(new ItemStack(Material.ENDER_PEARL), "§3§nTerug naar de Hub"));
			}
		...
		private void registerSWChestItems(){
			...
			this.swchestitems.add(new ChestItem(Material.COMPASS, 1, 1, "§6§lSpeler Tracker", 0, 1));
			...
			this.swtier2chestitems.add(new ChestItem(Material.COMPASS, 1, 1, "§6§lSpeler Tracker", 0, 5));
