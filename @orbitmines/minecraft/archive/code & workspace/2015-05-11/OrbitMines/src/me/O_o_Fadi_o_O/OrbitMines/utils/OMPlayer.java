...
public class OMPlayer {
	...
	public void load(){
		...
		try{
			...
			{
				int kills = 0, deaths = 0, levels = 0, money = 0, beststreak = 0;
				...
				this.kitpvpplayer = KitPvPPlayer.addKitPvPPlayer(this.player, kills, deaths, levels, money, beststreak, unlockedkits);
