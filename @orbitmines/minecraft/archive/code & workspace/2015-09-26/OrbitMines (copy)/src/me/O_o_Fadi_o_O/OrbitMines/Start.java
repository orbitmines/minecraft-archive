...
public class Start extends JavaPlugin {
	...
	private void registerAllEvents(){
		getServer().getPluginManager().registerEvents(new BreakEvent(), this);//Hub, Creative, Survival, SkyBlock, MiniGames, Prison
		getServer().getPluginManager().registerEvents(new ClickEvent(), this);//Hub, Creative, Survival, SkyBlock, MiniGames, Prison
		getServer().getPluginManager().registerEvents(new CommandPreprocessEvent(), this);//Hub, Creative, Survival, SkyBlock, MiniGames, Prison
		getServer().getPluginManager().registerEvents(new DamageEvent(), this);//Hub, Creative, Survival, SkyBlock, MiniGames, Prison
		getServer().getPluginManager().registerEvents(new EntityDamage(), this);//Hub, Creative, Survival, SkyBlock, MiniGames, Prison
		getServer().getPluginManager().registerEvents(new EntityDeath(), this);//Hub, Creative, Survival, SkyBlock, MiniGames, Prison
		getServer().getPluginManager().registerEvents(new EntityInteractEvent(), this);//Hub, Creative, Survival, SkyBlock, MiniGames, Prison
		getServer().getPluginManager().registerEvents(new InteractAtEntityEvent(), this);//Hub, Creative, Survival, SkyBlock, MiniGames, Prison
		getServer().getPluginManager().registerEvents(new JoinEvent(), this);//Hub, Creative, Survival, SkyBlock, MiniGames, Prison
		getServer().getPluginManager().registerEvents(new PlaceEvent(), this);//Hub, Creative, Survival, SkyBlock, MiniGames, Prison
		getServer().getPluginManager().registerEvents(new PlayerChat(), this);//Hub, Creative, Survival, SkyBlock, MiniGames, Prison
		getServer().getPluginManager().registerEvents(new PlayerInteract(), this);//Hub, Creative, Survival, SkyBlock, MiniGames, Prison
		getServer().getPluginManager().registerEvents(new PlayerMove(), this);//Hub, Creative, Survival, SkyBlock, MiniGames, Prison
		getServer().getPluginManager().registerEvents(new QuitEvent(), this);//Hub, Creative, Survival, SkyBlock, MiniGames, Prison
		getServer().getPluginManager().registerEvents(new SignEvent(), this);//Hub, Creative, Survival, SkyBlock, MiniGames, Prison
		getServer().getPluginManager().registerEvents(new VoteEvent(), this);//Hub, Creative, Survival, SkyBlock, MiniGames, Prison
		getServer().getPluginManager().registerEvents(new WorldChangeEvent(), this);//Hub, Creative, Survival, SkyBlock, MiniGames, Prison
