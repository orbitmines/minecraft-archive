...
public class Wardrobe {
	...
	public static Inventory getWardrobeInv(Player p){
		...
		final Inventory inv = Bukkit.createInventory(null, 54, "§0§lWardrobe");
		{
			...
			itemlore.add("");
			if(!Hub.white.containsKey(p.getName())){
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.blue.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b250 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.green.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b250 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.black.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b250 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.lightblue.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b250 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.pink.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b250 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.lightgreen.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b250 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.darkblue.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b250 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.purple.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b250 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.orange.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b250 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.red.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b250 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.cyan.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b250 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.yellow.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b250 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.gray.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b250 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
