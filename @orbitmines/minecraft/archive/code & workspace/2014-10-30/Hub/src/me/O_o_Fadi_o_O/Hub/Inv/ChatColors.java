	...
	public static Inventory getChatColors(final Player p){
		...
		{		
			
			{
				...
				itemlore.add("");
				if(!Hub.chatcolordarkred.containsKey(p.getName())){
			...
			}
			{
				...
				List<String> itemlore = new ArrayList<String>();
				itemlore.add("");
				if(!Hub.chatcolorlightgreen.containsKey(p.getName())){
			...
			}
			{
				...
				List<String> itemlore = new ArrayList<String>();
				itemlore.add("");
				if(!Hub.chatcolordarkgray.containsKey(p.getName())){
			...
			}
			{
				...
				List<String> itemlore = new ArrayList<String>();
				itemlore.add("");
				if(!Hub.chatcolorred.containsKey(p.getName())){
			...
			}
			{
				...
				List<String> itemlore = new ArrayList<String>();
				itemlore.add("");
				if(!Hub.chatcolorwhite.containsKey(p.getName())){
			...
			}
			{
				...
				List<String> itemlore = new ArrayList<String>();
				itemlore.add("");
				if(!Hub.chatcolorlightblue.containsKey(p.getName())){
			...
			}
			{
				...
				List<String> itemlore = new ArrayList<String>();
				itemlore.add("");
				if(!Hub.chatcolorpink.containsKey(p.getName())){
			...
			}
			{
				...
				List<String> itemlore = new ArrayList<String>();
				itemlore.add("");
				if(!Hub.chatcolorblue.containsKey(p.getName())){
					itemlore.add("§c§oPrice: §b475 VIP Points");
					itemlore.add("§7§o§nClick Here to Buy");
				}
				else{
			...
			}
			{
				...
				List<String> itemlore = new ArrayList<String>();
				itemlore.add("");
				if(!Hub.chatcolordarkblue.containsKey(p.getName())){
			...
			}
			{
				...
				List<String> itemlore = new ArrayList<String>();
				itemlore.add("");
				if(!Hub.chatcolorgreen.containsKey(p.getName())){
					itemlore.add("§c§oPrice: §b475 VIP Points");
					itemlore.add("§7§o§nClick Here to Buy");
				}
				else{
			...
			}
			{
				...
				List<String> itemlore = new ArrayList<String>();
				itemlore.add("");
				if(!Hub.chatcolorblack.containsKey(p.getName())){
			...
			{
				if(Hub.chatcolor.get(p).equals("4")){
					ItemStack item = new ItemStack(Material.REDSTONE, 1);
					ItemMeta itemmeta = item.getItemMeta();
					itemmeta.setDisplayName("§4Dark Red ChatColor ");
					List<String> itemlore = new ArrayList<String>();
				...
				if(Hub.chatcolor.get(p).equals("a")){
					ItemStack item = new ItemStack(Material.INK_SACK, 1);
					ItemMeta itemmeta = item.getItemMeta();
					itemmeta.setDisplayName("§aLight Green ChatColor ");
					List<String> itemlore = new ArrayList<String>();
				...
				if(Hub.chatcolor.get(p).equals("8")){
					ItemStack item = new ItemStack(Material.INK_SACK, 1);
					ItemMeta itemmeta = item.getItemMeta();
					itemmeta.setDisplayName("§8Dark Gray ChatColor ");
					List<String> itemlore = new ArrayList<String>();
				...
				if(Hub.chatcolor.get(p).equals("c")){
					ItemStack item = new ItemStack(Material.INK_SACK, 1);
					ItemMeta itemmeta = item.getItemMeta();
					itemmeta.setDisplayName("§cRed ChatColor ");
					List<String> itemlore = new ArrayList<String>();
				...
				if(Hub.chatcolor.get(p).equals("e")){
					ItemStack item = new ItemStack(Material.INK_SACK, 1);
					ItemMeta itemmeta = item.getItemMeta();
					itemmeta.setDisplayName("§eYellow ChatColor ");
					List<String> itemlore = new ArrayList<String>();
				...
				if(Hub.chatcolor.get(p).equals("f")){
					ItemStack item = new ItemStack(Material.INK_SACK, 1);
					ItemMeta itemmeta = item.getItemMeta();
					itemmeta.setDisplayName("§fWhite ChatColor ");
					List<String> itemlore = new ArrayList<String>();
				...
				if(Hub.chatcolor.get(p).equals("b")){
					ItemStack item = new ItemStack(Material.INK_SACK, 1);
					ItemMeta itemmeta = item.getItemMeta();
					itemmeta.setDisplayName("§bLight Blue ChatColor ");
					List<String> itemlore = new ArrayList<String>();
				...
				if(Hub.chatcolor.get(p).equals("d")){
					ItemStack item = new ItemStack(Material.INK_SACK, 1);
					ItemMeta itemmeta = item.getItemMeta();
					itemmeta.setDisplayName("§dPink ChatColor ");
					List<String> itemlore = new ArrayList<String>();
				...
				if(Hub.chatcolor.get(p).equals("9")){
					ItemStack item = new ItemStack(Material.INK_SACK, 1);
					ItemMeta itemmeta = item.getItemMeta();
					itemmeta.setDisplayName("§9Blue ChatColor ");
					List<String> itemlore = new ArrayList<String>();
				...
				if(Hub.chatcolor.get(p).equals("1")){
					ItemStack item = new ItemStack(Material.INK_SACK, 1);
					ItemMeta itemmeta = item.getItemMeta();
					itemmeta.setDisplayName("§1Dark Blue ChatColor ");
					List<String> itemlore = new ArrayList<String>();
				...
				if(Hub.chatcolor.get(p).equals("7")){
					ItemStack item = new ItemStack(Material.INK_SACK, 1);
					ItemMeta itemmeta = item.getItemMeta();
					itemmeta.setDisplayName("§7Gray ChatColor ");
					List<String> itemlore = new ArrayList<String>();
				...
				if(Hub.chatcolor.get(p).equals("6")){
					ItemStack item = new ItemStack(Material.INK_SACK, 1);
					ItemMeta itemmeta = item.getItemMeta();
					itemmeta.setDisplayName("§6Orange ChatColor ");
					List<String> itemlore = new ArrayList<String>();
				...
				if(Hub.chatcolor.get(p).equals("5")){
					ItemStack item = new ItemStack(Material.INK_SACK, 1);
					ItemMeta itemmeta = item.getItemMeta();
					itemmeta.setDisplayName("§5Purple ChatColor ");
					List<String> itemlore = new ArrayList<String>();
				...
				if(Hub.chatcolor.get(p).equals("3")){
					ItemStack item = new ItemStack(Material.INK_SACK, 1);
					ItemMeta itemmeta = item.getItemMeta();
					itemmeta.setDisplayName("§3Cyan ChatColor ");
					List<String> itemlore = new ArrayList<String>();
				...
				if(Hub.chatcolor.get(p).equals("2")){
					ItemStack item = new ItemStack(Material.INK_SACK, 1);
					ItemMeta itemmeta = item.getItemMeta();
					itemmeta.setDisplayName("§2Green ChatColor ");
					List<String> itemlore = new ArrayList<String>();
				...
				if(Hub.chatcolor.get(p).equals("0")){
					ItemStack item = new ItemStack(Material.INK_SACK, 1);
					ItemMeta itemmeta = item.getItemMeta();
					itemmeta.setDisplayName("§0Black ChatColor ");
					List<String> itemlore = new ArrayList<String>();
