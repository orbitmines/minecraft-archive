...
public class Disguises {
	...
	public static Inventory getDisguisesInv(Player p){
		...
		final Inventory inv = Bukkit.createInventory(null, 54, "§0§lDisguises");
		{
			...
			itemlore.add("");
			if(!Hub.disWitch.containsKey(p.getName())){
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.disBat.containsKey(p.getName())){
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.disChicken.containsKey(p.getName())){
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.disOcelot.containsKey(p.getName())){
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.disMushroomCow.containsKey(p.getName())){
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.disSquid.containsKey(p.getName())){
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.disSlime.containsKey(p.getName())){
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.disZombiePigman.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b400 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.disMagmaCube.containsKey(p.getName())){
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.disSkeleton.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b500 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.disWolf.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b400 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.disSpider.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b375 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.disSilverfish.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b475 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.disSheep.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b375 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.disCaveSpider.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b400 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.disCreeper.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b475 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.disCow.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b350 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
