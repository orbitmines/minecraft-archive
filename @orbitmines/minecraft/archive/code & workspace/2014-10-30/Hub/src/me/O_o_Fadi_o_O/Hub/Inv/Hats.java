...
public class Hats {
	...
	public static Inventory getHatsInv(Player p){
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.hatsStoneBricks.containsKey(p.getName())){
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.hatsGreenGlass.containsKey(p.getName())){
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.hatsCactus.containsKey(p.getName())){
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.hatsSnow.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b75 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.hatsTNT.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b125 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.hatsCoalOre.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b100 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.hatsBlackGlass.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b125 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.hatsFurnace.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b100 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.hatsQuartzOre.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b100 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.hatsHayBale.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b100 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.hatsRedstoneOre.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b125 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.hatsIce.containsKey(p.getName())){
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.hatsWorkbench.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b100 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.hatsGrass.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b100 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.hatsRedGlass.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b125 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.hatsBedrock.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b125 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.hatsLapisOre.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b100 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.hatsRedstoneBlock.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b125 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.hatsQuartzBlock.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b75 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.hatsLapisBlock.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b100 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.hatsMagentaGlass.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b125 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.hatsCoalBlock.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b100 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.hatsMelon.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b100 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.hatsGlass.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b150 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.hatsYellowGlass.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b125 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.hatsMycelium.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b75 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.hatsLeaves.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b125 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
		...
		}
		{
			...
			List<String> itemlore = new ArrayList<String>();
			itemlore.add("");
			if(!Hub.hatsOrangeGlass.containsKey(p.getName())){
				itemlore.add("§c§oPrice: §b125 VIP Points");
				itemlore.add("§7§o§nClick Here to Buy");
			}
			else{
