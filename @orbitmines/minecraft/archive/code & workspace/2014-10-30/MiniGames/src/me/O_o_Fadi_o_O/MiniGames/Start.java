...
public class Start extends JavaPlugin {
	...
	public void spawnNPCs(){
		
		{
			try{
				...
				Location l1 = new Location(w, -13.5, 65, 19.5, (float) 180, (float) 45);
				Location l2 = new Location(w, -46.5, 65, 12.5, (float) -90, (float) 45);
	...
	private void addCustomEntities(){
		...
		NPCManager.addCustomEntity(CustomSkeleton.class, "CustomSkeleton", 51);
	}
	...
	public boolean onCommand(CommandSender sender, Command cmd, String l, String[] a) {
		...
		if(cmd.getName().equalsIgnoreCase("omt")){
			...
			if(sender.hasPermission("Rank.Owner")){
				...
				sender.sendMessage("§8[§e§lOMT§8] §7Your OMT balance: §e§l" + StorageManager.omt.get(sender.getName()));
			}
		}
