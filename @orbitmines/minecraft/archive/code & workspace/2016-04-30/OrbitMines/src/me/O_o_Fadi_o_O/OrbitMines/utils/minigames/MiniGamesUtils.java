...
public class MiniGamesUtils {
	...
	public enum Rarity {
		...
		public void firework(Location l){
			...
			switch(this){
				case COMMON:
					fw.withColor(org.bukkit.Color.GREEN);
					fw.withColor(org.bukkit.Color.LIME);
					break;
				case LEGENDARY:
					fw.withColor(org.bukkit.Color.MAROON);
					fw.withColor(org.bukkit.Color.RED);
					break;
				case RARE:
					fw.withColor(org.bukkit.Color.ORANGE);
					fw.withColor(org.bukkit.Color.YELLOW);
					break;
			}
	...
	public enum TicketType {
		...
		ISLAND_CAGE(58), // Added: 08-08-2015 (Skywars Perk) \\
		TROPHEE_CAGE(59), // Added: 15-08-2015 (Skywars Perk) \\
		OCTOPUS_CAGE(60), // Added: 30-08-2015 (Skywars Perk) \\
		CASTLE_CAGE(61); // Added: 19-09-2015 (Skywars Perk) \\
		...
		public String getNameWithGame(){
			switch(this){
				...
				case ISLAND_CAGE:
					return "Island Cage (Skywars)";
				case TROPHEE_CAGE:
					return "Trophee Cage (Skywars)";
				case OCTOPUS_CAGE:
					return "Octopus Cage (Skywars)";
				case CASTLE_CAGE:
					return "Castle Cage (Skywars)";
				case BABY_CHICKEN_KIT:
		...
		public ItemStack getItemStack(){
			switch(this){
				...
				case OCTOPUS_CAGE:
					return Utils.setDurability(new ItemStack(Material.STAINED_CLAY), 10);
				case CASTLE_CAGE:
		...
		public List<String> getDescription(){
			switch(this){
				...
				case BLACK_ARMOR:
					return Arrays.asList("Jouw Leather Armor is Zwart!", getUses().getName());
				case BLUE_ARMOR:
					return Arrays.asList("Jouw Leather Armor is Blauw!", getUses().getName());
				case BOMBER_KIT:
					return Arrays.asList("10 TNT", getUses().getName());
				case CYAN_ARMOR:
					return Arrays.asList("Jouw Leather Armor is Cyaan!", getUses().getName());
				case DARK_BLUE_ARMOR:
					return Arrays.asList("Jouw Leather Armor is Donker Blauw!", getUses().getName());
				case DOUBLE_LOOT:
					return Arrays.asList("Dubbel loot in Chests.", "(Effect op alle Spelers)", getUses().getName());
				case DOUBLE_LOOT_PLAYER:
					return Arrays.asList("Dubbel loot in Chests.", "(Effect op jou)", getUses().getName());
				case ENABLE_POTIONS:
					return Arrays.asList("Potions in Chests.", "(Effect op alle Spelers)", getUses().getName());
				case ENABLE_POTIONS_PLAYER:
					return Arrays.asList("Potions in Chests.", "(Effect op jou)", getUses().getName());
				case FIGHTER_KIT:
					return Arrays.asList("Wood/Stone Wapen", getUses().getName());
				case GRAY_ARMOR:
					return Arrays.asList("Jouw Leather Armor is Grijs!", getUses().getName());
				case GREEN_ARMOR:
					return Arrays.asList("Jouw Leather Armor is Groen!", getUses().getName());
				case LIGHT_BLUE_ARMOR:
					return Arrays.asList("Jouw Leather Armor is Licht Blauw!", getUses().getName());
				case LIGHT_GREEN_ARMOR:
					return Arrays.asList("Jouw Leather Armor is Licht Groen!", getUses().getName());
				case ORANGE_ARMOR:
					return Arrays.asList("Jouw Leather Armor is Oranje!", getUses().getName());
				case PINK_ARMOR:
					return Arrays.asList("Jouw Leather Armor is Roze!", getUses().getName());
				case PURPLE_ARMOR:
					return Arrays.asList("Jouw Leather Armor is Paars!", getUses().getName());
				case RED_ARMOR:
					return Arrays.asList("Jouw Leather Armor is Rood!", getUses().getName());
				case RUNNER_KIT:
					return Arrays.asList("Geen PvP de eerste 30s.", getUses().getName());
				case WARRIOR_KIT:
					return Arrays.asList("Start met twee armor items.", getUses().getName());
				case WHITE_ARMOR:
					return Arrays.asList("Jouw Leather Armor is Wit!", getUses().getName());
				case YELLOW_ARMOR:
					return Arrays.asList("Jouw Leather Armor is Geeld!", getUses().getName());
				case APPLETREE_KIT:
					return Arrays.asList("+1 Apple elke 4m.", getUses().getName());
				case DOUBLE_IRON:
					return Arrays.asList("+1 Iron Ore van Iron Ore.", "50% Kans (Effect op alle Spelers)", getUses().getName());
				case DOUBLE_IRON_PLAYER:
					return Arrays.asList("+1 Iron Ore van Iron Ore.", "50% Kans (Effect op jou)", getUses().getName());
				case GOLD_FROM_LAPIS:
					return Arrays.asList("+1 Gold Ore van Lapis Ore", "50% Kans (Effect op jou)", getUses().getName());
				case GOLD_FROM_REDSTONE:
					return Arrays.asList("+1 Gold Ore van Redstone Ore", "50% Kans", getUses().getName());
				case MINER_KIT:
				...
				case CACTUS_CAGE:
					return Arrays.asList("Spawn in de Cactus Cage.", getUses().getName());
				case CAVE_CAGE:
					return Arrays.asList("Spawn in de Cave Cage.", getUses().getName());
				case CREEPER_KIT:
					return Arrays.asList("20 TNT", "Flint and Steel", getUses().getName());
				case DEATH_CAGE:
					return Arrays.asList("Spawn in de Death Cage.", getUses().getName());
				case ENCHANTER_CAGE:
					return Arrays.asList("Spawn in de Enchanter Cage.", getUses().getName());
				case ENCHANTER_KIT:
					return Arrays.asList("Enchantment Table", "15 EXP Potions", getUses().getName());
				case ENDERMAN_KIT:
					return Arrays.asList("2 Enderpearls", getUses().getName());
				case GRAY_RAINBOW_CAGE:
					return Arrays.asList("Spawn in de Gray Rainbow Cage.", getUses().getName());
				case HOT_AIR_BALLOON_CAGE:
					return Arrays.asList("Spawn in de Hot Air Balloon Cage.", getUses().getName());
				case MESA_CAGE:
					return Arrays.asList("Spawn in de Mesa Cage.", getUses().getName());
				case NETHER_CAGE:
					return Arrays.asList("Spawn in de Nether Cage.", getUses().getName());
				case SEA_CAGE:
					return Arrays.asList("Spawn in de Sea Cage.", getUses().getName());
				case SLIME_CAGE:
					return Arrays.asList("Spawn in de Slime Cage.", getUses().getName());
				case SNOWGOLEM_KIT:
					return Arrays.asList("Black Leather Helmet", "1 Carrot", "48 Snowballs", getUses().getName());
				case SUN_CAGE:
					return Arrays.asList("Spawn in de Sun Cage.", getUses().getName());
				case TANK_KIT:
					return Arrays.asList("Leather Helmet", "Chainmail Chestplate", "Chainmail Leggings", "Leather Boots", getUses().getName());
				case THE_END_CAGE:
					return Arrays.asList("Spawn in de End Cage.", getUses().getName());
				case THE_WOOL_HUT_CAGE:
					return Arrays.asList("Spawn in de Wool Hut Cage.", getUses().getName());
				case WOODEN_CAGE:
					return Arrays.asList("Spawn in de Wooden Cage.", getUses().getName());
				case ISLAND_CAGE:
					return Arrays.asList("Spawn in de Island Cage.", getUses().getName());
				case TROPHEE_CAGE:
					return Arrays.asList("Spawn in de Trophee Cage.", getUses().getName());
				case OCTOPUS_CAGE:
					return Arrays.asList("Spawn in de Octopus Cage.", getUses().getName());
				case CASTLE_CAGE:
					return Arrays.asList("Spawn in de Castle Cage.", getUses().getName());
				case BABY_CHICKEN_KIT:
					return Arrays.asList("Ability: Egg Bomb", "Knockback Genomen: 150%", "Damag Genomene: 110%", "Damage: 100%", getUses().getName());
				case CHICKEN_KIT:
					return Arrays.asList("Ability: Wool Trail", "Knockback Genomen: 95%", "Damage Genomen: 90%", "Damage: 120%", getUses().getName());
				case CHICKEN_MAMA_KIT:
					return Arrays.asList("Ability: Feather Attack", "Knockback Genomen: 120%", "Damage Genomen: 100%", "Damage: 100%", getUses().getName());
				case CHICKEN_WARLORD_KIT:
					return Arrays.asList("Ability: Iron Fist", "Knockback Genomen: 90%", "Damage Genomen: 80%", "Damage: 150%", getUses().getName());
				case HOT_WING_KIT:
					return Arrays.asList("Ability: Fire Shield", "Knockback Genomen: 130%", "Damage Genomen: 150%", "Damage: 100-400% [Fire]", getUses().getName());
				case JUMP_BOOST:
					return Arrays.asList("Jump Boost V.", "(Effect op alle Spelers)", getUses().getName());
				case SPEED_BOOST:
					return Arrays.asList("Speed Boost V.", "(Effect op alle Spelers)", getUses().getName());
			}
