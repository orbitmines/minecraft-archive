			...
			if(kitpvp.isProjectile(proj)){
				switch(kitpvp.getProjectileType(proj)){
					case PAINTBALLS_I:
						...
						int color = 14;
						if(proj.getCustomName().endsWith("Rood §8|| §bWapon§f")){
							color = 14;
						}
						else if(proj.getCustomName().endsWith("Blauw §8|| §bWapon§f")){
							color = 3;
						}
						else if(proj.getCustomName().endsWith("Zwart §8|| §bWapon§f")){
							color = 15;
						}
						else if(proj.getCustomName().endsWith("Grijs §8|| §bWapon§f")){
							color = 8;
						}
						else if(proj.getCustomName().endsWith("Groen §8|| §bWapon§f")){
							color = 5;
						}
						else{}
