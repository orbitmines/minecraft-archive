	...
	public enum TicketType {
		...
		public List<String> getDescription(){
			switch(this){
				...
				case ISLAND_CAGE:
					return Arrays.asList("Spawn in the Island Cage.", getUses().getName());
				case TROPHEE_CAGE:
					return Arrays.asList("Spawn in the Trophee Cage.", getUses().getName());
				case OCTOPUS_CAGE:
					return Arrays.asList("Spawn in the Octopus Cage.", getUses().getName());
				case CASTLE_CAGE:
					return Arrays.asList("Spawn in the Castle Cage.", getUses().getName());
				case BABY_CHICKEN_KIT:
