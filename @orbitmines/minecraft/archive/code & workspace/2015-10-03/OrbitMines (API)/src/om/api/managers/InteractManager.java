...
public class InteractManager {
	...
	public boolean handleMonsterEggs(){
	...
	public boolean handleChickenPetEggBomb(){
	...
	public boolean handleChickenPetAge(){
	...
	public boolean handleCreeperPetType(){
	...
	public boolean handleCreeperPetExplode(){
	...
	public boolean handleOcelotPetColor(){
	...
	public boolean handleOcelotPetKittyCannon(){
	...
	public boolean handleHorsePetColor(){
	...
	public boolean handleHorsePetSpeed(){
	...
	public boolean handleSilverfishPetLeap(){
	...
	public boolean handleSilverfishPetBomb(){
	...
	public boolean handleSheepPetDisco(){
	...
	public boolean handleSheepPetColor(){
	...
	public boolean handleCowPetMilkExplosion(){
	...
	public boolean handleCowPetAge(){
	...
	public boolean handleWolfPetAge(){
	...
	public boolean handleWolfPetBark(){
	...
	public boolean handleSlimePetJump(){
	...
	public boolean handleSlimePetSize(){
	...
	public boolean handlePetPigBabies(){
	...
	public boolean handlePetPigAge(){
	...
	public boolean handleMagmaCubePetSize(){
	...
	public boolean handleMagmaCubePetFireball(){
	...
	public boolean handleMushroomCowPetShroomTrail(){
	...
	public boolean handleMushroomCowPetFirework(){
	...
	@SuppressWarnings("deprecation")
	public boolean handleSpiderPetWebs(){
	...
	public boolean handleSpiderPetLauncher(){
	...
	public boolean handleSquidPetInkBomb(){
	...
	@SuppressWarnings("deprecation")
	public boolean handleSquidPetWaterSpout(){
	...
	@SuppressWarnings("deprecation")
	public boolean handleFlameThrower(){
	...
	public boolean handleMagmaCubeSoccer(){
	...
	public boolean handleSwapTeleporter(){
	...
	public boolean handleCreeperLauncher(){
	...
	public boolean handlePaintballs(){				
	...
	public boolean handleBookExplosion(){
	...
	public boolean handleSnowGolemAttack(){
	...
	public boolean handleFireworkGun(){
