...
public class NPC {
	...
	public void moveToLocation(Location location){
		WorldUtils.navigate((LivingEntity) this.entity, location, 1.2);
	}
	...
	public boolean update(Entity en){
		if(en.getType() == getEntityType() && en.getWorld().getName().equals(getLocation().getWorld().getName()) && getLocation().distance(en.getLocation()) <= 0.1){
			setEntity(en);
			return true;
		}
		return false;
